...
function config_meta()
{
    ...
    $sub_menu['80'] = [
        'id' => 'post_icons',
        'title' => $lang->post_icons,
        'link' => 'index.php?module=config-post_icons',
    ];
    $sub_menu['90'] = [
        'id' => 'help_documents',
        'title' => $lang->help_documents,
...
function config_action_handler($action)
{
    ...
    $actions = [
        ...
        'thread_prefixes' => [
            'active' => 'thread_prefixes',
            'file' => 'thread_prefixes.php',
        ],
        'questions' => ['active' => 'questions', 'file' => 'questions.php'],
        'report_reasons' => [
            'active' => 'report_reasons',
            'file' => 'report_reasons.php',
        ],
    ];
