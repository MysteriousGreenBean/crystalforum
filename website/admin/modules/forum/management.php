...
if (
    ...
    $mybb->input['action'] == 'copy' ||
    $mybb->input['action'] == 'permissions' ||
    !$mybb->input['action']
) {
    if (
        !empty($mybb->input['fid']) &&
        ($mybb->input['action'] == 'management' ||
            $mybb->input['action'] == 'edit' ||
            $mybb->input['action'] == 'copy' ||
            !$mybb->input['action'])
    ) {
        $sub_tabs['view_forum'] = [
            ...
            'link' =>
                'index.php?module=forum-management&amp;fid=' .
                $mybb->input['fid'],
        ...
        $sub_tabs['add_child_forum'] = [
            ...
            'link' =>
                'index.php?module=forum-management&amp;action=add&amp;pid=' .
                $mybb->input['fid'],
            'description' => $lang->view_forum_desc,
        ];
        ...
        $sub_tabs['edit_forum_settings'] = [
            ...
            'link' =>
                'index.php?module=forum-management&amp;action=edit&amp;fid=' .
                $mybb->input['fid'],
        ...
        $sub_tabs['copy_forum'] = [
            ...
            'link' =>
                'index.php?module=forum-management&amp;action=copy&amp;fid=' .
                $mybb->input['fid'],
...
if ($mybb->input['action'] == 'copy') {
    ...
    if ($mybb->request_method == 'post') {
        ...
        if (!$errors) {
            // Copy permissions
            if (
                isset($mybb->input['copygroups']) &&
                is_array($mybb->input['copygroups']) &&
                count($mybb->input['copygroups']) > 0
            ) {
                ...
                $query = $db->simple_select(
                    'forumpermissions',
                    '*',
                    "fid='{$from}' AND gid IN ({$groups})"
                );
                $db->delete_query(
                    'forumpermissions',
                    "fid='{$to}' AND gid IN ({$groups})",
                    1
                );
            ...
            admin_redirect(
                "index.php?module=forum-management&action=edit&fid={$to}"
            );
        }
    }
    ...
    $form = new Form(
        'index.php?module=forum-management&amp;action=copy',
        'post'
    );
    ...
    while ($usergroup = $db->fetch_array($query)) {
        $usergroups[$usergroup['gid']] = htmlspecialchars_uni(
            $usergroup['title']
        );
    }
    ...
    $form_container->output_row(
        $lang->source_forum . ' <em>*</em>',
        $lang->source_forum_desc,
        $form->generate_forum_select('from', $copy_data['from'], [
            'id' => 'from',
        ]),
        'from'
    );
    $form_container->output_row(
        $lang->destination_forum . ' <em>*</em>',
        $lang->destination_forum_desc,
        $form->generate_forum_select('to', $copy_data['to'], [
            'id' => 'to',
            'main_option' => $lang->copy_to_new_forum,
        ]),
        'to'
    );
    $form_container->output_row(
        $lang->copy_settings_and_properties,
        $lang->copy_settings_and_properties_desc,
        $form->generate_yes_no_radio(
            'copyforumsettings',
            $copy_data['copyforumsettings']
        )
    );
    $form_container->output_row(
        $lang->copy_user_group_permissions,
        $lang->copy_user_group_permissions_desc,
        $form->generate_select_box(
            'copygroups[]',
            $usergroups,
            $copy_data['copygroups'],
            ['id' => 'copygroups', 'multiple' => true, 'size' => 5]
        ),
        'copygroups'
    );
    ...
    $form_container->output_row(
        $lang->title . ' <em>*</em>',
        '',
        $form->generate_text_box('title', $copy_data['title'], [
            'id' => 'title',
        ]),
        'title'
    );
    $form_container->output_row(
        $lang->description,
        '',
        $form->generate_text_area('description', $copy_data['description'], [
            'id' => 'description',
        ]),
        'description'
    );
    $form_container->output_row(
        $lang->parent_forum . ' <em>*</em>',
        $lang->parent_forum_desc,
        $form->generate_forum_select('pid', $copy_data['pid'], [
            'id' => 'pid',
            'main_option' => $lang->none,
        ]),
        'pid'
    );
...
if ($mybb->input['action'] == 'editmod') {
    ...
    if ($mybb->request_method == 'post') {
        ...
        if (!$errors) {
            ...
            $update_array = [
                ...
                'cansoftdeleteposts' => $mybb->get_input(
                    'cansoftdeleteposts',
                    MyBB::INPUT_INT
                ),
                'canrestoreposts' => $mybb->get_input(
                    'canrestoreposts',
                    MyBB::INPUT_INT
                ),
                ...
                'cansoftdeletethreads' => $mybb->get_input(
                    'cansoftdeletethreads',
                    MyBB::INPUT_INT
                ),
                'canrestorethreads' => $mybb->get_input(
                    'canrestorethreads',
                    MyBB::INPUT_INT
                ),
                ...
                'canviewunapprove' => $mybb->get_input(
                    'canviewunapprove',
                    MyBB::INPUT_INT
                ),
                'canviewdeleted' => $mybb->get_input(
                    'canviewdeleted',
                    MyBB::INPUT_INT
                ),
                'canopenclosethreads' => $mybb->get_input(
                    'canopenclosethreads',
                    MyBB::INPUT_INT
                ),
                'canstickunstickthreads' => $mybb->get_input(
                    'canstickunstickthreads',
                    MyBB::INPUT_INT
                ),
                'canapproveunapprovethreads' => $mybb->get_input(
                    'canapproveunapprovethreads',
                    MyBB::INPUT_INT
                ),
                'canapproveunapproveposts' => $mybb->get_input(
                    'canapproveunapproveposts',
                    MyBB::INPUT_INT
                ),
                'canapproveunapproveattachs' => $mybb->get_input(
                    'canapproveunapproveattachs',
                    MyBB::INPUT_INT
                ),
                'canmanagethreads' => $mybb->get_input(
                    'canmanagethreads',
                    MyBB::INPUT_INT
                ),
                'canmanagepolls' => $mybb->get_input(
                    'canmanagepolls',
                    MyBB::INPUT_INT
                ),
                'canpostclosedthreads' => $mybb->get_input(
                    'canpostclosedthreads',
                    MyBB::INPUT_INT
                ),
                'canmovetononmodforum' => $mybb->get_input(
                    'canmovetononmodforum',
                    MyBB::INPUT_INT
                ),
                'canusecustomtools' => $mybb->get_input(
                    'canusecustomtools',
                    MyBB::INPUT_INT
                ),
                'canmanageannouncements' => $mybb->get_input(
                    'canmanageannouncements',
                    MyBB::INPUT_INT
                ),
                'canmanagereportedposts' => $mybb->get_input(
                    'canmanagereportedposts',
                    MyBB::INPUT_INT
                ),
                'canviewmodlog' => $mybb->get_input(
                    'canviewmodlog',
                    MyBB::INPUT_INT
                ),
            ];
    ...
    $sub_tabs['edit_mod'] = [
        'title' => $lang->edit_mod,
        'link' =>
            'index.php?module=forum-management&amp;action=editmod&amp;mid=' .
            $mybb->input['mid'],
    ...
    $page->add_breadcrumb_item(
        ...
        "index.php?module=forum-management&amp;fid={$mod_data['fid']}#tab_moderators"
    );
    ...
    $form = new Form(
        'index.php?module=forum-management&amp;action=editmod',
        'post'
    );
    ...
    $form_container = new FormContainer(
        $lang->sprintf($lang->edit_mod_for, $mod_data[$fieldname])
    );
    $form_container->output_row(
        $lang->forum,
        $lang->forum_desc,
        $form->generate_forum_select('fid', $mod_data['fid'], ['id' => 'fid']),
        'fid'
    );

    $moderator_permissions = [
        $form->generate_check_box('caneditposts', 1, $lang->can_edit_posts, [
            'checked' => $mod_data['caneditposts'],
            'id' => 'caneditposts',
        ]),
        $form->generate_check_box(
            ...
            [
                'checked' => $mod_data['cansoftdeleteposts'],
                'id' => 'cansoftdeleteposts',
            ]
        ),
        $form->generate_check_box(
            'canrestoreposts',
            ...
            [
                'checked' => $mod_data['canrestoreposts'],
                'id' => 'canrestoreposts',
            ]
        ),
        $form->generate_check_box(
            ...
            ['checked' => $mod_data['candeleteposts'], 'id' => 'candeleteposts']
        ),
        $form->generate_check_box(
            'cansoftdeletethreads',
            1,
            ...
            [
                'checked' => $mod_data['cansoftdeletethreads'],
                'id' => 'cansoftdeletethreads',
            ]
        ),
        $form->generate_check_box(
            'canrestorethreads',
            ...
            [
                'checked' => $mod_data['canrestorethreads'],
                'id' => 'canrestorethreads',
            ]
        ),
        $form->generate_check_box(
            'candeletethreads',
            ...
            [
                'checked' => $mod_data['candeletethreads'],
                'id' => 'candeletethreads',
            ]
        ),
        $form->generate_check_box('canviewips', 1, $lang->can_view_ips, [
            'checked' => $mod_data['canviewips'],
            'id' => 'canviewips',
        ]),
        $form->generate_check_box(
            'canviewunapprove',
            ...
            [
                'checked' => $mod_data['canviewunapprove'],
                'id' => 'canviewunapprove',
            ]
        ),
        $form->generate_check_box(
            ...
            ['checked' => $mod_data['canviewdeleted'], 'id' => 'canviewdeleted']
        ),
        $form->generate_check_box(
            'canopenclosethreads',
            1,
            ...
            [
                'checked' => $mod_data['canopenclosethreads'],
                'id' => 'canopenclosethreads',
            ]
        ),
        $form->generate_check_box(
            'canstickunstickthreads',
            ...
            [
                'checked' => $mod_data['canstickunstickthreads'],
                'id' => 'canstickunstickthreads',
            ]
        ),
        $form->generate_check_box(
            'canapproveunapprovethreads',
            ...
            [
                'checked' => $mod_data['canapproveunapprovethreads'],
                'id' => 'canapproveunapprovethreads',
            ]
        ),
        $form->generate_check_box(
            'canapproveunapproveposts',
            ...
            [
                'checked' => $mod_data['canapproveunapproveposts'],
                'id' => 'canapproveunapproveposts',
            ]
        ),
        $form->generate_check_box(
            'canapproveunapproveattachs',
            ...
            [
                'checked' => $mod_data['canapproveunapproveattachs'],
                'id' => 'canapproveunapproveattachs',
            ]
        ),
        $form->generate_check_box(
            'canmanagethreads',
            ...
            [
                'checked' => $mod_data['canmanagethreads'],
                'id' => 'canmanagethreads',
            ]
        ),
        $form->generate_check_box(
            ...
            ['checked' => $mod_data['canmanagepolls'], 'id' => 'canmanagepolls']
        ),
        $form->generate_check_box(
            'canpostclosedthreads',
            1,
            ...
            [
                'checked' => $mod_data['canpostclosedthreads'],
                'id' => 'canpostclosedthreads',
            ]
        ),
        $form->generate_check_box(
            'canmovetononmodforum',
            ...
            [
                'checked' => $mod_data['canmovetononmodforum'],
                'id' => 'canmovetononmodforum',
            ]
        ),
        $form->generate_check_box(
            'canusecustomtools',
            ...
            [
                'checked' => $mod_data['canusecustomtools'],
                'id' => 'canusecustomtools',
            ]
        ),
    ];
    $form_container->output_row(
        $lang->moderator_permissions,
        '',
    ...
    $moderator_cp_permissions = [
        $form->generate_check_box(
            ...
            [
                'checked' => $mod_data['canmanageannouncements'],
                'id' => 'canmanageannouncements',
            ]
        ),
        $form->generate_check_box(
            'canmanagereportedposts',
            ...
            [
                'checked' => $mod_data['canmanagereportedposts'],
                'id' => 'canmanagereportedposts',
            ]
        ),
        $form->generate_check_box('canviewmodlog', 1, $lang->can_view_mod_log, [
            'checked' => $mod_data['canviewmodlog'],
            'id' => 'canviewmodlog',
        ]),
    ];
    $form_container->output_row(
        $lang->moderator_cp_permissions,
        $lang->moderator_cp_permissions_desc,
        "<div class=\"forum_settings_bit\">" .
            implode(
                "</div><div class=\"forum_settings_bit\">",
                $moderator_cp_permissions
...
if ($mybb->input['action'] == 'clear_permission') {
    ...
    if ($mybb->request_method == 'post') {
        ...
        admin_redirect(
            "index.php?module=forum-management&fid={$fid}#tab_permissions"
        );
    } else {
        $page->output_confirm_action(
            "index.php?module=forum-management&amp;action=clear_permission&amp;pid={$pid}&amp;gid={$gid}&amp;fid={$fid}",
            $lang->confirm_clear_custom_permission
        );
    }
}
    ...
    if ($mybb->request_method == 'post') {
        ...
        if (isset($mybb->input['permissions'])) {
            ...
            foreach ($fields_array as $field) {
                if (
                    strpos($field['Field'], 'can') !== false ||
                    strpos($field['Field'], 'mod') !== false
                ) {
                    if (
                        array_key_exists(
                            $field['Field'],
                            $mybb->input['permissions']
                        )
                    ) {
                        $update_array[$db->escape_string($field['Field'])] =
                            (int) $mybb->input['permissions'][$field['Field']];
                    } else {
        ...
        if ($mybb->input['ajax'] == 1) {
            echo json_encode(
                "<script type=\"text/javascript\">$('#row_{$gid}').html('" .
                    str_replace(
                        ["'", "\t", "\n"],
                        ["\\'", '', ''],
                        retrieve_single_permissions_row($gid, $fid)
                    ) .
                    "'); QuickPermEditor.init({$gid});</script>"
            );
            die();
        } else {
    ...
    if ($mybb->input['ajax'] != 1) {
        ...
        if ($mybb->input['fid'] && $mybb->input['gid']) {
            $sub_tabs['edit_permissions'] = [
                ...
                'link' =>
                    'index.php?module=forum-management&amp;action=permissions&amp;fid=' .
                    $mybb->input['fid'] .
                    '&amp;gid=' .
                    $mybb->input['gid'],
            ...
            $sub_tabs['edit_permissions'] = [
                'title' => $lang->forum_permissions,
                'link' =>
                    'index.php?module=forum-management&amp;action=permissions&amp;pid=' .
...
// -->
    ...
    if (
        !empty($mybb->input['pid']) ||
        (!empty($mybb->input['gid']) && !empty($mybb->input['fid']))
    ) {
        if ($mybb->get_input('ajax') != 1) {
            $form = new Form(
                'index.php?module=forum-management&amp;action=permissions',
                'post'
            );
        } else {
            $form = new Form(
                'index.php?module=forum-management&amp;action=permissions&amp;ajax=1&amp;pid=' .
                    $mybb->get_input('pid', MyBB::INPUT_INT) .
                    '&amp;gid=' .
        ...
        if ($usergroup['gid'] == 1) {
            $hidefields = [
                ...
                'candeletethreads',
                'caneditattachments',
                'canviewdeletetionnotice',
            ];
        }

        $groups = $plugins->run_hooks(
        ...
        foreach ($fields_array as $field) {
            if (
                !in_array($field['Field'], $hidefields) &&
                (strpos($field['Field'], 'can') !== false ||
                    strpos($field['Field'], 'mod') !== false)
            ) {
        ...
        foreach (array_unique(array_values($groups)) as $group) {
            ...
            foreach ($field_list[$group] as $field) {
                ...
                $fields[] = $form->generate_check_box(
                    ...
                    $lang->$lang_field,
                    [
                        'checked' => !empty($permission_data[$field]),
                        'id' => $field,
                    ]
                );
            }
        ...
        if ($mybb->input['ajax'] == 1) {
            $buttons[] = $form->generate_submit_button($lang->cancel, [
                'onclick' => '$.modal.close(); return false;',
            ]);
            $buttons[] = $form->generate_submit_button(
                $lang->save_permissions,
                ['id' => 'savePermissions']
            );
            $form->output_submit_wrapper($buttons);
            $form->end();
...
if ($mybb->input['action'] == 'add') {
    ...
    if ($mybb->request_method == 'post') {
        ...
        if (!$errors) {
            ...
            $insert_array = [
                ...
                'allowmycode' => $mybb->get_input(
                    'allowmycode',
                    MyBB::INPUT_INT
                ),
                'allowsmilies' => $mybb->get_input(
                    'allowsmilies',
                    MyBB::INPUT_INT
                ),
                'allowimgcode' => $mybb->get_input(
                    'allowimgcode',
                    MyBB::INPUT_INT
                ),
                'allowvideocode' => $mybb->get_input(
                    'allowvideocode',
                    MyBB::INPUT_INT
                ),
                'allowpicons' => $mybb->get_input(
                    'allowpicons',
                    MyBB::INPUT_INT
                ),
                'allowtratings' => $mybb->get_input(
                    'allowtratings',
                    MyBB::INPUT_INT
                ),
                'usepostcounts' => $mybb->get_input(
                    'usepostcounts',
                    MyBB::INPUT_INT
                ),
                'usethreadcounts' => $mybb->get_input(
                    'usethreadcounts',
                    MyBB::INPUT_INT
                ),
                'requireprefix' => $mybb->get_input(
                    'requireprefix',
                    MyBB::INPUT_INT
                ),
                ...
                'defaultdatecut' => $mybb->get_input(
                    'defaultdatecut',
                    MyBB::INPUT_INT
                ),
                'defaultsortby' => $db->escape_string(
                    $mybb->input['defaultsortby']
                ),
                'defaultsortorder' => $db->escape_string(
                    $mybb->input['defaultsortorder']
                ),
            ];
    ...
    $form = new Form(
        'index.php?module=forum-management&amp;action=add',
        'post'
    );
    ...
    $form_container->output_row(
        $lang->title . ' <em>*</em>',
        '',
        $form->generate_text_box('title', $forum_data['title'], [
            'id' => 'title',
        ]),
        'title'
    );
    $form_container->output_row(
        $lang->description,
        '',
        $form->generate_text_area('description', $forum_data['description'], [
            'id' => 'description',
        ]),
        'description'
    );
    $form_container->output_row(
        $lang->parent_forum . ' <em>*</em>',
        $lang->parent_forum_desc,
        $form->generate_forum_select('pid', $forum_data['pid'], [
            'id' => 'pid',
            'main_option' => $lang->none,
        ]),
        'pid'
    ...
    $form_container->output_row(
        $lang->display_order,
        '',
        $form->generate_numeric_field('disporder', $forum_data['disporder'], [
            'id' => 'disporder',
            'min' => 0,
        ]),
        'disporder'
    ...
    $form_container = new FormContainer(
        "<div class=\"float_right\" style=\"font-weight: normal;\"><a href=\"#\" onclick=\"$('#additional_options_link').toggle(); $('#additional_options').fadeToggle('fast'); return false;\">{$lang->hide_additional_options}</a></div>" .
            $lang->additional_forum_options
    );
    $form_container->output_row(
        $lang->forum_link,
        $lang->forum_link_desc,
        $form->generate_text_box('linkto', $forum_data['linkto'], [
            'id' => 'linkto',
        ]),
        'linkto'
    );
    $form_container->output_row(
        $lang->forum_password,
        $lang->forum_password_desc,
        $form->generate_text_box('password', $forum_data['password'], [
            'id' => 'password',
        ]),
        'password'
    );
    ...
    $access_options = [
        $form->generate_check_box(
            'active',
            1,
            $lang->forum_is_active .
                "<br />\n<small>{$lang->forum_is_active_desc}</small>",
            ['checked' => $forum_data['active'], 'id' => 'active']
        ),
        $form->generate_check_box(
            'open',
            1,
            $lang->forum_is_open .
                "<br />\n<small>{$lang->forum_is_open_desc}</small>",
            ['checked' => $forum_data['open'], 'id' => 'open']
        ),
    ];
    ...
    $query = $db->simple_select(
        'themes',
        'tid,name',
        "name!='((master))' AND name!='((master-backup))'",
        ['order_by' => 'name']
    );
    ...
    $style_options = [
        $form->generate_check_box(
            'overridestyle',
            1,
            $lang->override_user_style,
            ['checked' => $forum_data['overridestyle'], 'id' => 'overridestyle']
        ),
        $lang->forum_specific_style .
        "<br />\n" .
        $form->generate_select_box('style', $styles, $forum_data['style'], [
            'id' => 'style',
        ]),
    ];
    ...
    $forum_rules = [
        ...
        $form->generate_select_box(
            ...
            $display_methods,
            $forum_data['rulestype'],
            ['checked' => $forum_data['rulestype'], 'id' => 'rulestype']
        ),
        $lang->title .
        "<br />\n" .
        $form->generate_text_box('rulestitle', $forum_data['rulestitle'], [
            'checked' => $forum_data['rulestitle'],
            'id' => 'rulestitle',
        ]),
        $lang->rules .
        "<br />\n" .
        $form->generate_text_area('rules', $forum_data['rules'], [
            'checked' => $forum_data['rules'],
            'id' => 'rules',
        ]),
    ];
    ...
    $form_container->output_row(
        ...
        '',
        "<div class=\"forum_settings_bit\">" .
            implode("</div><div class=\"forum_settings_bit\">", $forum_rules) .
            '</div>'
    );
    ...
    $view_options = [
        ...
        $form->generate_select_box(
            ...
            $forum_data['defaultdatecut'],
            [
                'checked' => $forum_data['defaultdatecut'],
                'id' => 'defaultdatecut',
            ]
        ),
        ...
        $form->generate_select_box(
            ...
            $default_sort_by,
            $forum_data['defaultsortby'],
            ['checked' => $forum_data['defaultsortby'], 'id' => 'defaultsortby']
        ),
        ...
        $form->generate_select_box(
            ...
            $forum_data['defaultsortorder'],
            [
                'checked' => $forum_data['defaultsortorder'],
                'id' => 'defaultsortorder',
            ]
        ),
    ];
    ...
    $form_container->output_row(
        $lang->default_view_options,
        '',
        "<div class=\"forum_settings_bit\">" .
            implode("</div><div class=\"forum_settings_bit\">", $view_options) .
            '</div>'
    );

    $misc_options = [
        $form->generate_check_box('allowhtml', 1, $lang->allow_html, [
            'checked' => $forum_data['allowhtml'],
            'id' => 'allowhtml',
        ]),
        $form->generate_check_box('allowmycode', 1, $lang->allow_mycode, [
            'checked' => $forum_data['allowmycode'],
            'id' => 'allowmycode',
        ]),
        $form->generate_check_box('allowsmilies', 1, $lang->allow_smilies, [
            'checked' => $forum_data['allowsmilies'],
            'id' => 'allowsmilies',
        ]),
        $form->generate_check_box('allowimgcode', 1, $lang->allow_img_code, [
            'checked' => $forum_data['allowimgcode'],
            'id' => 'allowimgcode',
        ]),
        $form->generate_check_box(
            'allowvideocode',
            1,
            $lang->allow_video_code,
            [
                'checked' => $forum_data['allowvideocode'],
                'id' => 'allowvideocode',
            ]
        ),
        $form->generate_check_box('allowpicons', 1, $lang->allow_post_icons, [
            'checked' => $forum_data['allowpicons'],
            'id' => 'allowpicons',
        ]),
        $form->generate_check_box(
            'allowtratings',
            1,
            $lang->allow_thread_ratings,
            ['checked' => $forum_data['allowtratings'], 'id' => 'allowtratings']
        ),
        $form->generate_check_box('showinjump', 1, $lang->show_forum_jump, [
            'checked' => $forum_data['showinjump'],
            'id' => 'showinjump',
        ]),
        $form->generate_check_box('usepostcounts', 1, $lang->use_postcounts, [
            'checked' => $forum_data['usepostcounts'],
            'id' => 'usepostcounts',
        ]),
        $form->generate_check_box(
            'usethreadcounts',
            1,
            $lang->use_threadcounts,
            [
                'checked' => $forum_data['usethreadcounts'],
                'id' => 'usethreadcounts',
            ]
        ),
        $form->generate_check_box(
    ...
    $form_container->output_row(
        ...
        '',
        "<div class=\"forum_settings_bit\">" .
            implode("</div><div class=\"forum_settings_bit\">", $misc_options) .
            '</div>'
    );
    $form_container->end();
    echo '</div>';
    ...
    $form_container->output_row_header($lang->overview_allowed_actions, [
        'class' => 'align_center',
    ]);
    $form_container->output_row_header($lang->overview_disallowed_actions, [
        'class' => 'align_center',
    ]);
    ...
    if ($mybb->request_method == 'post') {
        foreach ($usergroups as $usergroup) {
            if (isset($mybb->input['fields_' . $usergroup['gid']])) {
                $input_permissions =
                    $mybb->input['fields_' . $usergroup['gid']];
                ...
                foreach ($input_permissions as $input_permission) {
                    $mybb->input['permissions'][$usergroup['gid']][
                        $input_permission
                    ] = 1;
                }
            }
    ...
    foreach ($usergroups as $usergroup) {
        ...
        if (!empty($mybb->input['default_permissions'][$usergroup['gid']])) {
            if (
                isset($existing_permissions) &&
                is_array($existing_permissions) &&
                $existing_permissions[$usergroup['gid']]
            ) {
                $perms = $existing_permissions[$usergroup['gid']];
                $default_checked = false;
            } elseif (
                is_array($cached_forum_perms) &&
                isset($forum_data['fid']) &&
                !empty(
                    $cached_forum_perms[$forum_data['fid']][$usergroup['gid']]
                )
            ) {
                $perms =
                    $cached_forum_perms[$forum_data['fid']][$usergroup['gid']];
                ...
                isset($forum_data['fid']) &&
                !empty(
                    $cached_forum_perms[$forum_data['pid']][$usergroup['gid']]
                )
            ) {
                $perms =
                    $cached_forum_perms[$forum_data['pid']][$usergroup['gid']];
        ...
        foreach ($field_list as $forum_permission => $forum_perm_title) {
            if (isset($mybb->input['permissions'])) {
                if (
                    !empty(
                        $mybb->input['default_permissions'][$usergroup['gid']]
                    )
                ) {
                    $default_checked = true;
                } else {
        ...
        $form_container->output_cell(
            "<strong>{$usergroup['title']}</strong><br />" .
                $form->generate_check_box(
                    "default_permissions[{$usergroup['gid']}]",
                    1,
                    '',
                    [
                        'id' => "default_permissions_{$usergroup['gid']}",
                        'checked' => $default_checked,
                    ]
                ) .
                " <small><label for=\"default_permissions_{$usergroup['gid']}\">{$lang->permissions_use_group_default}</label></small>"
        );
...
if ($mybb->input['action'] == 'edit') {
        ...
        if (!$errors) {
            ...
            if ($pid != $forum_data['pid']) {
                ...
                while ($child = $db->fetch_array($query)) {
                    $db->update_query(
                        'forums',
                        ['parentlist' => make_parent_list($child['fid'])],
                        "fid='{$child['fid']}'"
                    );
                }
            }
            ...
            foreach ($mybb->input as $id => $permission) {
                ...
                if (
                    $mybb->input['fields_default_' . $gid] == $permission &&
                    $mybb->input['fields_inherit_' . $gid] == 1
                ) {
                    $inherit[$gid] = 1;
                    continue;
                }
    ...
    $form = new Form(
        'index.php?module=forum-management&amp;action=edit',
        'post'
    );
    echo $form->generate_hidden_field('fid', $fid);
    ...
    $query = $db->simple_select('usergroups', '*', '', ['order_dir' => 'name']);
    while ($usergroup = $db->fetch_array($query)) {
        $usergroups[$usergroup['gid']] = $usergroup;
    }
    ...
    $form_container = new FormContainer(
        $lang->sprintf($lang->forum_permissions_in, $forum_data['name'])
    );
    $form_container->output_row_header($lang->permissions_group, [
        'class' => 'align_center',
        'style' => 'width: 30%',
    ...
    foreach ($usergroups as $usergroup) {
        ...
        if (isset($mybb->input['default_permissions'])) {
            if ($mybb->input['default_permissions'][$usergroup['gid']]) {
                if (
                    ...
                    $perms =
                        $cached_forum_perms[$forum_data['fid']][
                            $usergroup['gid']
                        ];
                    $default_checked = true;
                } elseif (
                    ...
                    $perms =
                        $cached_forum_perms[$forum_data['pid']][
                            $usergroup['gid']
                        ];
                    $default_checked = true;
                }
            ...
            if (
                isset($existing_permissions) &&
                is_array($existing_permissions) &&
                !empty($existing_permissions[$usergroup['gid']])
            ) {
                $perms = $existing_permissions[$usergroup['gid']];
                $default_checked = false;
            } elseif (
        ...
        $form_container->output_cell(
            "<strong>{$usergroup['title']}</strong> <small style=\"vertical-align: middle;\">({$inherited_text})</small>"
        );
        ...
        $field_select .= $form->generate_hidden_field(
            'fields_inherit_' . $usergroup['gid'],
            (int) $default_checked,
            ['id' => 'fields_inherit_' . $usergroup['gid']]
        );
        $field_select .= $form->generate_hidden_field(
            'fields_default_' . $usergroup['gid'],
            @implode(',', @array_keys($perms_checked, '1')),
            ['id' => 'fields_default_' . $usergroup['gid']]
        );
        $field_select = str_replace("'", "\\'", $field_select);
        $field_select = str_replace("\n", '', $field_select);
...
//]]>
        ...
        if (!$default_checked) {
            $form_container->output_cell(
                "<a href=\"index.php?module=forum-management&amp;action=permissions&amp;pid={$perms['pid']}\" onclick=\"MyBB.popupWindow('index.php?module=forum-management&action=permissions&pid={$perms['pid']}&ajax=1', null, true); return false;\">{$lang->edit_permissions}</a>",
                ['class' => 'align_center']
            );
            $form_container->output_cell(
                "<a href=\"index.php?module=forum-management&amp;action=clear_permission&amp;pid={$perms['pid']}&amp;my_post_key={$mybb->post_code}\" onclick=\"return AdminCP.deleteConfirmation(this, '{$lang->confirm_clear_custom_permission}')\">{$lang->clear_custom_perms}</a>",
                ['class' => 'align_center']
            );
        } else {
            $form_container->output_cell(
                "<a href=\"index.php?module=forum-management&amp;action=permissions&amp;gid={$usergroup['gid']}&amp;fid={$fid}\" onclick=\"MyBB.popupWindow('index.php?module=forum-management&action=permissions&gid={$usergroup['gid']}&fid={$fid}&ajax=1', null, true); return false;\">{$lang->set_custom_perms}</a>",
...
if ($mybb->input['action'] == 'deletemod') {
    ...
    $query = $db->simple_select(
        'moderators',
        '*',
        "id='{$modid}' AND isgroup = '{$isgroup}' AND fid='{$fid}'"
    );
    ...
    if ($mybb->request_method == 'post') {
        ...
        $page->output_confirm_action(
            "index.php?module=forum-management&amp;action=deletemod&amp;fid={$mod['fid']}&amp;uid={$mod['uid']}",
            $lang->confirm_moderator_deletion
        );
    }
}
...
if ($mybb->input['action'] == 'delete') {
    ...
    if ($mybb->request_method == 'post') {
        ...
        $page->output_confirm_action(
            "index.php?module=forum-management&amp;action=delete&amp;fid={$forum['fid']}",
            $lang->confirm_forum_deletion
        );
    }
}
...
if (!$mybb->input['action']) {
    ...
    if ($mybb->request_method == 'post') {
        if ($mybb->get_input('update') == 'permissions') {
            ...
            if (!empty($mybb->input['usergroup'])) {
                ...
                $newmod = $newmoduser = get_user_by_username(
                    $mybb->input['username'],
                    $options
                );
                ...
                if (!$db->num_rows($query)) {
                    ...
                    if (!$isgroup) {
                        ...
                        if ($groupperms['canmodcp'] != 1) {
                            if (
                                $newmoduser['usergroup'] == 2 ||
                                $newmoduser['usergroup'] == 5
                            ) {
                    ...
                    admin_redirect(
                        "index.php?module=forum-management&action=editmod&mid={$mid}"
                    );
                } else {
                    flash_message(
                        $lang->error_moderator_already_added,
                        'error'
                    );
                    admin_redirect(
                        "index.php?module=forum-management&fid={$fid}#tab_moderators"
            ...
            if (
                !empty($mybb->input['disporder']) &&
                is_array($mybb->input['disporder'])
            ) {
                ...
                flash_message(
                    $lang->success_forum_disporder_updated,
                    'success'
                );
                admin_redirect(
                    'index.php?module=forum-management&fid=' .
    ...
    if ($fid) {
        ...
        $tabs = $plugins->run_hooks(
            'admin_forum_management_start_graph_tabs',
            $tabs
        );
        $page->output_tab_control($tabs);
        ...
        $form_container = new FormContainer(
            $lang->sprintf($lang->in_forums, $forum_cache[$fid]['name'])
        );
    } else {
    ...
    if ($form_container->num_rows() == 0) {
        $form_container->output_cell($lang->no_forums, ['colspan' => 3]);
        $form_container->construct_row();
        $no_results = true;
    }
            ...
            if (isset($mybb->input['default_permissions'])) {
                if ($mybb->input['default_permissions'][$usergroup['gid']]) {
                    if (
                        ...
                        $cached_forum_perms[$forum['fid']][$usergroup['gid']]
                    ) {
                        $perms =
                            $cached_forum_perms[$forum['fid']][
                                $usergroup['gid']
                            ];
                        $default_checked = true;
                    } elseif (
                        is_array($cached_forum_perms) &&
                        isset($cached_forum_perms[$forum['pid']]) &&
                        $cached_forum_perms[$forum['pid']][$usergroup['gid']]
                    ) {
                        $perms =
                            $cached_forum_perms[$forum['pid']][
                                $usergroup['gid']
                            ];
                        $default_checked = true;
                    }
...
//]]>
        ...
        $form_container = new FormContainer(
            $lang->sprintf(
                $lang->moderators_assigned_to,
                $forum_cache[$fid]['name']
            )
        );
        $form_container->output_row_header($lang->name, ['width' => '75%']);
        $form_container->output_row_header($lang->controls, [
            'class' => 'align_center',
            'style' => 'width: 200px',
            'colspan' => 2,
        ...
        $query = $db->query(
			...
			LEFT JOIN " .
                TABLE_PREFIX .
                "users u ON (m.isgroup='0' AND m.id=u.uid)
			LEFT JOIN " .
                TABLE_PREFIX .
                "usergroups g ON (m.isgroup='1' AND m.id=g.gid)
			WHERE fid='{$fid}'
        ...
        while ($moderator = $db->fetch_array($query)) {
            if ($moderator['isgroup']) {
                $moderator[
                    'img'
                ] = "<img src=\"styles/{$page->style}/images/icons/group.png\" alt=\"{$lang->permissions_group}\" title=\"{$lang->permissions_group}\" />";
                $form_container->output_cell(
                    "{$moderator['img']} <a href=\"index.php?module=user-groups&amp;action=edit&amp;gid={$moderator['id']}\">" .
                        htmlspecialchars_uni($moderator['title']) .
                        " ({$lang->usergroup} {$moderator['id']})</a>"
                );
                $form_container->output_cell(
                    "<a href=\"index.php?module=forum-management&amp;action=editmod&amp;mid={$moderator['mid']}\">{$lang->edit}</a>",
                    ['class' => 'align_center']
                );
                $form_container->output_cell(
                    "<a href=\"index.php?module=forum-management&amp;action=deletemod&amp;id={$moderator['id']}&amp;isgroup=1&amp;fid={$fid}&amp;my_post_key={$mybb->post_code}\" onclick=\"return AdminCP.deleteConfirmation(this, '{$lang->confirm_moderator_deletion}')\">{$lang->delete}</a>",
                    ['class' => 'align_center']
                );
            } else {
                $moderator[
                    'img'
                ] = "<img src=\"styles/{$page->style}/images/icons/user.png\" alt=\"{$lang->permissions_user}\" title=\"{$lang->permissions_user}\" />";
                $form_container->output_cell(
                    "{$moderator['img']} <a href=\"index.php?module=user-users&amp;action=edit&amp;uid={$moderator['id']}\">" .
                ...
                $form_container->output_cell(
                    "<a href=\"index.php?module=forum-management&amp;action=deletemod&amp;id={$moderator['id']}&amp;isgroup=0&amp;fid={$fid}&amp;my_post_key={$mybb->post_code}\" onclick=\"return AdminCP.deleteConfirmation(this, '{$lang->confirm_moderator_deletion}')\">{$lang->delete}</a>",
                    ['class' => 'align_center']
                );
            }
            $form_container->construct_row();
        ...
        if ($form_container->num_rows() == 0) {
            $form_container->output_cell($lang->no_moderators, [
                'colspan' => 3,
            ]);
            $form_container->construct_row();
        }
        ...
        foreach ($usergroups as $group) {
            $modgroups[$group['gid']] =
                ...
                $group['gid'] .
                ': ' .
                htmlspecialchars_uni($group['title']);
        }
        ...
        $form_container->output_row(
            $lang->usergroup . ' <em>*</em>',
            $lang->moderator_usergroup_desc,
            $form->generate_select_box(
                'usergroup',
                $modgroups,
                $mybb->input['usergroup'],
        ...
        $buttons = [$form->generate_submit_button($lang->add_user_moderator)];
        $form->output_submit_wrapper($buttons);
        $form->end();
 ...
 * @param int $depth
 */
function build_admincp_forums_list(
    &$form_container,
    &$form,
    $pid = 0,
    $depth = 1
    ...
    if (!is_array($forums_by_parent)) {
        ...
        foreach ($forum_cache as $forum) {
            $forums_by_parent[$forum['pid']][$forum['disporder']][
                $forum['fid']
            ] = $forum;
        }
    }
            ...
            if ($forum['type'] == 'c' && ($depth == 1 || $depth == 2)) {
                ...
                $form_container->output_cell(
                    "<div style=\"padding-left: " .
                        40 * ($depth - 1) .
                        "px;\"><a href=\"index.php?module=forum-management&amp;fid={$forum['fid']}\"><strong>{$forum['name']}</strong></a>{$sub_forums}</div>"
                );
                ...
                $popup->add_item(
                    $lang->edit_forum,
                    "index.php?module=forum-management&amp;action=edit&amp;fid={$forum['fid']}"
                );
                $popup->add_item(
                    $lang->subforums,
                    "index.php?module=forum-management&amp;fid={$forum['fid']}"
                );
                $popup->add_item(
                    $lang->moderators,
                    "index.php?module=forum-management&amp;fid={$forum['fid']}#tab_moderators"
                );
                $popup->add_item(
                    $lang->permissions,
                    "index.php?module=forum-management&amp;fid={$forum['fid']}#tab_permissions"
                );
                $popup->add_item(
                    $lang->forum_thread_prefixes,
                    "index.php?module=config-thread_prefixes&amp;fid={$forum['fid']}"
                );
                $popup->add_item(
                    $lang->add_child_forum,
                    "index.php?module=forum-management&amp;action=add&amp;pid={$forum['fid']}"
                );
                $popup->add_item(
                    $lang->copy_forum,
                    "index.php?module=forum-management&amp;action=copy&amp;fid={$forum['fid']}"
                );
                $popup->add_item(
                    $lang->delete_forum,
                    "index.php?module=forum-management&amp;action=delete&amp;fid={$forum['fid']}&amp;my_post_key={$mybb->post_code}",
                    "return AdminCP.deleteConfirmation(this, '{$lang->confirm_forum_deletion}')"
                );
                ...
                if ($forum['description']) {
                    $forum['description'] = preg_replace(
                        '#&(?!\#[0-9]+;)#si',
                        '&amp;',
                        $forum['description']
                    );
                ...
                $form_container->output_cell(
                    "<div style=\"padding-left: " .
                        40 * ($depth - 1) .
                        "px;\"><a href=\"index.php?module=forum-management&amp;fid={$forum['fid']}\">{$forum['name']}</a>{$forum['description']}{$sub_forums}</div>"
                );
                ...
                if ($donecount == $mybb->settings['subforumsindex']) {
                    if (subforums_count($forums_by_parent[$pid]) > $donecount) {
                        $sub_forums .=
                            ...
                            $lang->sprintf(
                                $lang->more_subforums,
                                subforums_count($forums_by_parent[$pid]) -
                                    $donecount
                            );
                        return;
                    }
