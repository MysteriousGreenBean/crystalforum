...
function user_action_handler($action)
{
    ...
    $actions = [
        'awaiting_activation' => [
            ...
            'file' => 'awaiting_activation.php',
        ],
        'group_promotions' => [
            'active' => 'group_promotions',
            'file' => 'group_promotions.php',
        ],
        'admin_permissions' => [
            'active' => 'admin_permissions',
