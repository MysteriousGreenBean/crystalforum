...
class FeedGenerator
{
    ...
    function generate_feed()
    {
        ...
        switch ($this->feed_format) {
            ...
            case 'json':
                $this->feed .=
                    "{\n\t\"version\": " .
                    json_encode('https://jsonfeed.org/version/1') .
                    ",\n";
                $this->feed .=
                    "\t\"title\": \"" . $this->channel['title'] . "\",\n";
                $this->feed .=
                    "\t\"home_page_url\": " .
                    json_encode($this->channel['link']) .
                    ",\n";
                $this->feed .=
                    "\t\"feed_url\": " .
                    json_encode($this->channel['link'] . 'syndication.php') .
                    ",\n";
                $this->feed .=
                    "\t\"description\": " .
                    json_encode($this->channel['description']) .
                    ",\n";
                $this->feed .= "\t\"items\": [\n";
                $serial = 0;
                break;
            ...
            case 'atom1.0':
                ...
                $this->feed .=
                    ...
                    $this->sanitize_content($this->channel['title']) .
                    "]]></title>\n";
                $this->feed .=
                    "\t<subtitle type=\"html\"><![CDATA[" .
                    $this->sanitize_content($this->channel['description']) .
                    "]]></subtitle>\n";
            ...
            default:
                ...
                $this->feed .=
                    ...
                    "]]></description>\n";
                $this->feed .=
                    "\t\t<pubDate>" . $this->channel['date'] . "</pubDate>\n";
            ...
            switch ($this->feed_format) {
                ...
                case 'atom1.0':
                    ...
                    if (!empty($item['author'])) {
                        ...
                        $this->feed .= "\t\t<author>\n";
                        $this->feed .=
                            "\t\t\t<name type=\"html\" xml:space=\"preserve\"><![CDATA[" .
                            $this->sanitize_content($author) .
                            "]]></name>\n";
                        $this->feed .= "\t\t</author>\n";
                    }
                    ...
                    $this->feed .=
                        "\t\t<title xml:space=\"preserve\"><![CDATA[" .
                        $this->sanitize_content($item['title']) .
                        "]]></title>\n";
                    $this->feed .=
                        "\t\t<content type=\"html\" xml:space=\"preserve\" xml:base=\"{$item['link']}\"><![CDATA[" .
                        $this->sanitize_content($item['description']) .
                        "]]></content>\n";
                    $this->feed .=
    ...
    function output_feed()
    {
        ...
        switch ($this->feed_format) {
            ...
            case 'atom1.0':
                header(
                    "Content-Type: application/atom+xml; charset=\"{$lang->settings['charset']}\""
                );
                break;
            default:
                header(
                    "Content-Type: text/xml; charset=\"{$lang->settings['charset']}\""
                );
        }
