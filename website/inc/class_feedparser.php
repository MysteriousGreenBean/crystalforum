...
class FeedParser
{
    ...
    {
        foreach (['title', 'link', 'description', 'pubdate'] as $value) {
        ...
        $this->channel = [
            ...
            'date_timestamp' => $this->get_rss_timestamp(
                $feed_contents['channel']['pubdate']['value']
            ),
        ];
        ...
        foreach ($feed_contents['channel']['item'] as $feed_item) {
            ...
            if (array_key_exists('pubdate', $feed_item)) {
                ...
                $item['date_timestamp'] = $this->get_rss_timestamp(
                    $item['date']
                );
            }
            ...
            } elseif (array_key_exists('content', $feed_item)) {
            ...
            elseif (array_key_exists('author', $feed_item)) {
