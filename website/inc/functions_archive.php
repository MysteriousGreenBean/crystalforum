...
<body>
<div id="container">
<h1><a href="<?php echo $mybb->settings[
    'bburl'
]; ?>/index.php"><?php echo $mybb->settings['bbname_orig']; ?></a></h1>
...
<div id="infobox"><?php echo $lang->sprintf(
    $lang->archive_note,
    $fullurl
); ?></div>
<div id="content">
...
<div id="footer">
<?php echo $lang->powered_by; ?> <a href="https://mybb.com">MyBB</a><?php echo $mybbversion; ?>, &copy; 2002-<?php echo date(
    'Y'
); ?> <a href="https://mybb.com">MyBB Group</a>
</div>
</body>
</html>
<?php
