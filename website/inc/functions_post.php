...
function build_postbit($post, $post_type = 0)
{
    ...
    switch ($post_type) {
        ...
        case 2: // Private message
            ...
            $parser_options['allow_smilies'] =
                $mybb->settings['pmsallowsmilies'];
            $parser_options['allow_imgcode'] =
                $mybb->settings['pmsallowimgcode'];
            $parser_options['allow_videocode'] =
                $mybb->settings['pmsallowvideocode'];
            $parser_options['me_username'] = $post['username'];
            $parser_options['filter_badwords'] = 1;
            $id = $pmid;
            break;
        case 3: // Announcement
            ...
            $parser_options['allow_html'] =
                ...
                $announcementarray['allowhtml'];
            $parser_options['allow_mycode'] = $announcementarray['allowmycode'];
            $parser_options['allow_smilies'] =
                $announcementarray['allowsmilies'];
    ...
    if (!empty($usergroup['image'])) {
        ...
        eval(
            "\$post['groupimage'] = \"" .
                $templates->get('postbit_groupimage') .
                "\";"
        );
    }
    ...
    if ($post['userusername']) {
        ...
        $post['username_formatted'] = format_name(
            $post['username'],
            $post['usergroup'],
            $post['displaygroup']
        );
        $post['profilelink'] = build_profile_link(
            $post['username_formatted'],
            $post['uid']
        );
        ...
        if ($post['starimage'] && isset($post['stars'])) {
            ...
            for ($i = 0; $i < $post['stars']; ++$i) {
                eval(
                    "\$post['userstars'] .= \"" .
                        $templates->get('postbit_userstar', 1, 0) .
                        "\";"
                );
            }
        ...
        if (
            ...
            if ($post['away'] == 1 && $mybb->settings['allowaway'] != 0) {
                eval(
                    "\$post['onlinestatus'] = \"" .
                        $templates->get('postbit_away') .
                        "\";"
                );
            } else {
                eval(
                    "\$post['onlinestatus'] = \"" .
                        $templates->get('postbit_offline') .
                        "\";"
                );
            }
        }
        ...
        if (
            ...
            (($post['receivepms'] != 0 &&
                $usergroup['canusepms'] != 0 &&
                $mybb->usergroup['cansendpms'] == 1 &&
                my_strpos(
                    ',' . $post['ignorelist'] . ',',
                    ',' . $mybb->user['uid'] . ','
                ) === false) ||
        ...
        if (
            ...
            eval(
                "\$post['button_rep'] = \"" .
                    $templates->get('postbit_rep_button') .
                    "\";"
            );
        }
        ...
        $post['userregdate'] = my_date(
            $mybb->settings['regdateformat'],
            $post['regdate']
        );
        ...
        if (
            ...
            $post['userreputation'] = get_reputation(
                $post['reputation'],
                $post['uid']
            );
            eval(
                "\$post['replink'] = \"" .
                    $templates->get('postbit_reputation') .
                    "\";"
            );
        }
        ...
        if (
            ...
            $warning_level = round(
                ($post['warningpoints'] / $mybb->settings['maxwarningpoints']) *
                    100
            );
            ...
            eval(
                "\$post['warninglevel'] = \"" .
                    $templates->get('postbit_warninglevel') .
                    "\";"
            );
        }
        ...
        if (
            ...
            eval(
                "\$post['button_purgespammer'] = \"" .
                    $templates->get('postbit_purgespammer') .
                    "\";"
            );
        }
                ...
                if (!empty($post[$fieldfid])) {
                    ...
                    if (
                        ...
                        if ($field['type'] == 'textarea') {
                            $field_parser_options['me_username'] =
                                $post['username'];
                        } else {
                        ...
                        $post['fieldvalue'] = $parser->parse_message(
                            $post[$fieldfid],
                            $field_parser_options
                        );
                    }
                    ...
                    eval(
                        "\$post['profilefield'] .= \"" .
                            $templates->get('postbit_profilefield') .
                            "\";"
                    );
                }
            }
        ...
        eval(
            "\$post['user_details'] = \"" .
                $templates->get('postbit_author_user') .
                "\";"
        );
    } else {
        ...
        eval(
            "\$post['user_details'] = \"" .
                $templates->get('postbit_author_guest') .
                "\";"
        );
    }
    ...
    if ($post_type == 2 && $post['pmid']) {
        ...
        eval(
            "\$post['button_reply_pm'] = \"" .
                $templates->get('postbit_reply_pm') .
                "\";"
        );
        eval(
            "\$post['button_forward_pm'] = \"" .
                $templates->get('postbit_forward_pm') .
                "\";"
        );
        eval(
            "\$post['button_delete_pm'] = \"" .
                $templates->get('postbit_delete_pm') .
                "\";"
        );
        ...
        if ($replyall == true) {
            eval(
                "\$post['button_replyall_pm'] = \"" .
                    $templates->get('postbit_replyall_pm') .
                    "\";"
            );
        }
    }
    ...
    if (!$post_type) {
        ...
        if (
            ...
            (($mybb->settings['showeditedby'] != 0 &&
                $usergroup['cancp'] == 0 &&
                !is_moderator($post['fid'], '', $post['uid'])) ||
                ($mybb->settings['showeditedbyadmin'] != 0 &&
                    ($usergroup['cancp'] == 1 ||
                        is_moderator($post['fid'], '', $post['uid']))))
        ) {
            $post['editdate'] = my_date('relative', $post['edittime']);
            $post['editnote'] = $lang->sprintf(
                $lang->postbit_edited,
                $post['editdate']
            );
            $post['editusername'] = htmlspecialchars_uni($post['editusername']);
            $post['editedprofilelink'] = build_profile_link(
                $post['editusername'],
                $post['edituid']
            );
            $editreason = '';
            if ($post['editreason'] != '') {
                $post['editreason'] = $parser->parse_badwords(
                    $post['editreason']
                );
                $post['editreason'] = htmlspecialchars_uni($post['editreason']);
                eval(
                    "\$editreason = \"" .
                        $templates->get('postbit_editedby_editreason') .
                        "\";"
                );
            }
            eval(
                "\$post['editedmsg'] = \"" .
                    $templates->get('postbit_editedby') .
                    "\";"
            );
        }
        ...
        if (
            (is_moderator($fid, 'caneditposts') ||
                ($forumpermissions['caneditposts'] == 1 &&
                    $mybb->user['uid'] == $post['uid'] &&
                    $thread['closed'] != 1 &&
            ...
            eval(
                "\$post['input_editreason'] = \"" .
                    $templates->get('postbit_editreason') .
                    "\";"
            );
            eval(
                "\$post['button_edit'] = \"" .
                    $templates->get('postbit_edit') .
                    "\";"
            );
        }
        ...
        if ($mybb->user['uid'] != 0) {
            if (
                ...
                eval(
                    "\$post['button_quickdelete'] = \"" .
                        $templates->get('postbit_quickdelete') .
                        "\";"
                );
            } elseif (
            ...
            if (is_moderator($fid, 'canrestoreposts') && $postcounter != 1) {
                ...
                eval(
                    "\$post['button_quickrestore'] = \"" .
                        $templates->get('postbit_quickrestore') .
                        "\";"
                );
            }
        ...
        if (
            ...
            eval(
                "\$post['button_multiquote'] = \"" .
                    $templates->get('postbit_multiquote') .
                    "\";"
            );
        }
        ...
        if (
            !in_array($mybb->user['uid'], $skip_report) &&
            !empty($reportable['canbereported'])
        ) {
            eval(
                "\$post['button_report'] = \"" .
                    $templates->get('postbit_report') .
                    "\";"
            );
        }
    } elseif ($post_type == 3) {
        ...
        if (
            ...
            eval(
                "\$post['button_edit'] = \"" .
                    $templates->get('announcement_edit') .
                    "\";"
            );
            eval(
                "\$post['button_quickdelete'] = \"" .
                    $templates->get('announcement_quickdelete') .
                    "\";"
            );
        }
    }
    ...
    if (!$post_type || $post_type == 2) {
        if ($show_ips != 'no' && !empty($post['ipaddress'])) {
            ...
            if ($show_ips == 'show') {
                eval(
                    "\$post['iplogged'] = \"" .
                        $templates->get('postbit_iplogged_show') .
                        "\";"
                );
            } elseif (
                $show_ips == 'hide' &&
                (is_moderator($fid, 'canviewips') ||
                ...
                eval(
                    "\$post['iplogged'] = \"" .
                        $templates->get('postbit_iplogged_hiden') .
                        "\";"
                );
            }
        }
    ...
    if (!empty($mybb->input['highlight'])) {
        ...
        $post['subject'] = $parser->highlight_message(
            $post['subject'],
            $parser_options['highlight']
        );
    }
    ...
    if (
        isset($post['includesig']) &&
        $post['includesig'] != 0 &&
        $post['username'] &&
        $post['signature'] != '' &&
        ($mybb->user['uid'] == 0 || $mybb->user['showsigs'] != 0) &&
        ($post['suspendsignature'] == 0 ||
            ($post['suspendsignature'] == 1 &&
                $post['suspendsigtime'] != 0 &&
                $post['suspendsigtime'] < TIME_NOW)) &&
        $usergroup['canusesig'] == 1 &&
        ($usergroup['canusesigxposts'] == 0 ||
            ($usergroup['canusesigxposts'] > 0 &&
                $postnum > $usergroup['canusesigxposts'])) &&
        ...
        $post['signature'] = $parser->parse_message(
            $post['signature'],
            $sig_parser
        );
        eval(
            "\$post['signature'] = \"" .
                $templates->get('postbit_signature') .
                "\";"
        );
    } else {
        $post['signature'] = '';
    ...
    switch ($post_type) {
        ...
        default:
            ...
            if (
                ...
                $deleted_message = $lang->sprintf(
                    $lang->postbit_deleted_post_user,
                    $post['username']
                );
                eval(
                    "\$deleted_bit = \"" .
                        $templates->get('postbit_deleted') .
                        "\";"
                );
            ...
            if (
                ...
                $ignored_message = $lang->sprintf(
                    $lang->postbit_post_under_moderation,
                    $post['username']
                );
                eval(
                    "\$ignore_bit = \"" .
                        $templates->get('postbit_ignored') .
                        "\";"
                );
                $post_visibility = 'display: none;';
            }
            ...
            if (
                ...
                $ignored_message = $lang->sprintf(
                    $lang->postbit_currently_ignoring_user,
                    $post['username']
                );
                eval(
                    "\$ignore_bit = \"" .
    ...
    if (
        $post_type == 0 &&
        $forumpermissions['canviewdeletionnotice'] == 1 &&
        $post['visible'] == -1 &&
        !is_moderator($fid, 'canviewdeleted')
    ) {
        eval(
    ...
    if (isset($attachcache[$id]) && is_array($attachcache[$id])) {
        ...
        foreach ($attachcache[$id] as $aid => $attachment) {
            if ($attachment['visible']) {
                ...
                $attachment['downloads'] = my_number_format(
                ...
                if (
                    ...
                    if (
                        ...
                        (($attachment['thumbnail'] == 'SMALL' &&
                            $forumpermissions['candlattachments'] == 1) ||
        ...
        if (
            ...
            if ($validationcount == 1) {
                $postbit_unapproved_attachments =
                    $lang->postbit_unapproved_attachment;
            } else {
                $postbit_unapproved_attachments = $lang->sprintf(
        ...
        if ($post['thumblist']) {
            eval(
                "\$post['attachedthumbs'] = \"" .
                    $templates->get('postbit_attachments_thumbnails') .
                    "\";"
            );
        } else {
            $post['attachedthumbs'] = '';
        ...
        if ($post['imagelist']) {
            eval(
                "\$post['attachedimages'] = \"" .
                    $templates->get('postbit_attachments_images') .
                    "\";"
            );
        } else {
            $post['attachedimages'] = '';
        ...
        if (
            ...
            eval(
                "\$post['attachments'] = \"" .
                    $templates->get('postbit_attachments') .
                    "\";"
            );
        }
    }
