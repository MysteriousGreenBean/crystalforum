...
$l['banned_ips_desc'] =
    'Here you can manage IP addresses which are banned from accessing your board.';
$l['banned_accounts'] = 'Banned Accounts';
$l['disallowed_usernames'] = 'Disallowed Usernames';
$l['disallowed_usernames_desc'] =
    'Here you manage a list of usernames which cannot be registered or used by users. This feature is also particularly useful for reserving usernames.';
$l['disallowed_email_addresses'] = 'Disallowed Email Addresses';
$l['disallowed_email_addresses_desc'] =
    'Here you manage a list of email addresses which cannot be registered or used by users.';
...
$l['ip_address_desc'] =
    'Note: To ban a range of IP addresses use * (Ex: 127.0.0.*) or CIDR notation (Ex: 127.0.0.0/8)';
...
$l['success_username_disallowed'] =
    'The username has been disallowed successfully.';
$l['success_email_disallowed'] =
    'The email address has been disallowed successfully.';
