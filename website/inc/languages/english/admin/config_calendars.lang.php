...
$l['manage_calendars_desc'] =
    'This section allows you to manage the calendars on your board. If you change the display order for one or more calendars make sure you submit the form at the bottom of the page.';
...
$l['display_order_desc'] =
    'The order the calendars are shown in the calendar selection. The calendar with display order 1 will be shown on the calendar page by default.';
$l['week_start'] = 'Start of Week';
$l['week_start_desc'] =
    'Here you can set the day weeks should start on for this calendar.';
$l['sunday'] = 'Sunday';
$l['monday'] = 'Monday';
$l['tuesday'] = 'Tuesday';
...
$l['event_limit_desc'] =
    'The number of events to be shown before a single link to all events on the particular day is shown instead.';
$l['show_birthdays'] = 'Show Birthdays?';
$l['show_birthdays_desc'] =
    'Do you wish to show birthdays of registered users in this calendar?';
$l['moderate_events'] = 'Moderate New Events?';
$l['moderate_events_desc'] =
    "If this option is set to 'Yes,' all events will be moderated apart from those created by members with 'Bypass moderation queue' set for their calendar permissions.";
...
$l['error_missing_order'] =
    'You did not enter a display order for this calendar';
...
$l['success_calendar_permissions_updated'] =
    'The calendar permissions have been updated successfully.';
$l['success_calendar_deleted'] =
    'The selected calendar has been deleted successfully.';
$l['success_calendar_orders_updated'] =
    'The calendar display orders have been updated successfully.';

$l['confirm_calendar_deletion'] =
    'Are you sure you wish to delete this calendar?';
