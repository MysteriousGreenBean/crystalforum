...
$l['manage_help_documents_desc'] =
    'This section allows you to manage your help documents.';
...
$l['no_help_documents'] =
    'There are no help documents on your forum at this time.';
$l['section_document'] = 'Section / Document';

$l['error_section_missing_name'] = 'You must specify a name for the section.';
$l['error_section_missing_description'] =
    'You must specify a short description for the section.';
$l['error_section_missing_enabled'] =
    "You must specify yes or no for \"Enabled?\".";
$l['error_section_missing_translation'] =
    "You must specify yes or no for \"Use Translation?\".";
...
$l['error_document_missing_description'] =
    'You must specify a short description for the document.';
$l['error_document_missing_document'] = 'You must specify the document.';
$l['error_document_missing_enabled'] =
    "You must specify yes or no for \"Enabled?\".";
$l['error_document_missing_translation'] =
    "You must specify yes or no for \"Use Translation?\".";
...
$l['success_help_section_added'] =
    'The help section has been added successfully.';
$l['success_help_document_added'] =
    'The help document has been added successfully.';
$l['success_help_section_updated'] =
    'The help section has been updated successfully.';
$l['success_help_document_updated'] =
    'The help document has been updated successfully.';
$l['success_section_deleted'] =
    'The selected help section has been deleted successfully.';
$l['success_document_deleted'] =
    'The selected help document has been deleted successfully.';

$l['confirm_section_deletion'] =
    'Are you sure you wish to delete this section?';
$l['confirm_document_deletion'] =
