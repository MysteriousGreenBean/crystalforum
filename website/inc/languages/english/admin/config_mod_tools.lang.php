...
$l['thread_tools_desc'] =
    'Custom moderator tools allows you to create combinations of moderator actions that can be used on both threads and posts. These can then be used like the default tools when managing your forum. Here you can manage your custom thread tools.';

$l['add_thread_tool'] = 'Add Thread Tool';
$l['add_new_thread_tool'] = 'Add New Thread Tool';
$l['add_thread_tool_desc'] =
    'Here you can add a new custom thread moderation tool. This tool will be accessible from both inline thread moderation and from within threads themselves, listed with the default moderation tools.';

$l['post_tools'] = 'Post Tools';
$l['post_tools_desc'] =
    'Custom moderator tools allows you to create combinations of moderator actions that can be used on both threads and posts. These can then be used like the default tools when managing your forum. Here you can manage your custom post tools.';

$l['add_post_tool'] = 'Add Post Tool';
$l['add_new_post_tool'] = 'Add New Post Tool';
$l['add_post_tool_desc'] =
    'Here you can add a new custom post moderation tool. This tool will be accessible from within threads themselves, listed with the default moderation tools.';

$l['edit_post_tool'] = 'Edit Post Tool';
$l['edit_post_tool_desc'] =
    "Here you can edit the post tool's settings and actions.";
$l['edit_thread_tool'] = 'Edit Thread Tool';
$l['edit_thread_tool_desc'] =
    "Here you can edit the thread tool's settings and actions.";
...
$l['confirm_thread_tool_deletion'] =
    'Are you sure you want to delete this thread tool?';
$l['confirm_post_tool_deletion'] =
    'Are you sure you want to delete this post tool?';

$l['success_post_tool_deleted'] =
    'The selected post moderation tool has been deleted successfully.';
$l['success_thread_tool_deleted'] =
    'The selected thread moderation tool has been deleted successfully.';
...
$l['move_thread_desc'] =
    "If moving the thread(s), the \"delete redirect after&hellip; days\" is only to be filled in if a redirect will be left.";
...
$l['subject_message_replacements_desc'] =
    "{subject} represents the original subject. {username} represents the moderator's username. {author} represents the thread author's username.";
...
$l['success_mod_tool_created'] =
    'The moderation tool has been created successfully.';
$l['success_mod_tool_updated'] =
    'The moderation tool has been updated successfully.';
...
$l['private_message_message_desc'] =
    'Message to send to the author of the thread. Leave empty to disable this feature.';
$l['private_message_subject'] = 'Subject';
$l['private_message_subject_desc'] =
    'Enter the subject of the Private Message.';
...
$l['error_no_forums_selected'] =
    'Please select the forums in which this tool will be available.';
$l['error_no_groups_selected'] =
    'Please select the groups to which this tool will be available.';
$l['error_forum_is_category'] =
    "You can't pick a category-type forum as a destination forum.";
