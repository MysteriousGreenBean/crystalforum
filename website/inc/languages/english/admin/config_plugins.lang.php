...
$l['plugins'] = 'Plugins';
$l['plugins_desc'] =
    "This section allows you to activate, deactivate, and manage the plugins that you have uploaded to your forum's <strong>inc/plugins</strong> directory. To hide a plugin from view, but not lose any stored information from it, click the Deactivate link.";
$l['plugin_updates'] = 'Plugin Updates';
$l['plugin_updates_desc'] =
    'This section allows you to check for updates on all your plugins.';
...
$l['error_vcheck_no_supported_plugins'] =
    'None of the plugins installed support version checking.';
...
$l['error_vcheck_vulnerable_notes'] =
    'This submission has currently been marked as vulnerable by the MyBB Staff. We recommend complete removal of this modification. Please see the notes below: ';
...
$l['error_no_results_found'] =
    'No results were found for the specified keywords.';

$l['success_plugins_up_to_date'] =
    'Congratulations, all of your plugins are up to date.';
$l['success_plugin_activated'] =
    'The selected plugin has been activated successfully.';
$l['success_plugin_deactivated'] =
    'The selected plugin has been deactivated successfully.';
$l['success_plugin_installed'] =
    'The selected plugin has been installed and activated successfully.';
$l['success_plugin_uninstalled'] =
    'The selected plugin has been uninstalled successfully.';
