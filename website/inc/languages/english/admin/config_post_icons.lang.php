...
$l['add_multiple_post_icons_desc'] =
    'Here you can add multiple new post icons.';
$l['edit_post_icon'] = 'Edit Post Icon';
$l['edit_post_icon_desc'] = 'Here you can edit a post icon.';
$l['manage_post_icons'] = 'Manage Post Icons';
$l['manage_post_icons_desc'] =
    'This section allows you to edit, delete, and manage your post icons.';

$l['name_desc'] = 'This is the name for the post icon.';
$l['image_path'] = 'Image Path';
$l['image_path_desc'] =
    'This is the path to the post icon image. If you want to use different post icon images for different themes, please use <strong>{theme}</strong> to represent the image directory of each theme.';
...
$l['error_no_images'] =
    'There are no post icons in the specified directory, or all post icons in the directory have already been added.';
...
$l['success_post_icons_added'] =
    'The selected post icons have been added successfully.';
$l['success_post_icon_updated'] =
    'The post icon has been updated successfully.';
$l['success_post_icon_deleted'] =
    'The selected post icon has been deleted successfully.';

$l['confirm_post_icon_deletion'] =
    'Are you sure you wish to delete this post icon?';
