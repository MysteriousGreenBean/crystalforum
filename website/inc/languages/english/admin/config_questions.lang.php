...
$l['security_questions_desc'] =
    'Here you can create and manage security questions that will be randomly shown during registration.';
$l['add_new_question'] = 'Add New Question';
$l['add_new_question_desc'] =
    'Add a question and its answers for the security questions to be used during registration.';
...
$l['no_security_questions'] =
    'There are no security questions on your forum at this time.';

$l['question'] = 'Question';
$l['question_desc'] =
    'Enter the question you want answered during registration.';
$l['answers'] = 'Answer(s)';
$l['answers_desc'] =
    'Enter the answer(s) to the question above. Please enter each answer on a separate line.';
$l['active'] = 'Active';
...
$l['success_question_disabled'] =
    'The question has been disabled successfully.';
