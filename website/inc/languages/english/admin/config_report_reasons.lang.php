...
$l['report_reasons_desc'] =
    'Here you can create and manage reasons that can be selecting when users report content.';
$l['add_new_reason'] = 'Add New Reason';
$l['add_new_reason_desc'] =
    'Add a new reason for users to select when reporting content.';
$l['edit_reason'] = 'Edit Reason';
$l['edit_reason_desc'] =
    'Edit a reason for users to select when reporting content.';
...
$l['no_report_reasons'] =
    'There are no report reasons on your forum at this time.';

$l['reason_title'] = 'Title';
$l['reason_title_desc'] =
    'Enter the title of the reason for reporting the content.';
$l['requires_extra'] = 'Require An Extra Comment?';
$l['requires_extra_desc'] =
    'Require the user to enter an additional comment when this reason is selected?';
...
$l['error_missing_extra'] =
    'You did not select if you want extra information for this reason.';

$l['success_reasons_disporder_updated'] =
    'The report reason display orders have been updated successfully.';
