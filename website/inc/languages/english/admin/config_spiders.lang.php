...
$l['spiders_bots_desc'] =
    "This section allows you to manage the search engine spiders &amp; bots automatically detected by your forum. You're also able to see when a particular bot last visited.";
$l['add_new_bot'] = 'Add New Bot';
$l['add_new_bot_desc'] =
    'Here you can add a new bot that you would like to be detected by your forum.';
...
$l['no_bots'] =
    'There are no search engine spiders or web crawlers being tracked by this forum.';

$l['name'] = 'Name';
$l['name_desc'] = 'Enter the name of this bot which you want to identify it by';
$l['user_agent'] = 'User Agent String';
$l['user_agent_desc'] =
    'Enter the string which will be matched against the bots user agent (partial matches are accepted)';
$l['language_str'] = 'Language';
$l['language_desc'] =
    'Select the language pack the bot will use when viewing the board.';
$l['theme'] = 'Theme';
...
$l['error_missing_agent'] =
    'You did not enter a user agent string for this bot';
