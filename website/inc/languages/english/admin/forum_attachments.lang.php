...
$l['find_attachments_desc'] =
    "Using the attachments search system you can search for specific files users have attached to your forums. Begin by entering some search terms below. All fields are optional and won't be included in the criteria unless they contain a value.";
$l['find_orphans'] = 'Find Orphaned Attachments';
$l['find_orphans_desc'] =
    'Orphaned attachments are attachments which are for some reason missing in the database or the file system. This utility will assist you in locating and removing them.';
$l['attachment_stats'] = 'Attachment Statistics';
$l['attachment_stats_desc'] =
    'Below are some general statistics for the attachments currently on your forum.';

// Errors
$l['error_nothing_selected'] =
    'Please select one or more attachments to delete.';
$l['error_no_attachments'] =
    "There aren't any attachments on your forum yet. Once an attachment is posted you'll be able to access this section.";
$l['error_not_all_removed'] =
    'Only some orphaned attachments were successfully deleted, others could not be removed from the uploads directory.';
...
$l['error_no_results'] =
    'No attachments were found with the specified search criteria.';
$l['error_not_found'] =
    'Attachment file could not be found in the uploads directory.';
$l['error_not_attached'] =
    'Attachment was uploaded over 24 hours ago but not attached to a post.';
$l['error_does_not_exist'] =
    'Thread or post for this attachment no longer exists.';

// Success
$l['success_deleted'] =
    'The selected attachments have been deleted successfully.';
$l['success_orphan_deleted'] =
    'The selected orphaned attachment(s) have been deleted successfully.';
$l['success_count'] = '{1} attachment(s) removed successfully.';
$l['success_no_orphans'] = 'There are no orphaned attachments on your forum.';

// Confirm
$l['confirm_delete'] =
    'Are you sure you wish to delete the selected attachments?';
...
$l['step1of2_line1'] =
    'Please wait, the file system is currently being scanned for orphaned attachments.';
$l['step2of2_line1'] =
    'Please wait, the database is currently being scanned for orphaned attachments.';
$l['step_line2'] =
    "You'll automatically be redirected to the next step once this process is complete.";
...
$l['name_contains_desc'] =
    'Search for attachments that include the given query in the file name. For example, enter .zip to find attachments using the .zip file extension.';
