...
$l['forum_management_desc'] =
    'This section allows you to manage the categories and forums on your board. You can manage forum permissions and forum-specific moderators as well. If you change the display order for one or more forums or categories, make sure you submit the form at the bottom of the page.';
...
$l['copy_forum_desc'] =
    'Here you can copy forum settings or permissions from an existing forum to another or to a new forum.';
$l['forum_permissions'] = 'Permissions';
$l['forum_permissions_desc'] =
    'Here you can modify the full permissions for an individual group for a single forum';
$l['view_forum'] = 'View Forum';
$l['view_forum_desc'] =
    'Here you can view sub forums, quickly edit permissions and add moderators to your forum.';
$l['add_child_forum'] = 'Add Child Forum';
$l['edit_forum_settings'] = 'Edit Forum Settings';
$l['edit_forum_settings_desc'] =
    "Here you can edit an existing forums' settings and its permissions.";
...
$l['can_move_to_other_forums'] =
    "Can move threads to another forum this user doesn't moderate?";
...
$l['moderator_cp_permissions_desc'] =
    'This user must be able to access the Mod CP and have usergroup permission to access these functions in order for these permissions to take effect.';
...
$l['success_forum_disporder_updated'] =
    'The forum display orders have been updated successfully.';
$l['success_forum_deleted'] =
    "The selected forum has been deleted successfully. Ideally you should now run the <a href=\"index.php?module=tools-recount_rebuild\">Recount &amp; Rebuild</a> tools.";
$l['success_moderator_deleted'] =
    "The selected moderator has been deleted successfully.<br />Please remember that this hasn't changed this user's group permission, they may still have moderation powers.";
$l['success_forum_permissions_updated'] =
    'The forum permissions have been updated successfully.';
$l['success_forum_updated'] =
    'The forum settings have been updated successfully.';
$l['success_moderator_updated'] =
    'The selected moderator has been updated successfully.';
$l['success_custom_permission_cleared'] =
    'The custom permissions for this forum have been cleared successfully.';
...
$l['error_forum_parent_child'] =
    "You can't set the parent forum of this forum to one of it's children.";
$l['error_forum_parent_itself'] =
    'The forum parent cannot be the forum itself.';
$l['error_incorrect_moderator'] = 'Please select a valid moderator.';

$l['confirm_moderator_deletion'] =
    'Are you sure you wish to remove this moderator from this forum?';
$l['confirm_forum_deletion'] = 'Are you sure you wish to delete this forum?';
$l['confirm_clear_custom_permission'] =
    'Are you sure you wish to clear this custom permission?';
...
$l['forum_password_desc'] =
    'To protect this forum further, you can choose a password that must be entered for access. Note: User groups still need permissions to access this forum.';
$l['access_options'] = 'Access Options';
$l['forum_is_active'] = 'Forum is Active?';
$l['forum_is_active_desc'] =
    "If unselected, this forum will not be shown to users and will not \"exist\".";
...
$l['copy_settings_and_properties_desc'] =
    'Only applies if the destination forum exists.';
...
$l['override_user_style'] =
    "Yes, override the user's selected style for this forum";
...
$l['display_rules_inline'] =
    'Display rules for this forum on the thread listing';
$l['display_rules_inline_new'] =
    'Display rules in the thread listing and for new threads/replies';
...
$l['moderator_usergroup_desc'] =
    'Select a usergroup to add as a Moderator from the list below.';
...
$l['allow_img_code'] =
    'Yes, allow [img] code in posts (requires MyCode to be turned on)';
$l['allow_video_code'] =
...
$l['use_permissions_desc'] =
    'Select the permissions you would like to use for this user group - inherited permissions (will delete custom permissions) or custom permissions.';
$l['inherit_permissions'] =
    'Use user group permissions or inherit permissions from parent forums';
...
$l['error_forum_link_not_empty'] =
    'Forums with threads cannot be redirected to another webpage.';

$l['success_forum_added'] = 'The forum has been created successfully.';
$l['success_moderator_added'] =
    'The moderator has been added to this forum successfully.';
$l['success_forum_permissions_saved'] =
    'The forum permissions have been saved successfully.';
$l['success_forum_copied'] = 'The selected forum has been copied successfully.';

$l['error_moderator_already_added'] =
    'The selected user/group is already a moderator of this forum.';
...
$l['moderate_field_mod_edit_posts'] =
...
$l['confirm_proceed_deletion'] =
    "Click \"Proceed\" to continue the deletion of the forum.";
