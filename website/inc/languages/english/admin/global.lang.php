...
$l['enter_username_and_password'] =
    'Please enter your {1} and password to continue.';
...
$l['error_mybb_admin_lockedout_message'] =
    'Your account is currently locked out after failing to login {1} times. You have been sent an email with instructions on how to unlock your account.';
$l['error_mybb_not_admin_account'] =
    'You do not have permission to access the administration control panel.';
...
$l['error_invalid_username_password'] =
    'The {1} and password combination you entered is invalid.';
...
$l['cannot_perform_action_super_admin_general'] =
    'Sorry, but you cannot perform this action because you are not a super administrator.<br /><br />To be able to perform this action, you need to add your user ID to the list of super administrators in inc/config.php.';
...
$l['invalid_post_verify_key2'] =
    'An authorization code mismatch occurred. Please double check that you are accessing this page correctly.';
...
$l['enter_username_and_token'] =
    'Please enter your username and the activation code to continue.';
...
$l['my2fa_no_codes'] =
    "Note: you've used all of your recovery codes. Please visit the <a href=\"index.php?module=home-preferences&amp;action=recovery_codes\">recovery codes page</a> to generate a new set.";
