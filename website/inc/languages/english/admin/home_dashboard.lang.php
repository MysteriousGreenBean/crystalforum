...
$l['last_update_check_two_weeks'] =
    "Your last <a href=\"{1}\">MyBB version check</a> was more than two weeks ago.";
$l['new_version_available'] =
    'You are currently running {1} whilst the latest generally available release is {2}.';
$l['version_check_description'] =
    'Here you can check that you are currently running the latest copy of MyBB and see the latest announcements directly from MyBB.';
$l['latest_mybb_announcements'] = 'Latest MyBB Announcements';
$l['no_announcements'] =
    "No stored announcements. <a href=\"index.php?module=home&amp;action=version_check\">Check for Updates</a>.";
$l['your_version'] = 'Your Version';
$l['latest_version'] = 'Latest Version';
$l['update_forum'] =
    "Please upgrade to the latest version of MyBB by visiting the <a href=\"https://mybb.com\" target=\"_blank\" rel=\"noopener\">MyBB Website</a>.";
$l['read_more'] = 'Read more';

$l['success_up_to_date'] =
...
$l['error_fetch_news'] =
    'MyBB was unable to successfully fetch the latest announcements from the MyBB website.';

$l['news_description'] =
    "The latest news from the <a href=\"https://blog.mybb.com/\" target=\"_blank\" rel=\"noopener\">MyBB Blog</a>.";
...
$l['success_notes_updated'] =
    'The administrator notes have been successfully updated.';
