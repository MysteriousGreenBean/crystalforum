...
$l['database_backups_desc'] =
    'Here you find a listing of the database backups that are currently stored on your web server in the MyBB Backups directory.';
...
$l['file_type_desc'] =
    'Select the file type you would like the database backup saved as.';
$l['gzip_compressed'] = 'GZIP Compressed';
$l['plain_text'] = 'Plain Text';
$l['save_method'] = 'Save Method';
$l['save_method_desc'] =
    'Select the method you would like to use to save the backup.';
$l['backup_directory'] = 'Backup Directory';
$l['backup_contents'] = 'Backup Contents';
$l['backup_contents_desc'] =
    'Select the information that you would like included in the backup.';
...
$l['error_file_not_specified'] =
    'You did not specify a database backup to download.';
$l['error_invalid_backup'] =
    'The back up file you selected is either invalid or does not exist.';
...
$l['error_no_zlib'] =
    'The zlib library for PHP is not enabled - you cannot create GZIP compressed backups.';

$l['alert_not_writable'] =
    'Your backups directory (within the Admin CP directory) is not writable. You cannot save backups on the server.';
