...
$l['user_email_log_desc'] =
    "All emails sent from one member to another member as well as emails sent by the 'Send Thread to a Friend' feature are logged and shown below. Here you can identify potential abusers of this function.";
...
$l['sent_using_send_thread_feature'] =
    'Sent using the Send Thread to Friend feature';
$l['thread'] = 'Thread:';
