...
$l['mod_logs_desc'] =
    'Here you can view, prune, and search the moderator logs. These logs contain the actions any user may take (deletion of their own posts/threads) and all other actions by moderators.';
$l['prune_mod_logs'] = 'Prune Moderator Logs';
$l['prune_mod_logs_desc'] =
    'Here you can prune the moderator logs matching a specified criteria.';
...
$l['success_pruned_mod_logs'] =
    'The moderator logs have been pruned successfully.';
$l['note_logs_locked'] =
