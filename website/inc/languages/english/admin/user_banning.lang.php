...
$l['banned_accounts_desc'] =
    'Here you can manage user accounts which are banned from access to the board.';
$l['ban_a_user'] = 'Ban a User';
$l['ban_a_user_desc'] = 'Here you can ban a user.';
$l['edit_ban'] = 'Edit Ban';
$l['edit_ban_desc'] =
    'Here you can edit the reason and length of currently banned users.';
...
$l['error_already_banned'] =
    'This user already belongs to a banned group and cannot be added to a new one.';
...
$l['success_pruned'] =
    "The selected user's posts and threads have been pruned successfully.";

// Confirm
$l['confirm_lift_ban'] = 'Are you sure you want to lift this ban?';
$l['confirm_prune'] =
    'Are you sure you want to prune all threads and posts created by this user?';
...
$l['ban_group_desc'] =
    'In order for this user to be banned they must be moved to a banned group.';
...
$l['for'] = 'for';
$l['bannedby_x_on_x'] =
    '<strong>{1}</strong><br /><small>Banned by {2} on {3} {4}</small>';
$l['lift'] = 'Lift';
