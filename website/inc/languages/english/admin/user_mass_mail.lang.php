...
$l['mass_mail_queue_desc'] =
    'Here you can manage mass mailings that are currently being sent or are queued for the future.';
$l['create_mass_mail'] = 'Create New Mailing';
$l['create_mass_mail_desc'] =
    'Here you can create a new mass mailing and set its options.';
$l['mass_mail_archive'] = 'Mass Mailing Archive';
$l['mass_mail_archive_desc'] =
    'Here you can view a log of mass mailings that have already been sent.';
...
$l['delivery_date_desc'] =
    'Please select the date and time you want this mass mailing to be delivered';
$l['per_page'] = 'Per Page';
$l['per_page_desc'] =
...
$l['review_text_version_desc'] =
    'Please review the automatically generated text version';
...
$l['canceled'] = 'Canceled';
$l['resend'] = 'Resend';
$l['no_archived_messages'] =
    'You do not have any previously sent or canceled mass mailings.';

$l['draft'] = 'Draft';
$l['queued'] = 'Queued';
$l['delivering'] = 'Delivering';
$l['na'] = 'N/A';
$l['mass_mail_cancel_confirmation'] =
    'Are you sure you wish to cancel the delivery of this mass mailing?';
$l['no_unsent_messages'] =
    'You do not have any unsent, queued or currently delivering mass mailings.';

$l['error_invalid_mid'] = 'You have selected an invalid mass mailing.';
$l['error_only_in_future'] =
    'You can only deliver mass mailings in the future.';
$l['error_no_users'] =
    'Your search criteria did not return any users. Please adjust your criteria and try again.';
$l['error_missing_plain_text'] =
    'You did not enter a plain text version of this message.';
$l['error_missing_subject'] =
    'You did not enter a subject for this mass mailing.';
...
$l['error_delete_invalid_mid'] =
    'You have selected an invalid mass mailing to delete.';

$l['success_mass_mail_saved'] = 'The mass mailing has been saved successfully.';
$l['success_mass_mail_deleted'] =
    'The selected mass mailing has been deleted successfully.';
$l['success_mass_mail_resent'] =
    'The mass mailing has been copied successfully. Please review it below.';
$l['success_mass_mail_canceled'] =
    'The mass mailing delivery has been canceled successfully.';

$l['mass_mail_deletion_confirmation'] =
    'Are you sure you want to delete this mass mailing?';
