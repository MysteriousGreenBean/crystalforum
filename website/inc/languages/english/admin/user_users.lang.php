...
$l['browse_users_desc'] =
    'Below you can browse users of your forums in different defined views. Views are particularly useful for generating different result sets with different information - think of them as saved live searches.';
$l['find_users'] = 'Find Users';
$l['find_users_desc'] =
    'Here you can search for users of your forum. The fewer fields you fill in, the broader your search is; the more you fill in, the narrower your search is.';
...
$l['edit_user_desc'] =
    'Here you can edit this users profile, settings, and signature; see general statistics; and visit other pages for further information relating to this user.';
$l['show_referrers'] = 'Show Referrers';
$l['show_referrers_desc'] =
    'The results to your search criteria are shown below. You can view the results in either a table view or business card view.';
$l['show_ip_addresses'] = 'Show IP Addresses';
$l['show_ip_addresses_desc'] =
    'The registration IP address and the post IPs for the selected users are shown below. The first IP address is the registration IP (it is marked as such). Any other IP addresses are IP addresses the user has posted with.';
$l['manage_users'] = 'Manage Users';
$l['manage_users_desc'] =
    'Mass-managing users makes it a lot easier to do common tasks.';
...
$l['inline_activated_more'] =
    '<small>{1} user(s) you selected were already activated.</small>';
$l['inline_activated_failed'] =
    'All the users you selected were already activated.';
$l['ban_time'] = 'Ban Length <em>*</em>';
$l['ban_reason'] = 'Ban Reason';
$l['mass_ban'] = 'Mass Ban Users';
$l['important'] = 'Important';
$l['mass_ban_info'] =
    'This action will affect {1} user(s). Only continue if you are sure you want to do this.';
$l['ban_users'] = 'Ban Users';
$l['users_banned'] = '{1} user(s) have been banned.';
$l['confirm_multilift'] =
    'Are you sure you want to lift bans for the user(s) you selected?';
$l['success_ban_lifted'] =
    'Bans for {1} user(s) you selected have been lifted.';
$l['edit_ban'] = 'Edit Ban';
$l['lift_ban'] = 'Lift Ban';
$l['lift_bans'] = 'Lift Bans';
$l['confirm_multidelete'] =
    'Are you sure you want to delete these {1} user(s)? This cannot be undone.';
$l['users_deleted'] = '{1} user(s) have been deleted.';
$l['mass_prune_info'] =
    "This action will affect {1} user(s). If you continue, it will remove all the users' posts older than the date you enter below.<br /><br /><strong>Please note that if any users' post is the first post of a thread, the entire thread will be removed.</strong>";
...
$l['multi_selected_dates'] =
    "You've selected both a manual date and a set option. Please select either a manual date or a set option.";
$l['incorrect_date'] =
    'The date you entered is invalid. Please enter a valid date, or leave blank and select a set option.';
$l['prune_complete'] = 'Prune completed successfully.';
$l['prune_fail'] =
    'No posts were found for the selected user(s). No posts were pruned.';
...
$l['usergroup_info'] =
    "The following action will affect {1} user(s). By choosing the options below, you will be overwriting the selected users' primary / additional / display usergroup.";
...
$l['no_usergroup_changed'] =
    'None of the user(s) you selected can have their usergroups changed.';
$l['no_set_option'] =
    'A valid set date was not selected. Please select an option from the dropdown box or enter a manual date.';
...
$l['error_avatartoobig'] =
    'Sorry, but we cannot change your avatar as the new avatar you specified is too big. The maximum dimensions are {1}x{2} (width x height)';
...
$l['error_invalid_user_source'] =
    'The source account username you entered does not exist';
$l['error_invalid_user_destination'] =
    'The destination account username you entered does not exist';
...
$l['error_invalid_view_perpage'] =
    'You have entered an invalid number of results to show per page';
$l['error_invalid_view_sortby'] =
    'You have selected an invalid field to sort results by';
$l['error_invalid_view_sortorder'] = 'You have selected an invalid sort order';
$l['error_invalid_view_delete'] =
    'You selected an invalid administration view to delete';
$l['error_cannot_delete_view'] =
    'You must have at least 1 administration view.';
...
$l['error_no_referred_users'] =
    'The selected user does not have any referred users.';

$l['user_deletion_confirmation'] = 'Are you sure you wish to delete this user?';

$l['success_coppa_activated'] =
    'The selected COPPA user has been activated successfully.';
...
$l['succuss_view_set_as_default'] =
    'The selected administration view has been set as your default successfully';
$l['success_view_created'] =
    'The administration view has been created successfully.';
$l['success_view_updated'] =
    'The selected administration view has been updated successfully.';
$l['success_view_deleted'] =
    'The selected administration view has been deleted successfully.';

$l['confirm_view_deletion'] =
    'Are you sure you want to delete the selected view?';

$l['warning_coppa_user'] =
    "<p class=\"alert\"><strong>Warning: </strong> This user is awaiting COPPA validation. <a href=\"index.php?module=user-users&amp;action=activate_user&amp;uid={1}&amp;my_post_key={2}\">Activate Account</a></p>";
...
$l['signature_desc'] =
    'Formatting options: MyCode is {1}, smilies are {2}, IMG code is {3}, HTML is {4}';
...
$l['suspend_sig_info'] =
    "If a signature is suspended, the user can't edit it and it won't be shown on their profile or in their posts";
$l['suspend_sig_extend'] =
    '<small>Enter a new time below to change, or untick this option to remove this suspension.</small>';
$l['suspend_expire_info'] =
    "<small>Remaining: <span style=\"color: {2};\">{1}</span></small>";
$l['suspend_never_expire'] =
    "<small>{1}'s suspension will never expire (permanently suspended).</small>";
$l['suspend_sig_error'] =
    "You entered an incorrect time to suspend this user's signature for. Please enter a correct time.";

$l['moderate_posts'] = 'Moderate Posts';
$l['moderate_posts_info'] = 'Moderate new posts made by {1}.';
$l['moderate_for'] = 'Moderate for:';
$l['moderated_perm'] =
    '<p><small>Moderated permanently.<br />Enter a new time below to change or untick this option to remove this moderation.</small></p>';
$l['moderate_length'] =
    "<p><small>Remaining Moderation: <span style=\"color: {2};\">{1}</span>.<br />Enter a new time below to change or untick this option to remove this moderation.</small></p>";

$l['suspend_posts'] = 'Suspend Posts';
$l['suspend_posts_info'] = 'Suspend {1} from making new posts.';
$l['suspend_for'] = 'Suspend for:';
$l['suspended_perm'] =
    '<p><small>Suspended permanently.<br />Enter a new time below to change or untick this option to remove this suspension.</small></p>';
$l['suspend_length'] =
    "<p><small>Remaining Suspension: <span style=\"color: {2};\">{1}</span>.<br />Enter a new time below to change or untick this option to remove this suspension.</small></p>";
...
$l['user_current_using_uploaded_avatar'] =
    'This user is currently using an uploaded avatar.';
$l['user_currently_using_remote_avatar'] =
    'This user is currently using a remotely linked avatar.';
...
$l['avatar_desc'] =
    'Below you can manage the avatar for this user. Avatars are small identifying images which are placed under the authors username when they make a post.';
$l['avatar_auto_resize'] =
    'If the avatar is too large, it will automatically be resized';
$l['attempt_to_auto_resize'] =
    'Attempt to resize this avatar if it is too large?';
...
$l['source_account_desc'] =
    'This is the account that will be merged into the destination account. It will be removed after this process.';
$l['destination_account'] = 'Destination Account';
$l['destination_account_desc'] =
    'This is the account that the source account will be merged into. It will remain after this process.';
...
$l['views'] = 'Views';
$l['views_desc'] =
    'The view manager allows you to create different kinds of views for this specific area. Different views are useful for generating a variety of reports.';
...
$l['wildcard'] =
    'To search for ranges of IP addresses use * (Ex: 127.0.0.*) or CIDR notation (Ex: 127.0.0.0/8)';
...
$l['create_new_view_desc'] =
    'Here you can define a new view for this area. You can define which fields you want to be shown, any search criteria and sorting options.';
...
$l['edit_view_desc'] =
    'Whilst editing a view you can define which fields you want to be shown, any search criteria and sorting options.';
$l['private'] = 'Private';
...
$l['default_view_desc'] =
    'Default view created by MyBB. Cannot be edited or removed.';
