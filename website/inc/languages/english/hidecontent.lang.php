...
$l['hidecontent_not_none'] =
    "<div class=\"hidecontent\"><strong>You have not unlocked this post's content yet. Unfortunately, the administrator has disabled all means of unlocking it.</strong></div>";
$l['hidecontent_content_unlocked'] =
    '<div><strong>Content Unlocked:</strong><br />{1}</div>';
$l['hidecontent_bad_content'] =
    'Content is hidden! Please check original post to view it.';
$l['hidecontent_stripped_content'] =
...
$l['hidecontent_paid_already'] =
    'You have already unlocked this post\'s content';
$l['hidecontent_alert'] = '{1} unlocked your content.';
$l['hidecontent_log'] =
    '{1}-{2}-{3}-{4}-(to username, to userid, postid, amount)';
