...
$l['error_no_connection'] =
    'There was an error establishing a connection through the server: ';
...
$l['error_not_sent'] =
    'There was a error while trying to send the mail through php mail function.';
$l['error_status_missmatch'] =
    'The status from server mismatches expected result, returning: ';
$l['error_data_not_sent'] = 'This data could not be sent to server: ';

$l['error_occurred'] =
    'One or more errors have occurred. Please correct the following errors before continuing.<br />';
