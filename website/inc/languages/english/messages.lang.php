...
$l['redirect_return_forum'] =
    "<br /><br />Alternatively, <a href=\"{1}\">return to the forum</a>.";
$l['redirect_emailsent'] = 'Your e-mail message has been sent successfully.';
$l['redirect_loggedin'] =
    'You have successfully been logged in.<br />You will now be taken back to where you came from.';
$l['update_confirm'] =
    'The following file(s) are already attached and will be updated / replaced with the newly selected one(s). {1} Are you sure?';
...
$l['error_invalidpworusername1'] =
    "You have entered an invalid email/password combination. <br /><br />If you have forgotten your password please <a href=\"member.php?action=lostpw\">retrieve a new one</a>.";
$l['error_invalidpworusername2'] =
    "You have entered an invalid username/password or email/password combination. <br /><br />If you have forgotten your password please <a href=\"member.php?action=lostpw\">retrieve a new one</a>.";
$l['error_incompletefields'] =
    'It appears you have left one or more required fields blank. Please go back and enter the required fields.';
$l['error_alreadyuploaded'] =
    "This post already contains an attachment with the name \"{1}\". Please rename the file and upload it again. Alternatively you may click \"Update Attachment\".";
$l['error_alreadyuploaded_perm'] =
    'This post already contains an attachment with the same name. Please either remove the existing file or rename the file and upload it again.';
$l['error_updatefailed'] =
    "The file \"{1}\" is not already attached and can not be updated.";
$l['error_nomessage'] =
    'Sorry, we cannot proceed because you did not enter a valid message. Please go back and do so.';
$l['error_invalidemail'] = 'You did not enter a valid email address.';
$l['error_nomember'] =
    "The member you specified is either invalid or doesn't exist.";
$l['error_maxposts'] =
    "I'm sorry, but your daily post limit has been exceeded.  Please wait till tomorrow to post further or contact your administrator.<br /><br />The maximum amount of posts you may make in a day is {1}";
...
$l['error_attachsize'] =
    "The file \"{1}\" is too large. The maximum size for that type of file is {2} kilobytes.";
...
$l['error_uploadfailed_nothingtomove'] =
    'An invalid file was specified, so the uploaded file could not be moved to its destination.';
$l['error_uploadfailed_movefailed'] =
    'There was a problem moving the uploaded file to its destination.';
$l['error_uploadfailed_lost'] =
    'The attachment could not be found on the server.';
...
$l['error_usernametaken'] =
    "The username you have chosen is already registered. If you have previously registered on these forums, please <a href=\"member.php?action=login\">login</a>.";
$l['error_nousername'] = 'You did not enter a username.';
$l['error_invalidusername'] =
    'The username you have entered appears to be invalid.';
$l['error_invalidpassword'] =
    "The password you entered is incorrect. If you have forgotten your password, click <a href=\"member.php?action=lostpw\">here</a>. Otherwise, go back and try again.";
$l['error_postflooding'] =
    'We are sorry but we cannot process your post. The administrator has specified you are only allowed to post once every {1} seconds.';
$l['error_nopermission_guest_1'] =
    'You are either not logged in or do not have permission to view this page. This could be because one of the following reasons:';
$l['error_nopermission_guest_2'] =
    'You are not logged in or registered. Please login and retry the desired action.';
...
$l['error_nopermission_user_4'] =
    'Your account may still be awaiting activation or moderation.';
...
$l['error_nopermission_user_username'] =
    "You are currently logged in with the username: '{1}'";
$l['logged_in_user'] = 'Logged In User';
$l['error_too_many_images'] = 'Too Many Images.';
$l['error_too_many_images2'] =
    'We are sorry, but we cannot process your post because it contains too many images. Please remove some images from your post to continue.';
$l['error_too_many_images3'] =
    '<b>Note:</b> The maximum amount of images per post is';
$l['error_attach_file'] = 'Error Attaching File';
$l['please_correct_errors'] =
    'Please correct the following errors before continuing:';
$l['error_reachedattachquota'] =
    'Sorry, but you cannot attach this file because you have reached your attachment quota of {1}';
$l['error_maxattachpost'] =
    'Sorry but you cannot attach this file because you have reached the maximum number of attachments allowed per post of {1}';
...
$l['error_message_too_short'] =
    'Sorry, your message is too short and cannot be posted.';
$l['failed_login_wait'] =
    'You have failed to login within the required number of attempts. You must now wait {1}h {2}m {3}s before you can login again.';
$l['failed_login_again'] =
    '<br />You have <strong>{1}</strong> more login attempts.';
$l['error_max_emails_day'] =
    "You cannot use the 'Send Thread to a Friend' or the 'Email User' features because you've already used up your allocated quota of sending {1} messages in the past 24 hours.";
$l['attachments_disabled'] =
    'You cannot use the attachment system as it has been disabled by the Administrator.';
$l['error_attach_filename_length'] =
    "The file name '{1}' exceeds the maximum file name length {2}. Please upload a file with a shorter file name.";
...
$l[
    'email_reportreputation'
] = "{1} from {2} has reported the following reputation:
...
$l[
    'email_broken_task'
] = "Your copy of MyBB running on {1} ({2}) has experienced an error with the task system.
