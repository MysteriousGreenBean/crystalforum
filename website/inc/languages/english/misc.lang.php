...
$l['close'] = 'Close';
$l['no_buddies'] =
    '<em>Your buddy list is currently empty. Use your User CP or visit a user profile to add users to your buddy list.</em>';
...
$l['error_helpsearchdisabled'] =
    'The ability to search the help documents has been disabled by the Administrator.';
...
$l['error_invalid_limit'] =
    'The feed item limit you entered is invalid. Please specify a valid limit.';

$l['syndication'] = 'Latest Thread Syndication';
$l['syndication_generated_url'] = 'Your Generated Syndication URL:';
$l['syndication_note'] =
    "Below you can generate links to specific RSS syndication feeds. Links can be generated for all forums, per forum, or for a specific number of forums. You will then be presented with a link which you can copy in to an RSS reader. <i><a href=\"https://en.wikipedia.org/wiki/RSS\" target=\"_blank\" rel=\"noopener\">What is RSS?</a></i>";
...
$l['redirect_forumpasscleared'] =
    'The stored password for this forum has been cleared.';
$l['redirect_cookiescleared'] = 'All cookies have been cleared.';

$l['error_invalidforum'] = 'Invalid forum';
$l['error_invalidhelpdoc'] =
    'The specified help document does not appear to exist.';
$l['error_invalidsearch'] =
    'An invalid search was specified.  Please go back and try again.';
$l['error_no_search_support'] =
    'This database engine does not support searching.';
$l['error_searchflooding'] =
    'Sorry, but you can only perform one search every {1} seconds. Please wait another {2} seconds before attempting to search again.';
$l['error_searchflooding_1'] =
    'Sorry, but you can only perform one search every {1} seconds. Please wait another 1 second before attempting to search again.';

$l['dst_settings_updated'] =
    'Your daylight saving time settings have automatically been adjusted.<br /><br />You will now be taken back to the forum index.';
