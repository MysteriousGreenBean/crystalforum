...
$l['post_subject'] =
    'Title &nbsp;&nbsp;&nbsp;<span class="text-danger" style="font-size: 10px">REQUIRED</span>';
$l['your_message'] =
    'Message &nbsp;&nbsp;&nbsp;<span class="text-danger" style="font-size: 10px">REQUIRED</span>';
...
$l['close_thread'] =
    '<strong>Close Thread</strong>: prevent further posting in this thread.';
$l['stick_thread'] =
    '<strong>Stick Thread:</strong> stick this thread to the top of the forum.';
$l['forum_rules'] = '{1} - Rules';
$l['thread_review'] = 'Thread Review (Newest First)';
$l['thread_review_more'] =
    'This thread has more than {1} replies. <a href="{2}" target="_blank">Read the whole thread.</a>';
$l['posted_by'] = 'Posted by';
$l['draft_saved'] =
    'The new post has successfully been saved as a draft.<br />You will now be taken to your draft listing.';
$l['error_post_already_submitted'] =
    'You have already posted this reply to the specified thread. Please visit the thread to see your reply.';
$l['multiquote_external_one'] =
    'You have selected one post outside of this thread.';
$l['multiquote_external'] =
    'You have selected {1} posts outside of this thread.';
...
$l['redirect_newreplyerror'] =
    'Sorry, but your reply has been rejected for lack of content. <br />You will now be returned to the thread.';
...
$l['error_stop_forum_spam_fetching'] =
    'Sorry, something went wrong verifying your reply against a spammer database. Most likely the database couldn\'t be accessed. Please try again later.';
$l[
    'error_suspendedposting'
] = 'Your posting privileges are currently suspended {1}.<br /><br />
