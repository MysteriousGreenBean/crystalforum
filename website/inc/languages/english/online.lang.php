...
$l['viewing_attachment2'] =
    'Viewing <a href="attachment.php?aid={1}" target="_blank">Attachment</a> in Thread <a href="{3}">{2}</a>';
...
$l['marking_read'] =
    '<a href="misc.php?action=markread&amp;my_post_key={1}">Marking Forums as Read</a>';
$l['viewing_helpdocs'] =
    'Viewing <a href="misc.php?action=help">Help Documents</a>';
$l['viewing_buddylist'] =
    'Viewing <a href="#" onclick="MyBB.popupWindow(\'/misc.php?action=buddypopup&amp;modal=1\'); return false;">Buddy List</a>';
$l['viewing_smilies'] =
    'Viewing <a href="misc.php?action=smilies">Smilie List</a>';
$l['viewing_syndication'] =
    'Viewing <a href="misc.php?action=syndication">RSS Syndication</a> Page';
...
$l['viewing_woltoday'] =
    'Viewing <a href="online.php?action=today">Who Was Online Today</a>';
...
$l['updating_profile'] =
    '<a href="usercp.php?action=profile">Updating Profile</a>';
$l['updating_options'] =
    '<a href="usercp.php?action=options">Updating Options</a>';
$l['editing_signature'] =
    '<a href="usercp.php?action=editsig">Editing Signature</a>';
$l['changing_avatar'] =
    '<a href="usercp.php?action=avatar">Changing Avatar</a>';
$l['viewing_subscriptions'] =
    'Viewing <a href="usercp.php?action=subscriptions">Thread Subscriptions</a>';
$l['editing_pad'] = 'Editing <a href="usercp.php">Personal Pad</a>';
$l['editing_password'] =
    'Editing <a href="usercp.php?action=password">Password</a>';
...
$l['member_lostpw'] =
    'Retrieving <a href="member.php?action=lostpw">Lost Password</a>';
...
$l['members_were_online_today'] =
    '<strong>{1}</strong> Members Were Online Today';
