...
$l['welcome'] = 'Welcome, {1}';
$l['guest_welcome_registration'] =
    "You have to <a href=\"{1}\">register</a> before you can post on our site.";
$l['username'] = 'Username';
$l['password'] = 'Password';
$l['login'] = 'Login!';
...
$l['portal_disabled'] =
    'You cannot use the portal functionality as it has been disabled by the Administrator.';
