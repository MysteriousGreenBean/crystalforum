...
$l['thread_closed_edit_subjects'] =
    'This thread is closed and you may not edit subjects.';
$l['no_permission_edit_subject'] =
    'You do not have permission to edit this thread subject.';
$l['thread_closed_edit_message'] =
    'This thread is closed and you may not edit messages within it.';
$l['no_permission_edit_post'] =
    'You do not have permission to edit this message.';
$l['edit_time_limit'] =
    'You can only edit messages for {1} minutes after they were posted.';
...
$l['captcha_not_exists'] =
    'The image verification image you are trying to refresh does not exist.';
$l['captcha_valid_not_exists'] =
    'The image verification image you are trying to check does not seem to exist.';
...
$l['banned_username'] =
    'The username you entered has been disallowed by the administrator';
$l['banned_characters_username'] =
    'Your username contains one or more invalid characters';
...
$l['buddylist_error'] =
    'It seems like you do not have any buddies on your buddy list. Please add some before trying to use this.';
$l['close'] = 'Close';
$l['select_buddies'] = 'Select Buddies';
$l['select_buddies_desc'] =
    'To add one or more of your buddies as recipients, select them below and click OK.';
