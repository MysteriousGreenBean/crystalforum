...
$l['banned_ips_desc'] =
    'Zarządzaj listą adresów IP, które nie mają dostępu do forum.';
$l['banned_accounts'] = 'Konta';
$l['disallowed_usernames'] = 'Loginy';
$l['disallowed_usernames_desc'] =
    'Zarządzaj listą loginów, które nie mogą zostać zarejestrowane.';
$l['disallowed_email_addresses'] = 'Adresy e-mail';
$l['disallowed_email_addresses_desc'] =
    'Zarządzaj listą adresów e-mail, które nie mogą być użyte przy rejestracji.';
...
$l['username_desc'] =
    "Porada: Użyj znaku \"*\" aby zastąpić dowolny ciąg znaków";
...
$l['ip_address_desc'] =
    "Porada: Aby zablokować cały zakres adresów IP, użyj znaku \"*\" (przykład: 127.0.0.*) lub notacji CIDR (przykład: 127.0.0.0/8)";
$l['ban_ip_address'] = 'Zablokuj adres IP';

$l['error_missing_ban_input'] =
    'Nie podano wartości, która ma zostać zablokowana.';
