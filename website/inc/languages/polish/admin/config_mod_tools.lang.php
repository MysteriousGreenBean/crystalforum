...
$l['thread_tools_desc'] =
    'Dodatkowe narzędzia moderacji pozwalają na tworzenie kombinacji poleceń moderatorskich dla postów i wątków. Tutaj zarządzasz dodatkowymi narzędziami moderacji dla wątków.';

$l['add_thread_tool'] = 'Nowe narzędzie wątków';
$l['add_new_thread_tool'] = 'Nowe narzędzie wątków';
$l['add_thread_tool_desc'] =
    'Konfiguruj dodatkowe narzędzia moderacji wątków. Te narzędzia będą dostępne wewnątrz wątków, na liście standardowych narzędzi moderacji.';

$l['post_tools'] = 'Narzędzia postów';
$l['post_tools_desc'] =
    'Dodatkowe narzędzia moderacji pozwalają na tworzenie kombinacji poleceń moderatorskich dla postów i wątków. Tutaj zarządzasz dodatkowymi narzędziami moderacji dla postów.';

$l['add_post_tool'] = 'Nowe narzędzie postów';
$l['add_new_post_tool'] = 'Nowe narzędzie postów';
$l['add_post_tool_desc'] =
    'Konfiguruj dodatkowe narzędzia moderacji postów. Te narzędzia będą dostępne wewnątrz wątków, na liście standardowych narzędzi moderacji.';

$l['edit_post_tool'] = 'Edytuj narzędzie moderowania postów';
$l['edit_post_tool_desc'] =
    'Edytuj ustawienia i akcje narzędzia moderowania postów.';
$l['edit_thread_tool'] = 'Edytuj narzędzie moderowania wątków';
$l['edit_thread_tool_desc'] =
    'Edytuj ustawienia i akcje narzędzia moderowania wątków.';
...
$l['confirm_thread_tool_deletion'] =
    'Czy na pewno chcesz usunąć to narzędzie moderacji wątków?';
$l['confirm_post_tool_deletion'] =
    'Czy na pewno chcesz usunąć to narzędzie moderacji postów?';

$l['success_post_tool_deleted'] =
    'Wybrane narzędzie moderacji postów zostało usunięte.';
$l['success_thread_tool_deleted'] =
    'Wybrane narzędzie moderacji wątków zostało usunięte.';

$l['error_invalid_post_tool'] =
    'Wybrane narzędzie moderacji postów nie istnieje.';
$l['error_invalid_thread_tool'] =
    'Wybrane narzędzie moderacji wątków nie istnieje.';
...
$l['move_thread_desc'] =
    "Jeżeli przenosisz wątek, pole \"Usuń przekierowanie po&hellip; dniach\" musi zostać wypełnione tylko gdy pozostawiasz przekierowanie.";
...
$l['subject_message_replacements_desc'] =
    '{subject} reprezentuje oryginalny temat. {username} reprezentuje nick moderatora. {author} reprezentuje nick autora tematu.';

$l['add_new_reply'] = 'Napisz odpowiedź';
$l['add_new_reply_desc'] =
    'Pozostaw puste, jeżeli nie chcesz udzielać odpowiedzi.';
...
$l['private_message_message_desc'] =
    'Wiadomość do autora wątku. Pozostaw puste, żeby wyłączyć tę funkcję.';
...
$l['error_no_forums_selected'] =
    'Wybierz działy, w których będzie dostępne to narzędzie.';
$l['error_no_groups_selected'] =
    'Wybierz grupy, dla których będzie dostępne to narzędzie.';
$l['error_forum_is_category'] =
    'Nie można wybrać kategorii jako działu docelowego.';
