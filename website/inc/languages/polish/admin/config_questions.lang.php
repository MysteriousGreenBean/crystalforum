...
$l['security_questions_desc'] =
    'Dodawaj i zarządzaj pytaniami zabezpieczającymi, które będą losowo pokazywane podczas rejestracji.';
$l['add_new_question'] = 'Dodaj nowe pytanie';
$l['add_new_question_desc'] =
    'Dodaj pytanie i akceptowane odpowiedzi na nie. Podczas rejestracji będzie wymagana odpowiedź na jedno z pytań.';
...
$l['question'] = 'Pytanie';
$l['question_desc'] =
    'Wprowadź treść pytania, na jakie trzeba będzie udzielić odpowiedzi podczas rejestracji.';
$l['answers'] = 'Odpowiedzi';
$l['answers_desc'] =
    'Wprowadź odpowiedź (lub odpowiedzi) na wpisane wcześniej pytanie. Każda odpowiedź powinna się znaleźć w osobnej linii.';
$l['active'] = 'Aktywne';
