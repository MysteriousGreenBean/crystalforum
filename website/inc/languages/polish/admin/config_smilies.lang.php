...
$l['text_replace_desc'] =
    'Tekst, który zostanie zamieniony na obrazek z emotikonem (każda fraza do zamiany w nowej linii).';
$l['image_path'] = 'Ścieżka do obrazka';
$l['image_path_desc'] =
    'To jest ścieżka do obrazka z emotikonem. Jeżeli chcesz użyć innych emotikon dla poszczególnych stylów, możesz skorzystać ze znacznika <strong>{theme}</strong>. W jego miejsce podstawiony zostanie katalog z obrazkami danego stylu.';
$l['order'] = 'Kolejność';
$l['display_order'] = 'Kolejność wyświetlania';
$l['display_order_desc'] =
    'Kolejność, w której ten emotikon pojawi się na liście emotikonów. Ta liczba nie powinna być taka sama jak innego emotikona.';
$l['mass_edit_show_clickable'] = 'Pokazywać na liście?';
$l['show_clickable'] = 'Pokazywać na liście emotikonów?';
$l['show_clickable_desc'] =
    'Czy chcesz, aby ten emotikon był pokazywany na liście emotikonów do wyboru w edytorze postów?';
$l['include'] = 'Dodać?';
$l['path_to_images'] = 'Ścieżka do obrazków';
$l['path_to_images_desc'] =
    'To jest ścieżka do folderu, w którym znajdują się emotikony.';
...
$l['error_missing_text_replacement'] =
    'Nie wpisano tekstu do zamiany dla tego emotikona.';
...
$l['error_missing_order'] =
    'Nie wpisano kolejności wyświetlania tego emotikona.';
$l['error_duplicate_order'] =
    'Nie wpisano prawidłowej kolejności wyświetlania tego emotikona.';
$l['error_missing_clickable'] =
    'Nie wybrano czy ten emotikon ma być pokazywany na liście emotikonów';
$l['error_no_smilies'] =
    'Nie ma emotikonów w podanym folderze lub wszystkie zostały już dodane.';
