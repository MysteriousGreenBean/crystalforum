...
$l['find_attachments_desc'] =
    'Znajdź załączniki wysłane przez użytkowników. Za pomocą poniższego formularza możesz określić kryteria wyszukiwania.';
$l['find_orphans'] = 'Znajdź nieużywane';
$l['find_orphans_desc'] =
    'Załączniki, o których nie ma informacji w bazie lub systemie plików są nieużywane. Wyszukaj je i usuń.';
$l['attachment_stats'] = 'Statystyki';
$l['attachment_stats_desc'] =
    'Poniżej znajdują się statystyki dla załączników umieszczonych na forum.';

// Errors
$l['error_nothing_selected'] = 'Nie zaznaczono załączników do usunięcia.';
$l['error_no_attachments'] =
    'Nie ma załączników na forum. Po wysłaniu przez użytkowników przynajmniej jednego pliku uzyskasz dostęp do tej sekcji.';
$l['error_not_all_removed'] =
    'Zostały usunięte tylko nieużywane pliki, pozostałe nadal są w katalogu załączników.';
$l['error_count'] = 'Nie można usunąć {1} załącznika (ów).';
$l['error_invalid_username'] = 'Wpisany login jest nieprawidłowy.';
$l['error_invalid_forums'] =
    'Zaznaczono jedno lub więcej nieprawidłowych działów.';
...
$l['error_not_attached'] =
    'Załącznik został wysłany 24 godziny temu, ale nie dołączono go do posta.';
$l['error_does_not_exist'] =
    'Wątek lub post połączony z tym załącznikiem już nie istnieje.';

// Success
$l['success_deleted'] = 'Wybrane załączniki zostały usunięte.';
$l['success_orphan_deleted'] =
    'Wybrane nieużywane załączniki zostały usunięte.';
...
$l['bandwidth_used'] =
    '<strong>Szacowane zużycie transferu przez załączniki</strong>';
...
$l['users_diskspace'] =
    '5 użytkowników używających najwięcej miejsca na załączniki';
...
$l['step1of2_line1'] =
    'Proszę czekać, system plików jest skanowany w poszukiwaniu nieużywanych załączników.';
$l['step2of2_line1'] =
    'Proszę czekać, baza danych jest skanowana w poszukiwaniu nieużywanych załączników.';
$l['step_line2'] =
    'Po zakończeniu procesu nastąpi przeniesienie do kolejnego kroku.';
...
$l['name_contains_desc'] =
    'Wyszukaj załączniki, które zawierają podany ciąg znaków w nazwie pliku. Na przykład wpisz .zip, aby znaleźć załączniki, korzystając z rozszerzenia .zip.';
