...
$l['manage_template_sets_desc'] =
    'Przeglądaj swoje paczki szablonów, zarządzaj nimi i dostosuj wygląd forum według swoich upodobań.';
$l['add_set'] = 'Nowa paczka';
$l['add_set_desc'] =
    'Utwórz nową paczkę szablonów, która będzie kopią istniejącej. Dzięki temu będzie możliwość wprowadzania dalszych zmian w wyglądzie forum bez obaw o dotychczasowe efekty swojej pracy.';
...
$l['add_template_group_desc'] =
    'Utwórz nową grupę szablonów, aby je uporządkować.';
$l['search_replace'] = 'Znajdź i zamień';
$l['search_replace_desc'] =
    'Znajdź szablony zawierające dany ciąg znaków i ewentualnie automatycznie zamień go na inny.';
$l['find_updated'] = 'Znajdź zmienione';
$l['find_updated_desc'] =
    'Wyszukuj szablony, które zmieniły się wraz z wydaniem nowej wersji MyBB, abyś mógł dokonać właściwych zmian.';
$l['edit_template'] = 'Edytuj szablon';
$l['editing_template'] = 'Edytowanie szablonu: {1}';
$l['edit_template_desc'] =
    'Zmień tytuł szablonu, zmodyfikuj jego kod lub przypisz go do innej paczki.';
...
$l['manage_templates_desc'] =
    "Zarządzaj szablonami należącymi do tej paczki. Wybierz opcję \"Edytuj\" lub kliknij nazwę szablonu by wprowadzić w nim zmiany.";
$l['diff_report'] = 'Podgląd różnic';
$l['diff_report_desc'] =
    'Zobacz różnice występujące pomiędzy zmodyfikowanym przez Ciebie szablonem a jego domyślną wersją.';
...
$l['search_noresults'] =
    "Nie znaleziono szablonów zawierających ciąg znaków \"<strong>{1}</strong>\"";
$l['search_noresults_title'] =
    "Nie znaleziono szablonów o tytule \"<strong>{1}</strong>\"";
...
$l['template_name_desc'] =
    'Nazwa szablonu. Jeżeli zmienisz ją domyślnemu szablonowi, twoja wersja zostanie zapisana jako kopia o zmienionej nazwie.';
...
$l['template_group_prefix_desc'] =
    'Prefiks którym będą poprzedzone nazwy wszystkich szablonów z tej grupy. Nie może się pokrywać z istniejącą grupą szablonów. Przykładowo, jeżeli szablony mają się nazywać <em>hello_world</em>, <em>hello_foobar</em> i <em>hello_foo</em>, jako prefiks wpisz <strong>hello</strong>.';
$l['template_group_title'] = 'Nazwa grupy szablonów';
$l['template_group_title_desc'] =
    'Wpisz nazwę dla tej grupy szablonów. Będzie ona pokazywana na liście szablonów. Przykładowo, jeżeli prefiksem grupy szablonów jest <em>hello</em>, możesz tu wpisać <strong>Hello</strong>.';
...
$l['master_updated_ins'] =
    'W ten sposób oznaczono różnice pomiędzy poprzednią a aktualną wersją.';
$l['master_updated_del'] =
    'W ten sposób oznaczono miejsca, w których usunięto dokonane przez Ciebie zmiany.';
$l['template_diff_analysis'] = 'Analiza różnic w szablonach';
$l['search_names_header'] =
    "Wyszukiwanie szablonów o nazwach zawierających \"{1}\"";

$l['updated_template_welcome1'] =
    'Edycja - pozwala na modyfikację wybranego szablonu celem dostosowania go do nowej wersji systemu.';
$l['updated_template_welcome2'] =
    'Przywracanie - powoduje utratę wszelkich wprowadzonych zmian, ale pozwala na przywrócenie domyślnego wyglądu szablonu w przypadku awarii.';
$l['updated_template_welcome3'] =
    'Podgląd różnic - wyświetla wszystkie zmiany, jakich dokonano w danym szablonie.';

$l['no_global_templates'] = 'Aktualnie nie ma globalnych szablonów.';
$l['no_updated_templates'] =
    'Żaden szablon nie był modyfikowany od czasu ostatniej aktualizacji.';

$l['confirm_template_set_deletion'] =
    'Czy na pewno chcesz usunąć tę paczkę szablonów?';
$l['confirm_template_group_delete'] =
    'Czy na pewno chcesz usunąć tę grupę szablonów? Nie spowoduje to usunięcia szablonów należących do tej grupy.';
$l['confirm_template_deletion'] = 'Czy na pewno chcesz usunąć ten szablon?';
$l['confirm_template_revertion'] =
    'Czy na pewno chcesz przywrócić ten szablon do stanu domyślnego?';
...
$l['error_missing_input'] =
    'Upewnij się, że wprowadzono wszystkie dane potrzebne do tej operacji (tid, sid)';
$l['error_already_exists'] =
    'Podany tytuł szablonu jest już w użyciu. Podaj inny tytuł.';
...
$l['error_themes_attached_template_set'] =
    'Ta paczka nie może zostać usunięta - znajdują się w niej szablony, które są aktualnie w użyciu.';
$l['error_missing_group_prefix'] = 'Podaj prefiks dla grupy szablonów.';
$l['error_invalid_group_title'] =
    'Podkreślenia  (_) są stosowane jako separator i są zakazane w prefiksie grupy szablonów. Proszę wybrać inny prefiks.';
$l['error_missing_group_title'] = 'Podaj nazwę dla tej grupy szablonów.';
$l['error_duplicate_group_prefix'] =
    'Podany prefiks jest już w użyciu. Podaj inny prefiks.';
$l['error_missing_template_group'] =
    'Nie znaleziono grupy szablonów o podanej nazwie.';
$l['error_default_template_group'] =
    'Nie możesz edytować i usuwać domyślnych grup szablonów.';
