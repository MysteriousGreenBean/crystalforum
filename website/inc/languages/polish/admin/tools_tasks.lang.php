...
$l['add_new_task_desc'] =
    'Planuj zadania, które będą automatycznie wykonywane przez MyBB.';
...
$l['view_task_logs_desc'] =
    'Wszystkie informacje o wynikach oraz błędach napotkanych podczas wykonywania zadań będą znajdować się na poniższej liście pod warunkiem, że włączono opcję zapisywania logów dla danego zadania. Wpisy starsze niż 30 dni są automatycznie usuwane.';
$l['scheduled_tasks'] = 'Zaplanowane zadania';
$l['scheduled_tasks_desc'] =
    'Zarządzaj zaplanowanymi zadaniami, które będą wykonywane przez MyBB. Aby uruchomić zadanie, kliknij ikonę znajdującą się po prawej stronie nazwy zadania.';
...
$l['time_minutes_desc'] =
    "Wpisz listę minut w których zadanie ma być uruchamiane, oddzielając poszczególne wartości (0-59) przecinkiem. Wpisz \"*\" jeżeli chcesz, by zadanie było uruchamiane w każdej minucie.";
$l['time_hours'] = 'Czas - godziny';
$l['time_hours_desc'] =
    "Wpisz listę godzin w których zadanie ma być uruchamiane, oddzielając poszczególne wartości (0-23) przecinkiem. Wpisz \"*\" jeżeli chcesz, by zadanie było uruchamiane w każdej godzinie.";
$l['time_days_of_month'] = 'Czas - dni miesiąca';
$l['time_days_of_month_desc'] =
    "Wpisz listę dni miesiąca w których zadanie ma być uruchamiane, oddzielając poszczególne wartości (1-31) przecinkiem. Wpisz \"*\" jeżeli chcesz, by zadanie było uruchamiane niezależnie od dnia miesiąca.";
...
$l['time_weekdays_desc'] =
    "Wybierz dni tygodnia, w których zadanie ma być uruchamiane. Przytrzymaj CTRL klikając, by zaznaczyć więcej niż jedno pole. Wybierz \"Każdy dzień tygodnia\" jeżeli chcesz, by zadanie było wykonywane niezależnie od dnia tygodnia.";
$l['every_month'] = 'Każdy miesiąc';
$l['time_months'] = 'Czas - miesiące';
$l['time_months_desc'] =
    "Wybierz miesiące, w których zadanie ma być uruchamiane. Przytrzymaj CTRL klikając, by zaznaczyć więcej niż jedno pole. Wybierz \"Każdy miesiąc\" jeżeli chcesz, by zadanie było wykonywane w każdym miesiącu.";
...
$l['confirm_task_enable'] =
    "<strong>UWAGA:</strong> Chcesz aktywować zadanie, które powinno być uruchamiane tylko i wyłącznie za pomocą cron (zobacz <a href=\"https://docs.mybb.com/1.8/administration/task-manager\" target=\"_blank\" rel=\"noopener\">Dokumentację MyBB</a> - po angielsku). Kontynuować?";
