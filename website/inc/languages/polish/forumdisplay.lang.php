...
$l['forum_unapproved_posts_count'] =
    'Aktualnie jest {1} ukrytych postów w tym dziale.';
$l['forum_unapproved_post_count'] =
    'Aktualnie jest 1 ukryty post w tym dziale.';
$l['forum_unapproved_threads_count'] =
    'Aktualnie jest {1} ukrytych wątków w tym dziale.';
$l['forum_unapproved_thread_count'] =
    'Aktualnie jest 1 ukryty wątek w tym dziale.';
$l['thread_unapproved_posts_count'] =
    'Aktualnie jest {1} ukrytych postów w tym wątku.';
$l['thread_unapproved_post_count'] =
    'Aktualnie jest 1 ukryty post w tym wątku.';
$l['page_selected'] =
    'Wybrano wszystkie <strong>{1}</strong> wątki na tej stronie.';
$l['all_selected'] =
    'Wybrano wszystkie <strong>{1}</strong> wątki w tym dziale.';
...
$l['inline_no_tool_selected'] =
    'Wybierz narzędzie do przeprowadzenia działań moderatora.';
$l['inline_no_post_selected'] =
    'Musisz wybrać jeden lub więcej postów, dla których chcesz przeprowadzić akcję moderatora.';
