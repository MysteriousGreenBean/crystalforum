...
$l['hidecontent_not_replied'] =
    "<div class=\"hidecontent\" style=\"text-indent: 0px;\"><center><strong>. . .</strong></center></div>";
...
$l['hidecontent_content_unlocked'] = '<div>{1}</div>';
$l['hidecontent_bad_content'] =
    '<i>Treść ukryta i niedostępna w podglądzie posta!</i>';
