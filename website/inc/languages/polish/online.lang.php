...
$l['viewing_attachment2'] =
    "Przegląda <a href=\"attachment.php?aid={1}\">załącznik</a> w wątku <a href=\"{3}\">{2}</a>";
...
$l['adding_event'] =
    "<a href=\"calendar.php?action=addevent\">Dodaje wydarzenie</a>";
$l['editing_event'] = 'Edytuje wydarzenie';
$l['viewing_contact_us'] =
    "Przegląda <a href=\"contact.php\">stronę kontaktową</a>";
...
$l['viewing_memberlist'] =
    "Przegląda <a href=\"memberlist.php\">Listę użytkowników</a>";
$l['viewing_buddylist'] =
    'Przegląda <a href="#" onclick="MyBB.popupWindow(\'/misc.php?action=buddypopup&amp;modal=1\'); return false;">listę znajomych</a>';
$l['viewing_whoposted'] = "Przegląda \"Kto napisał\"";
$l['viewing_whoposted2'] =
    "Przegląda \"Kto napisał\" w wątku <a href=\"showthread.php?tid={1}\">{2}</a>";
$l['marking_read'] =
    "<a href=\"misc.php?action=markread&amp;my_post_key={1}\">Oznacza działy jako przeczytane</a>";
$l['viewing_helpdocs'] = "Przegląda <a href=\"misc.php?action=help\">pomoc</a>";
$l['viewing_buddylist'] =
    "Przegląda <a href=\"misc.php?action=buddypopup\">listę znajomych</a>";
$l['viewing_smilies'] =
    "Przegląda <a href=\"misc.php?action=smilies\">listę emotikonów</a>";
$l['viewing_syndication'] =
    "Przegląda <a href=\"misc.php?action=syndication\">stronę RSS</a>";
...
$l['viewing_woltoday'] =
    "Przegląda <a href=\"online.php?action=today\">\"Kto był dzisiaj online\"</a>";
...
$l['updating_profile'] =
    "<a href=\"usercp.php?action=profile\">Aktualizuje profil</a>";
$l['updating_options'] =
    "<a href=\"usercp.php?action=options\">Aktualizuje opcje</a>";
$l['editing_signature'] =
    "<a href=\"usercp.php?action=editsig\">Edytuje sygnaturę</a>";
$l['changing_avatar'] =
    "<a href=\"usercp.php?action=avatar\">Zmienia awatar</a>";
$l['viewing_subscriptions'] =
    "Przegląda <a href=\"usercp.php?action=subscriptions\">subskrypcje wątków</a>";
$l['editing_pad'] = 'Edytuje <a href="usercp.php">osobisty notatnik</a>';
$l['editing_password'] =
    "Zmienia <a href=\"usercp.php?action=password\">hasło</a>";
...
$l['giving_reputation'] =
    "Przyznaje punkt reputacji użytkownikowi <a href=\"{1}\">{2}</a>";
$l['viewing_reputation_report'] =
    "Przegląda informacje o reputacji użytkownika <a href=\"{1}\">{2}</a>";
$l['viewing_reputation_report2'] = 'Przegląda informacje o reputacji';
$l['member_resendactivation'] = 'Przesyła sobie e-mail aktywujący';
$l['member_lostpw'] =
    "Przywraca <a href=\"member.php?action=lostpw\">zapomniane hasło</a>";
...
$l['online_count'] =
    '{1} {2} w ciągu ostatnich {3} minut ({4} {5}, {6} {7} i {8} {9}).';
$l['ip'] = 'IP:';
$l['resolves_to'] = 'Nazwa hosta:';
$l['if_resolvable'] = '(jeśli możliwe)';
$l['admin_options'] = 'Opcje administratora';
$l['search_regip_users'] =
    'Szukaj użytkowników, którzy rejestrowali się z tego IP';
...
$l['members_were_online_today'] =
    'W ciągu ostatnich 24 godzin było <strong>{1}</strong> użytkowników online';
