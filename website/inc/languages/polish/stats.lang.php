...
$l['todays_top_poster'] =
    'Najwięcej postów dziś: <b>{1}</b> (<b>{2}</b> postów)';
$l['popular_forum'] =
    'Najpopularniejszy dział: <b>{1}</b> (<b>{2}</b> postów, <b>{3}</b> wątków)';
...
$l['not_enough_info_stats'] =
    'Aby można było wygenerować statystyki, potrzebny jest przynajmniej jeden użytkownik i jeden wątek.';
$l['replies'] = 'odpowiedzi';
$l['views'] = 'wyświetleń';
$l['top_referrer'] =
    'Najwięcej poleconych użytkowników: <strong>{1}</strong> (<strong>{2}</strong>)';
