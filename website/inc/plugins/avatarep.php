...
if (defined('IN_ADMINCP')) {
    ...
    if (defined('THIS_SCRIPT')) {
        ...
        if (THIS_SCRIPT == 'index.php' || THIS_SCRIPT == 'forumdisplay.php') {
            if (
                isset($settings['sidebox5']) &&
                ($settings['sidebox5'] == 0 || $settings['sidebox5'] == 1)
            ) {
            ...
            $plugins->add_hook(
                ...
                'forumlist_avatar_fname',
                15
            );
            $plugins->add_hook(
                'forumdisplay_thread',
                'forumlist_avatar_thread',
                15
            );
            $plugins->add_hook(
                'forumdisplay_announcement',
                'avatarep_announcement',
                15
            );
            ...
            $plugins->add_hook('postbit', 'avatarep_postbit');
        } elseif (THIS_SCRIPT == 'search.php') {
            $plugins->add_hook(
                'search_results_thread',
                'forumlist_avatar_search',
                15
            );
            $plugins->add_hook(
                'search_results_post',
            ...
            $plugins->add_hook(
                ...
                'avatarep_private_tracking_fname',
                15
            );
            ...
            $plugins->add_hook(
                ...
                'avatarep_usercp_fsubs'
            );
            $plugins->add_hook(
                'usercp_subscriptions_end',
                'avatarep_usercp_subs'
            );
        } elseif (THIS_SCRIPT == 'memberlist.php') {
            $plugins->add_hook('memberlist_user', 'avatarep_memberlist');
        } elseif (THIS_SCRIPT == 'member.php') {
            $plugins->add_hook('member_profile_end', 'avatarep_member');
        }
    }
...
function avatarep_info()
{
    ...
    if (isset($mybb->settings['avatarep_active'])) {
        $avatarep_config_link =
            '<div style="float: right;"><a href="index.php?module=config-plugins&action=avatarep_settings" style="color:#035488; background: url(../images/icons/brick.png) no-repeat 0px 18px; padding: 18px; text-decoration: none;"> ' .
            $db->escape_string($lang->avatarep_config) .
            '</a></div>';
    } elseif (
        isset($mybb->settings['avatarep_active']) &&
        $mybb->settings['avatarep_active'] == 0
    ) {
        $avatarep_config_link .=
            '<div style="float: right; color: rgba(136, 17, 3, 1); background: url(../images/icons/exclamation.png) no-repeat 0px 18px; padding: 21px; text-decoration: none;">' .
            $db->escape_string($lang->avatarep_disabled_msg) .
            '</div>';
    }
    if (
        function_exists('styleUsernames_info') &&
        $mybb->settings['avatarep_format']
    ) {
        $avatarep_config_link .=
            '<div style="float: right; color: rgba(136, 17, 3, 1); background: url(../images/icons/exclamation.png) no-repeat 0px 18px; padding: 21px; text-decoration: none;">' .
            $db->escape_string($lang->avatarep_style_usernames) .
            '</div>';
    }
    return [
        'name' => $db->escape_string($lang->avatarep_name),
        'description' =>
            $db->escape_string($lang->avatarep_descrip) . $avatarep_config_link,
...
function avatarep_activate()
{
    ...
    $avatarep_config[] = [
        ...
        'description' => $db->escape_string(
            $lang->avatarep_thread_owner_descrip
        ),
        'optionscode' => 'yesno',
        'value' => '1',
        'disporder' => 30,
    ...
    $avatarep_config[] = [
        ...
        'description' => $db->escape_string(
            $lang->avatarep_thread_lastposter_mark_descrip
        ),
        'optionscode' => 'yesno',
        'value' => '0',
        'disporder' => 40,
    ...
    $avatarep_config[] = [
        ...
        'description' => $db->escape_string(
            $lang->avatarep_thread_contributor_descrip
        ),
        'optionscode' => 'yesno',
        'value' => '1',
        'disporder' => 50,
    ...
    $avatarep_config[] = [
        ...
        'description' => $db->escape_string(
            $lang->avatarep_latest_threads_descrip
        ),
        'optionscode' => 'yesno',
        'value' => '1',
        'disporder' => 60,
    ...
    $avatarep_config[] = [
        ...
        'description' => $db->escape_string(
            $lang->avatarep_menu_events_descrip
        ),
        'optionscode' => 'select \n1=On Click \n2=Mouse Over',
        'value' => '1',
        'disporder' => 120,
    ...
    $avatarep_config[] = [
        'name' => 'avatarep_letter_avatar',
        'title' => $db->escape_string($lang->avatarep_letter_avatar),
        'description' => $db->escape_string(
            $lang->avatarep_letter_avatar_descrip
        ),
        'optionscode' => 'yesno',
        'value' => 1,
        'disporder' => 130,
    ...
    $avatarep_config[] = [
        ...
        'description' => $db->escape_string(
            $lang->avatarep_similar_threads_desc
        ),
        'optionscode' => 'yesno',
        'value' => '1',
        'disporder' => 170,
    ...
    $avatarep_config[] = [
        'name' => 'avatarep_postbit',
        'title' => $db->escape_string($lang->avatarep_postbit),
        'description' => $db->escape_string($lang->avatarep_postbit_desc),
        'optionscode' => 'yesno',
        'value' => '1',
        'disporder' => 190,
        'gid' => $group['gid'],
    ...
    $avatarep_config[] = [
        ...
        'title' => 'Version',
        'description' =>
            'Plugin version of last poster avatar on threadlist and forumlist',
        'optionscode' => 'text',
        'value' => 306,
        'disporder' => 200,
        'gid' => 0,
	...
	<div class="trow2 avatarep_divisor_hov">
		<div class="avatarep_uprofile_hov">
			<span class="avatarep_data">
				<span class="avatarep_data_item">{$lang->registration_date} {$user_reg_date}</span>
				<span class="avatarep_data_item">{$lang->reputation} {$user[\'reputation\']}</span>
				<span class="avatarep_data_item">{$lang->total_threads} {$user[\'threadnum\']}</span>
				<span class="avatarep_data_item">{$lang->total_posts} {$user[\'postnum\']}</span>
				<span class="avatarep_data_item">{$lang->lastvisit} {$user_lastvisit_date} {$user_lastvisit_time}</span>
				<span class="avatarep_data_item">{$lang->warning_level} <a href="{$warning_link}">{$warning_level} %</a></span>
				<span style="float:right;">{$lang->online_status} {$online_status}</span>	
			</span>
		</div>
	</div>
</div>'),
...
@media screen and (max-width: 450px){
    ...
    find_replace_templatesets(
        ...
        '#^(.*)$#s',
        '<avatarep_uid_[{$lastpost_data[\'lastposteruid\']}]>' . "\\1"
    );
    find_replace_templatesets(
    ...
    find_replace_templatesets(
        'forumdisplay_thread',
        '#' . preg_quote('{$lastpostdate}') . '#',
        '<avatarep_uid_[{$thread[\'lastposteruid\']}]>{$lastpostdate}'
    );
    find_replace_templatesets(
        'forumdisplay_thread',
        '#' . preg_quote('{$lastposterlink}') . '#',
        '{$avbr}{$lastposterlink}'
    );
    find_replace_templatesets(
        'forumdisplay_announcements_announcement',
        '#' .
            preg_quote('<td class="{$bgcolor} forumdisplay_announcement">') .
            '#',
        '<td class="{$bgcolor} forumdisplay_announcement"><avatarep_uid_[{$announcement[\'uid\']}]>'
    );
    find_replace_templatesets(
    ...
    find_replace_templatesets(
        'search_results_threads_thread',
        '#' . preg_quote('{$thread[\'profilelink\']}') . '#',
        '{$avbr}{$thread[\'profilelink\']}'
    );
    find_replace_templatesets(
        'search_results_posts_post',
        '#' . preg_quote('{$post[\'profilelink\']}') . '#',
        '<avatarep_uid_[{$post[\'uid\']}]>{$post[\'profilelink\']}'
    );
    find_replace_templatesets(
        'private_messagebit',
        '#' . preg_quote('{$tofromusername}') . '#',
        '<avatarep_uid_[{$tofromuid}]>{$tofromusername}'
    );
    find_replace_templatesets(
        'private_tracking_readmessage',
        '#' . preg_quote('{$readmessage[\'profilelink\']}') . '#',
        '<avatarep_uid_[{$readmessage[\'toid\']}]>{$readmessage[\'profilelink\']}'
    );
    find_replace_templatesets(
        'private_tracking_unreadmessage',
        '#' . preg_quote('{$unreadmessage[\'profilelink\']}') . '#',
        '<avatarep_uid_[{$unreadmessage[\'toid\']}]>{$unreadmessage[\'profilelink\']}'
    );
    find_replace_templatesets(
        'portal_latestthreads_thread',
        '#' . preg_quote('<strong><a href="') . '#',
        '<strong><avatarep_uid_[{$thread[\'lastposteruid\']}]><a href="'
    );
    find_replace_templatesets(
        'showthread',
        '#' . preg_quote('{$pollbox}') . '#',
        '{$pollbox}{$avatarep_thread}'
    );
    find_replace_templatesets(
    ...
    find_replace_templatesets(
        ...
        '#' . preg_quote('{$similar_thread[\'profilelink\']}') . '#',
        '<avatarep_suid_[{$similar_thread[\'uid\']}]>{$similar_thread[\'profilelink\']}'
    );
    find_replace_templatesets(
        'showthread_similarthreads_bit',
        '#' . preg_quote('{$lastposterlink}') . '#',
        '<avatarep_suid_[{$similar_thread[\'lastposteruid\']}]>{$lastposterlink}'
    );
    find_replace_templatesets(
        'usercp_forumsubscriptions_forum',
        '#' . preg_quote('{$lastpost}') . '#',
        '<avatarep_suid_[{$forum[\'lastposteruid\']}]>{$lastpost}'
    );
    find_replace_templatesets(
        'usercp_subscriptions_thread',
        '#' . preg_quote('{$lastposterlink}') . '#',
        '<avatarep_suid_[{$thread[\'lastposteruid\']}]>{$lastposterlink}'
    );
    find_replace_templatesets(
        'memberlist_user',
        '#' . preg_quote('{$user[\'avatar\']}') . '#',
        '{$user[\'avatarep\']}'
    );
...
function avatarep_deactivate()
{
    ...
    find_replace_templatesets(
        'forumbit_depth1_forum_lastpost',
        '#' .
            preg_quote('<avatarep_uid_[{$lastpost_data[\'lastposteruid\']}]>') .
            '#',
        '',
        0
    );
    ...
    find_replace_templatesets(
        'forumdisplay_thread',
        '#' . preg_quote('{$thread[\'avatarep\']}') . '#',
        '',
        0
    );
    find_replace_templatesets(
        'forumdisplay_thread',
        '#' . preg_quote('<avatarep_uid_[{$thread[\'uid\']}]>') . '#',
        '',
        0
    );
    find_replace_templatesets(
        'forumdisplay_thread',
        '#' . preg_quote('<avatarep_uid_[{$thread[\'lastposteruid\']}]>') . '#',
        '',
        0
    );
    find_replace_templatesets(
    ...
    find_replace_templatesets(
        'forumdisplay_announcements_announcement',
        '#' . preg_quote('<avatarep_uid_[{$announcement[\'uid\']}]>') . '#',
        '',
        0
    );
    find_replace_templatesets(
    ...
    find_replace_templatesets(
        'search_results_posts_post',
        '#' . preg_quote('<avatarep_uid_[{$post[\'uid\']}]>') . '#',
        '',
        0
    );
    find_replace_templatesets(
        'private_messagebit',
        '#' . preg_quote('<avatarep_uid_[{$tofromuid}]>') . '#',
        '',
        0
    );
    find_replace_templatesets(
        'private_tracking_readmessage',
        '#' . preg_quote('<avatarep_uid_[{$readmessage[\'toid\']}]>') . '#',
        '',
        0
    );
    find_replace_templatesets(
        'private_tracking_unreadmessage',
        '#' . preg_quote('<avatarep_uid_[{$unreadmessage[\'toid\']}]>') . '#',
        '',
        0
    );
    find_replace_templatesets(
    ...
    find_replace_templatesets(
        ...
        '#' .
            preg_quote(
                '<avatarep_suid_[{$similar_thread[\'lastposteruid\']}]>'
            ) .
            '#',
        '',
        0
    ...
    find_replace_templatesets(
        'usercp_forumsubscriptions_forum',
        '#' . preg_quote('<avatarep_suid_[{$forum[\'lastposteruid\']}]>') . '#',
        '',
        0
    );
    find_replace_templatesets(
        'usercp_subscriptions_thread',
        '#' .
            preg_quote('<avatarep_suid_[{$thread[\'lastposteruid\']}]>') .
            '#',
        '',
        0
    );
    ...
    // Delete cache
    $cache->delete('avatarep_threads_cache');
}

function avatarep_admin()
{
    global $mybb, $db;
    // Load the settings of plugin
...
/**
 * function avatarep_format_avatar
 * @param array user
 * @param string css
 * @return array
 */
...
{
    global $mybb, $theme, $lang, $avatar;
    $lang->load('avatarep', false, true);
    $size = 2048;
    $dimensions = '40px';
    $onerror = '';
    $default_avatar = str_replace(
        '{theme}',
        $theme['imgdir'],
    ...
    if ($mybb->settings['avatarep_letter_avatar'] == 0) {
        if ($user['avatar'] == '') {
        ...
        return [
            ...
            'avatarep' =>
                ...
                $css .
                '" alt="' .
                htmlspecialchars_uni($user['userusername']) .
                '"' .
                $onerror .
                ' />',
            'avatarep_contributor' =>
                '<img src="' .
                $avatar .
                '" class="avatarep_img_contributor" alt="' .
                htmlspecialchars_uni($user['userusername']) .
                '"' .
                $onerror .
                ' />',
        ...
        if ($user['avatar'] == '') {
            return [
                ...
                'avatarep' =>
                    ...
                    '" />',
                'avatarep_contributor' =>
                    '<img class="avatarep_bg avatarep_img_contributor" alt="' .
                    htmlspecialchars_uni($user['userusername']) .
                    '" data-name="' .
                    htmlspecialchars_uni($user['userusername']) .
                    '" />',
...
function forumlist_avatar_fname(&$forum)
{
    ...
    if (
        $mybb->settings['avatarep_active'] == 0 ||
        ($mybb->settings['avatarep_active'] == 1 &&
            $mybb->settings['avatarep_foros'] == 0)
    ) {
        return false;
    }
    ...
    if ($mybb->settings['avatarep_format'] == 1) {
        if ($forum['lastposteruid'] > 0) {
            $cache->cache['users'][$forum['lastposteruid']] =
                $forum['lastposter'];
            $forum[
                'lastposter'
            ] = "#{$forum['lastposter']}{$forum['lastposteruid']}#";
        } else {
...
function forumlist_avatar(&$content)
{
    ...
    if ($show_avatars == true) {
        $content = avatarep_get_data_full(
            $content,
            $avatarep_css,
            $avatarep_css_img
        );
...
function forumlist_avatar_thread()
{
    ...
    if ($mybb->settings['avatarep_temas_mark'] == 1 && $mybb->user['uid']) {
        if (
            $thread['lastposteruid'] == $mybb->user['uid'] ||
            $thread['uid'] == $mybb->user['uid']
        ) {
            $avatarep = avatarep_format_avatar($mybb->user, 'avatarep_fdl_img');
            $thread[
                'avatarep'
            ] = "<div class=\"avatarep_fdl_mine\">{$avatarep['avatarep']}</div>";
        } elseif (
            $thread['lastposteruid'] != $mybb->user['uid'] &&
            $thread['uid'] != $mybb->user['uid'] &&
            $mybb->user['uid']
            ...
            if ($is_avatar >= 1) {
                $avatarep = avatarep_format_avatar(
                    $mybb->user,
                    'avatarep_fdl_img'
                );
                $thread[
    ...
    if (
        $mybb->settings['avatarep_format'] == 1 &&
        $mybb->settings['avatarep_temas'] == 1
    ) {
        if ($thread['uid'] > 0) {
        ...
        if ($thread['lastposteruid'] > 0) {
            $cache->cache['users'][$thread['lastposteruid']] =
                $thread['lastposter'];
            $thread[
                'lastposter'
            ] = "#{$thread['lastposter']}{$thread['lastposteruid']}#";
        } else {
...
function forumlist_avatar_search()
{
    ...
    if (
        $mybb->settings['avatarep_active'] == 0 ||
        ($mybb->settings['avatarep_active'] == 1 &&
            $mybb->settings['avatarep_busqueda'] == 0)
    ) {
        return false;
    }
...
function avatarep_announcement()
{
    ...
    if (
        $mybb->settings['avatarep_active'] == 0 ||
        ($mybb->settings['avatarep_active'] == 1 &&
            $mybb->settings['avatarep_temas'] == 0)
    ) {
        return false;
    }
    ...
    if ($mybb->settings['avatarep_format'] == 1) {
        if ($announcement['uid'] > 0) {
            $cache->cache['users'][$announcement['uid']] =
                $announcement['username'];
            $announcement[
                'username'
            ] = "#{$announcement['username']}{$announcement['uid']}#";
            $announcement['profilelink'] = build_profile_link(
                $announcement['username'],
                $announcement['uid']
            );
        } else {
        ...
        $announcement['username'] = htmlspecialchars_uni(
            $announcement['username']
        );
    }
}
...
function avatarep_private_fname()
{
    ...
    if (
        $mybb->settings['avatarep_active'] == 0 ||
        ($mybb->settings['avatarep_active'] == 1 &&
            $mybb->settings['avatarep_private'] == 0)
    ) {
        return false;
    }
    if ($mybb->input['fid'] == 2) {
...
{
    global $mybb, $latest_threads, $latest_subscribed;
    if (
        $mybb->settings['avatarep_active'] == 0 ||
        ($mybb->settings['avatarep_active'] == 1 &&
            $mybb->settings['avatarep_usercp'] == 0)
    ) {
        return false;
    }
...
function avatarep_portal()
{
    ...
    if (
        $mybb->settings['avatarep_active'] == 0 ||
        ($mybb->settings['avatarep_active'] == 1 &&
            $mybb->settings['avatarep_portal'] == 0)
    ) {
        return false;
    }
    if ($mybb->settings['avatarep_format'] == 1) {
...
function avatarep_usercp_fsubs()
{
    ...
    if (
        $mybb->settings['avatarep_active'] == 0 ||
        ($mybb->settings['avatarep_active'] == 1 &&
            $mybb->settings['avatarep_usercp_fsubs'] == 0)
    ) {
        return false;
    }
...
function avatarep_usercp_subs()
{
    ...
    if (
        $mybb->settings['avatarep_active'] == 0 ||
        ($mybb->settings['avatarep_active'] == 1 &&
            $mybb->settings['avatarep_usercp_tsubs'] == 0)
    ) {
        return false;
    }
...
{
    global $mybb, $sblatestthreads;
    if (
        $mybb->settings['avatarep_active'] == 0 ||
        ($mybb->settings['avatarep_active'] == 1 &&
            $mybb->settings['avatarep_latest_threads'] == 0)
    ) {
        return false;
    }
...
function avatarep_postbit(&$post)
{
    global $mybb;
    if (
        $mybb->settings['avatarep_active'] == 1 &&
        $mybb->settings['avatarep_letter_avatar'] == 1 &&
        $mybb->settings['avatarep_postbit'] == 1
    ) {
        if ($post['avatar'] == '') {
            $post[
                'useravatar'
            ] = "<img src=\"javascript:void(0);\" data-name=\"{$post['username']}\" alt=\"{$post['username']}\" class=\"avatarep_bg avatarep_postbit\" />";
        }
    }
}
...
{
    global $db, $mybb, $thread, $lang, $cache, $avatarep_thread;
    ...
    if (THIS_SCRIPT == 'showthread.php') {
        if (
            $mybb->settings['avatarep_contributor'] == 1 &&
            $mybb->user['uid']
        ) {
            $tid = (int) $thread['tid'];
            $avatars_cache_thread = avatarep_threads_cache_get(
                $tid,
                $thread['lastpost']
            );
            $username = '';
            $avatar = '';
            $avatar_list = '';
            if (!empty($avatars_cache_thread)) {
                $avatars = json_decode($avatars_cache_thread['avatars']);
                $usernames = json_decode($avatars_cache_thread['usernames']);
                $participants = (int) $avatars_cache_thread['participants'];
                if (!empty($avatars)) {
                    foreach ($avatars as $uid => $avatar) {
                        ...
                        if (
                            ...
                            $avatar_list .= "<img src=\"javascript:void(0);\" data-name=\"{$username}\" alt=\"{$username}\" class=\"avatarep_bg avatarep_img_contributor\" />";
                        } else {
                            $avatar_list .= "<img class=\"avatarep_img_contributor\" src=\"{$avatar}\" alt=\"{$username}\" />";
                        }
                    }
                }
            }
            $avatarep_thread = "<div class=\"avatarep_participants_list\"><span class=\"avatarep_participants\"><span class=\"fas fa-users\"></span><span class=\"avatarep_participants_counter\">{$participants}</span></span>{$avatar_list}</div>";
        }
    }
}

function avatarep_threads_cache_get($tid, $date)
{
    global $cache;
    $avatarep_cache = $cache->read('avatarep_threads_cache');
    if (
        !is_array($avatarep_cache) ||
        (is_array($avatarep_cache) && !isset($avatarep_cache[$tid]))
    ) {
        $avatarep_cache[$tid] = avatarep_threads_cache_update($tid, $date);
    }
    if (isset($avatarep_cache[$tid])) {
        if (
            $avatarep_cache[$tid]['date'] != $date ||
            $avatarep_cache[$tid]['participants'] == ''
        ) {
            $avatarep_cache[$tid] = avatarep_threads_cache_update($tid, $date);
        }
        return $avatarep_cache[$tid];
    } else {
        return '';
    }
}

function avatarep_threads_cache_update($tid, $date)
{
    global $mybb, $cache, $db;
    $query = $db->query(
        "
		SELECT DISTINCT(p.uid), p.username, u.avatar FROM
		" .
            TABLE_PREFIX .
            "posts p INNER JOIN
		" .
    ...
    while ($entries = $db->fetch_array($query)) {
        if (empty($entries['avatar'])) {
            $entries['avatar'] = $mybb->settings['useravatar'];
        }
        $uid = (int) $entries['uid'];
        $avatars[$uid] = htmlspecialchars_uni($entries['avatar']);
        $usernames[$uid] = htmlspecialchars_uni($entries['username']);
    }
    $values[$tid] = [
        'date' => $date,
        'avatars' => json_encode($avatars),
        'usernames' => json_encode($usernames),
        'participants' => count($usernames),
    ];
    $cache->update('avatarep_threads_cache', $values);
    return $values[$tid];
}

function avatarep_memberlist(&$user)
{
    global $mybb;
    if ($mybb->settings['avatarep_contributor'] == 1) {
        if ($user['avatar'] == '') {
            $user['username'] = htmlspecialchars_uni($user['username']);
            if ($mybb->settings['avatarep_letter_avatar'] == 1) {
                $user[
                    'avatarep'
                ] = "<img src=\"javascript:void(0);\" data-name=\"{$user['username']}\" alt=\"{$user['username']}\" class=\"avatarep_bg avatarep_memberlist\" />";
            } else {
                $user[
                    'avatarep'
                ] = "<img src=\"{$mybb->settings['useravatar']}\" alt=\"{$user['username']}\" class=\"avatarep_bg avatarep_memberlist \">";
            }
        } else {
            $user['avatar'] = htmlspecialchars_uni($user['avatar']);
            $user[
                'avatarep'
            ] = "<img class=\"avatarep_img_contributor\" src=\"{$user['avatar']}\" alt=\"{$user['username']}\" />";
        }
    }
}

function avatarep_member()
{
    global $mybb, $memprofile, $avatar;
    if (
        $memprofile['avatar'] == '' &&
        $mybb->settings['avatarep_letter_avatar'] == 1
    ) {
        $avatar = "<img src=\"javascript:void(0);\" data-name=\"{$memprofile['username']}\" alt=\"{$memprofile['username']}\" class=\"avatarep_bg avatarep_member\" />";
    }
}
...
function avatarep_similar_threads()
{
    ...
    if (
        $mybb->settings['avatarep_active'] == 0 ||
        ($mybb->settings['avatarep_active'] == 1 &&
            $mybb->settings['avatarep_similar_threads'] == 0)
    ) {
        return false;
    }
...
function avatarep_style_guser()
{
    ...
    if (
        $mybb->settings['avatarep_active'] == 0 ||
        ($mybb->settings['avatarep_active'] == 1 &&
            $mybb->settings['avatarep_format'] == 0)
    ) {
        return false;
    }
        ...
        foreach ($cache->cache['moderators'] as $fmid => $fmdata) {
            if (isset($fmdata['usergroups'])) {
                foreach ($fmdata['usergroups'] as $gmid => $gmdata) {
                    $cache->cache['moderators'][$fmid]['usergroups'][$gmid][
                        'title'
                    ] = "#{$gmdata['title']}{$gmid}#";
                    $cache->cache['usergroups'][$gmid]['title'] =
                        $gmdata['title'];
            ...
            if (isset($fmdata['users'])) {
                foreach ($fmdata['users'] as $umid => $umdata) {
                    $cache->cache['moderators'][$fmid]['users'][$umid][
                        'username'
                    ] = "#{$umdata['username']}{$umid}#";
    ...
    if (isset($content)) {
        ...
        if (isset($cache->cache['users']) && !empty($cache->cache['users'])) {
            $result = $db->simple_select(
                ...
                'uid IN (' .
                    implode(',', array_keys($cache->cache['users'])) .
                    ')'
            );
            while ($avatarep = $db->fetch_array($result)) {
                $username = format_name(
                    $avatarep['username'],
                    $avatarep['usergroup'],
                    $avatarep['displaygroup']
                );
                $format = "#{$avatarep['username']}{$avatarep['uid']}#";
                if (
                    is_array($cache->cache['groups']) &&
                    is_array($cache->cache['mods'])
                ) {
                    if (in_array($avatarep['uid'], $cache->cache['mods'])) {
                        $old_username = str_replace(
                            '{username}',
                            $format,
                            $cache->cache['usergroups'][$avatarep['usergroup']][
                                'namestyle'
                            ]
                        );
                        if ($old_username != '') {
            ...
            if (isset($fmdata['users'])) {
                foreach ($fmdata['users'] as $umid => $umdata) {
                    $cache->cache['moderators'][$umid]['users'][$umid][
                        'username'
                    ] = "#{$umdata['username']}{$umid}#";
                    $cache->cache['users'][$umid] = $umdata['username'];
                    $cache->cache['mods'][] = $umid;
...
function avatarep_get_data_full(&$content, $avatarep_css, $avatarep_css_img)
{
    ...
    if (isset($content)) {
        ...
        if (!empty($avatars)) {
            ...
            $query = $db->simple_select(
                'users',
                'uid, username, username AS userusername, avatar, avatartype, usergroup, displaygroup',
                "uid IN ({$sql})"
            );
            $find = $replace = [];
            while ($user = $db->fetch_array($query)) {
                ...
                $uid = (int) $user['uid'];
                $user['avatarep_title'] = $lang->sprintf(
                    $lang->avatarep_user_alt,
                    ...
                    if (function_exists('google_seo_url_profile')) {
                        if ($mybb->settings['avatarep_menu_events'] == 2) {
                            $user['avatar'] =
                                "<a href=\"" .
                                $avatar['profilelink'] .
                                "?action=avatarep_popup\" title=\"" .
                                $user['avatarep_title'] .
                                "\" class=\"forum_member{$uid}\" onclick=\"return false;\">" .
                                $user['avatar'] .
                                '</a>' .
                                avatarep_hover_extends($uid, 'forum_member');
                        } else {
                            $user['avatar'] =
                                "<a href=\"javascript:void(0)\" title=\"" .
                                $user['avatarep_title'] .
                                "\" onclick=\"MyBB.popupWindow('" .
                                $avatar['profilelink'] .
                                "?action=avatarep_popup', null, true); return false;\">" .
                                $user['avatar'] .
                                '</a>';
                        }
                    } else {
                        if ($mybb->settings['avatarep_menu_events'] == 2) {
                            $user['avatar'] =
                                "<a href=\"member.php?uid={$uid}&amp;action=avatarep_popup\" class=\"forum_member{$uid}\" title=\"" .
                                $user['avatarep_title'] .
                            ...
                            $user['avatar'] =
                                "<a href=\"javascript:void(0)\" title=\"" .
                                $user['avatarep_title'] .
                                "\" onclick=\"MyBB.popupWindow('member.php?uid={$uid}&amp;action=avatarep_popup', null, true); return false;\">" .
                                $user['avatar'] .
                                '</a>';
                        }
                    }
...
function get_avatars_none($content, $css, $username)
{
    global $mybb, $theme;
    ...
    if ($mybb->settings['avatarep_letter_avatar'] == 0) {
        ...
        $replace[] =
            "<div class=\"avatarep_fd\"><img class=\"avatarep_bg {$css}\" src=\"" .
            $default_avatar .
            "\" alt=\"" .
            $username .
            "\" /></div>";
        ...
        $replace[] =
            "<div class=\"avatarep_fd\"><img class=\"avatarep_bg {$css}\" data-name=\"" .
            $username .
            "\" alt=\"" .
            $username .
            "\" /></div>";
...
function avatarep_get_data_normal($contents)
{
    ...
    if (isset($contents)) {
        ...
        if (!empty($users)) {
            ...
            $query = $db->simple_select(
                'users',
                'uid, username, username AS userusername, avatar, usergroup, displaygroup',
                "uid IN ({$sql})"
            );
            $find = $replace = [];
            while ($user = $db->fetch_array($query)) {
                if ($user['uid'] == 0) {
                    ...
                    $replace[] =
                        "<div class=\"avatarep_fd\"><img class=\"avatarep_bg\" data-name=\"" .
                        $user['username'] .
                        "\" alt=\"" .
                        $lang->guest .
                        "\" /></div>";
...
function avatarep_hover_extends($id, $name)
{
    ...
    if (
        $mybb->settings['avatarep_active'] == 0 ||
        ($mybb->settings['avatarep_menu'] == 0 &&
            $mybb->settings['avatarep_menu_events'] == 2)
    ) {
        return false;
    }
    $lang->load('avatarep', false, true);
    $timeloader = 500;
    $avatar_script =
        '<script type="text/javascript">var lpaname="' .
        $name .
        '";var lpatimer="' .
        $timeloader .
        '";</script>';
    $avatar_hover = "{$avatar_script}
<!-- Last post avatar v3.0.x extends-->";
    return $avatar_hover;
}
...
function avatarep_popup()
{
    ...
    if (
        ...
        $mybb->user[
            'avatarep'
        ] = "<img src=\"javascript:void(0);\" data-name=\"{$mybb->user['username']}\" alt=\"{$mybb->user['username']}\" class=\"avatarep_bg avatarep_user\" />";
    } else {
        $mybb->user['username'] = htmlspecialchars_uni($mybb->user['username']);
        $mybb->user[
            'avatarep'
        ] = "<img class=\"avatarep_user\" src=\"{$mybb->user['avatar']}\" alt=\"{$mybb->user['username']}\" />";
    }
    $avatarep_script = "<script type=\"text/javascript\" src=\"{$mybb->asset_url}/jscripts/avatarep.js?ver=305\"></script>";
    if (
        isset($mybb->input['action']) &&
        $mybb->settings['avatarep_active'] == 1 &&
        $mybb->settings['avatarep_menu_events'] != 0 &&
        $mybb->input['action'] == 'avatarep_popup'
    ) {
        $lang->load('avatarep', false, true);
        ...
        if ($mybb->usergroup['canviewprofiles'] == 0) {
            if ($mybb->settings['avatarep_menu_events'] == 2) {
                eval(
                    "\$avatarep_popup = \"" .
                        $templates->get('avatarep_popup_error_hover', 1, 0) .
                        "\";"
                );
                ...
                eval(
                    "\$avatarep_popup = \"" .
                        $templates->get('avatarep_popup_error', 1, 0) .
                        "\";"
                );
                echo $avatarep_popup;
                exit();
            ...
            if ($mybb->settings['avatarep_menu_events'] == 2) {
                $extra_avat = '_ext2';
            } elseif ($mybb->settings['avatarep_menu_events'] == 1) {
                $extra_avat = '_ext1';
            } else {
                $extra_avat = '_ext';
            }
            ...
            $lang->avatarep_user_alt = $lang->sprintf(
                $lang->avatarep_user_alt,
                htmlspecialchars_uni($user['username'])
            );
            $lang->avatarep_user_no_avatar = htmlspecialchars_uni(
                $lang->avatarep_user_no_avatar
            );
            ...
            if (
                ($user['uid'] > 0 && $user['avatar'] == '') ||
                empty($user['avatar'])
            ) {
                $avatarep =
                    '<img src="' .
                    $avatar .
                    '" class="avatarep_img" alt="' .
                    $lang->avatarep_user_no_avatar .
                    '" />';
            } elseif ($user['uid'] == 0 && empty($user['avatar'])) {
                $avatarep =
                    '<img src="' .
                    $avatar .
                    '" class="avatarep_img" alt="' .
                ...
                if ($mybb->settings['avatarep_onerror'] == 1) {
                    $onerror = " onerror=\"this.src=\'{$mybb->settings['useravatar']}\'\"";
                } else {
                    $onerror = '';
                }
                $avatarep = htmlspecialchars_uni($user['avatar']);
                if ($user['avatartype'] == 'gravatar') {
                    $search = '&';
                    $replace = '&amp;';
                    $avatarep = str_replace($search, $replace, $avatarep);
                }
                $user['avatartype'] = htmlspecialchars_uni($user['avatartype']);
                $avatarep =
                    "<img src=\"" .
                    $avatarep .
                    "\" alt=\"" .
            ...
            $user['avatar'] = $status_start . $avatarep . $status_end;
            if ($mybb->settings['avatarep_format'] == 1) {
                ...
                $formattedname = htmlspecialchars_uni($user['username']);
            }
            $usertitle = '';
            ...
            $user_reg_date = my_date(
                $mybb->settings['dateformat'],
                $user['regdate']
            );
            $user['postnum'] = my_number_format($user['postnum']);
            $user['threadnum'] = my_number_format($user['threadnum']);
            $user['reputation'] = my_number_format($user['reputation']);
            $warning_link = "warnings.php?uid={$user['uid']}";
            $warning_level = round(
                ($user['warningpoints'] / $mybb->settings['maxwarningpoints']) *
                    100
            );
            $user_lastvisit_date = my_date(
                $mybb->settings['dateformat'],
                $user['lastactive']
            );
            $user_lastvisit_time = my_date(
            ...
            if ($mybb->settings['avatarep_menu_events'] == 2) {
                eval(
                    "\$avatarep_popup = \"" .
                        $templates->get('avatarep_popup_hover', 1, 0) .
                        "\";"
                );
                echo json_encode($avatarep_popup);
                exit();
                ...
                eval(
                    "\$avatarep_popup = \"" .
                        $templates->get('avatarep_popup', 1, 0) .
                        "\";"
                );
                echo $avatarep_popup;
                exit();
