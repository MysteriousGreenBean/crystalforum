...
!(function (t, e) {
    ...
    class Hi extends B {
        constructor(t, e) {
            super(t),
                (this._config = this._getConfig(e)),
                (this._dialog = V.findOne('.mymodal-dialog', this._element)),
        ...
        hide() {
            ...
            if (j.trigger(this._element, 'hide.bs.mymodal').defaultPrevented)
                return
            this._isShown = !1
            ...
            t && (this._isTransitioning = !0),
                ...
                this._queueCallback(() => this._hidemymodal(), this._element, t)
        }
        dispose() {
            ;[window, this._dialog].forEach((t) => j.off(t, '.bs.mymodal')),
        ...
        _showElement(t) {
            ...
            ;(this._element.parentNode &&
                ...
                this._element.setAttribute('aria-mymodal', !0),
                ...
                this._queueCallback(
                    () => {
                        this._config.focus && this._focustrap.activate(),
                            (this._isTransitioning = !1),
                            j.trigger(this._element, 'shown.bs.mymodal', {
                                relatedTarget: t,
                            })
                    },
                    this._dialog,
        ...
        _hidemymodal() {
            ;(this._element.style.display = 'none'),
                ...
                this._element.removeAttribute('aria-mymodal'),
        ...
        _triggerBackdropTransition() {
            if (
                j.trigger(this._element, 'hidePrevented.bs.mymodal')
                    .defaultPrevented
            )
                return
    ...
    class un extends B {
        ...
        dispose() {
            clearTimeout(this._timeout),
                j.off(this._element.closest(ln), cn, this._hidemymodalHandler),
        ...
        _setListeners() {
            this._config.trigger.split(' ').forEach((t) => {
                ...
                j.on(this._element.closest(ln), cn, this._hidemymodalHandler),
                this._config.selector
                    ? (this._config = {
                          ...this._config,
                          trigger: 'manual',
