...
// Carousel - small
document.addEventListener("DOMContentLoaded", function () {
  const wrappers = document.querySelectorAll(".carousel-wrapper.small");
...
const icon = e.target;
  ...
  if (icon.classList.contains("opener") && (icon.classList.contains("cp-minus") || icon.classList.contains("cp-plus"))) {
