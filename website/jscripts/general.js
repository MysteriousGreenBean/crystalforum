var MyBB = {
    ...
    reputation: function (uid, pid) {
        ...
        MyBB.popupWindow(
            '/reputation.php?action=add&uid=' + uid + '&pid=' + pid + '&modal=1'
        )
    },
        ...
        if (expandedItem.length) {
            ...
            element
                .attr({
                    ...
                    src: expState
                        ? expcolImg.replace('collapse.', 'collapse_collapsed.')
                        : expcolImg.replace('collapse_collapsed.', 'collapse.'),
                })
                .parents(':eq(1)')
                .toggleClass(
                    element.parents(':eq(1)').hasClass('thead')
                        ? 'thead_collapsed'
