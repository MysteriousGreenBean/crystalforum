$(function () {
    ...
    if (
        regsettings.securityquestion == '1' &&
        regsettings.questionexists == '1'
    ) {
        $('#answer').rules('add', {
            required: true,
            remote: {
            ...
            function (value, element, param) {
                return !(
                    ...
                    ($('#username').val() != '' &&
                        value == $('#username').val()) ||
                    ($('#email').val() != '' &&
                        value.indexOf($('#email').val()) > -1) ||
                    ($('#username').val() != '' &&
                        value.indexOf($('#username').val()) > -1) ||
                    ($('#email').val() != '' &&
                        $('#email').val().indexOf(value) > -1) ||
                    ($('#username').val() != '' &&
                        $('#username').val().indexOf(value) > -1)
                )
            },
