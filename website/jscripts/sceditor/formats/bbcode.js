...
!(function (t) {
    ...
    var f = t.escapeEntities,
        ...
        y = {
            ...
            color: {
                ...
                format: function (t, e) {
                    ...
                    return (
                        ...
                        s(
                            (n =
                                !p(t, 'font') || !(n = m(t, 'color'))
                                    ? t.style.color || h(t, 'color')
                                    : n)
                        ) +
                        ']' +
                        e +
            ...
            img: {
                ...
                format: function (e, t) {
                    ...
                    return m(e, v)
                        ? t
                        : ((t = m(e, 'width') || r('width')),
                          (r = m(e, 'height') || r('height')),
                          '[img' +
                              (n =
                                  (e.complete && (t || r)) || (t && r)
                                      ? '=' + d.width(e) + 'x' + d.height(e)
                                      : n) +
                              ']' +
                              m(e, 'src') +
                              '[/img]')
                ...
                html: function (t, e, n) {
                    ...
                    return (
                        e.defaultattr &&
                            ((i = (e = e.defaultattr.split(/x/i))[0]),
                            (l = 2 === e.length ? e[1] : e[0])),
                        void 0 !== i && (r += ' width="' + f(i, !0) + '"'),
                        void 0 !== l && (r += ' height="' + f(l, !0) + '"'),
                        '<img' + r + ' src="' + o(n) + '" />'
                    )
                },
            },
            url: {
                ...
                format: function (t, e) {
                    t = m(t, 'href')
                    return 'mailto:' === t.substr(0, 7)
                        ? '[email="' + t.substr(7) + '"]' + e + '[/email]'
                        : '[url=' + t + ']' + e + '[/url]'
                },
                html: function (t, e, n) {
                    return (
                        (e.defaultattr = f(e.defaultattr, !0) || n),
                        '<a href="' + o(e.defaultattr) + '">' + n + '</a>'
                    )
                },
            },
            email: {
    ...
    function T(t) {
        ...
        function d(t, e, n) {
            for (var r = n.length; r--; )
                if (n[r].type === e && n[r].name === t) return 1
        }
        function h(t, e) {
            ...
            (m.toHTML = function (t, e) {
                return (function t(e, n) {
                    ...
                    for (; 0 < e.length; )
                        if ((r = e.shift())) {
                            if (r.type === E)
                                (u = r.children[r.children.length - 1] || {}),
                                    (i = y[r.name]),
                                    (o = n && s(i)),
                                    (l = t(r.children, !1)),
                                    (l =
    ...
    function u() {
        ...
        function f(i, l, e) {
            function o(t) {
                var e = t[0],
                    ...
                    t = i.parentNode
                return (
                    !(!r || (t && d.hasStyle(t, e, r))) && (!n || n.includes(r))
                )
            }
            function t(t) {
                a[t] &&
                    a[t][e] &&
                    g(a[t][e], function (t, e) {
        ...
        function t(t, e, n) {
            var r,
                i,
                e = new T(s.opts.parserOptions).toHTML(
                    s.opts.bbcodeTrim ? e.trim() : e
                )
            return t || n
                ? ((t = e),
                  ...
                  (n = function (t, e) {
                      if (!d.hasStyling(t)) {
                          if (
                              ...
                              for (; (r = t.firstChild); ) i.insertBefore(r, t)
                          !e ||
                              (t !== (e = i.lastChild) &&
                                  p(e, 'div') &&
                                  t.nextSibling === e &&
                  ...
                  h(i, 'display', 'none'),
                  (i.innerHTML = t.replace(/<\/div>\n/g, '</div>')),
                  (t = i.firstChild) && p(t, 'div') && n(t, !0),
                  (t = i.lastChild) && p(t, 'div') && n(t),
                  i.innerHTML)
                : e
        }
        function e(t, e, n, r) {
            ...
            for (
                o.innerHTML = e,
                    h(l, 'visibility', 'hidden'),
                    l.appendChild(o),
                    n.body.appendChild(l),
                    t &&
                        (l.insertBefore(n.createTextNode('#'), l.firstChild),
                        l.appendChild(n.createTextNode('#'))),
                    r && h(o, 'whiteSpace', h(r, 'whiteSpace')),
                    i = o.getElementsByClassName('sceditor-ignore');
                i.length;

            )
                i[0].parentNode.removeChild(i[0])
            return (
                d.removeWhiteSpace(l),
                (o = u(o)),
                n.body.removeChild(l),
                (o = a.toBBCode(o, !0)),
                (o = s.opts.bbcodeTrim ? o.trim() : o)
            )
        }
        ;(s.init = function () {
            ;(s.opts = this.opts),
                ...
                g(y, function (n, t) {
                    ...
                    t &&
                        ((a['*'] = a['*'] || {}),
                        (a['*'][r] = a['*'][r] || {}),
                        (a['*'][r][n] = [['style', Object.entries(t)]])),
                        e &&
                            g(e, function (t, e) {
                                e &&
                                    e.style &&
                                    (e.style = Object.entries(e.style)),
                                    (a[t] = a[t] || {}),
                                    (a[t][r] = a[t][r] || {}),
                                    (a[t][r][n] = e && Object.entries(e))
                            })
                }),
            ...
            (s.toHtml = t.bind(null, !1)),
            (s.fragmentToHtml = t.bind(null, !0)),
            (s.toSource = e.bind(null, !1)),
            (s.fragmentToSource = e.bind(null, !0))
    }
    ;(a.prototype = {
        clone: function () {
            var t = this
        ...
        splitAt: function (t) {
            ...
            return (
                -1 < n &&
                    ((t = this.children.length - n),
                    (e.children = this.children.splice(n, t))),
                e
            )
        },
    }),
