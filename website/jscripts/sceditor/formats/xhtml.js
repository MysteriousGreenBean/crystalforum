    ...
    function T() {
        ...
        function t(t, e, n) {
            ...
            return (
                        ...
                        if (
                            ...
                            1 === o &&
                                ...
                                (1 === t.childNodes.length &&
                                    /br/i.test(d.nodeName))
                                    ? (s = !0)
                                    : (t.classList.remove('sceditor-nlf'),
                                      t.className || E(t, 'class'))),
                            s
                                ? (e = !0)
                                : u && u.length
                                  ? (e = u.indexOf(n) < 0)
                                  : f && f.length && (e = -1 < f.indexOf(n)),
                            e)
                        ) {
                            if (!s) {
                                for (
                                    ...
                                    a &&
                                    b.isInline(a) &&
                                    i.insertBefore(c.createTextNode(' '), t);
                                    t.firstChild;
                                ...
                                r &&
                                    l &&
                                    b.isInline(l) &&
                                    i.insertBefore(c.createTextNode(' '), l)
                            }
                            i.removeChild(t)
                        }
                    },
                ...
                (e = v),
                (u = (c = T.allowedAttribs) && !S(c)),
                (f = (d = T.disallowedAttribs) && !S(d)),
                (h = {}),
                b.traverse(e, function (t) {
                    if (
                        t.attributes &&
                ...
                t ||
                    (function (t) {
                        var e
                        b.removeWhiteSpace(t)
                        for (var n, i = t.firstChild; i; )
                            (n = i.nextSibling),
                                b.isInline(i) && !y(i, '.sceditor-ignore')
                                    ? (e ||
                                          ((e =
                ...
                (t = new m.XHTMLSerializer().serialize(v, !0)),
        ...
        ;(o.init = function () {
            S(T.converters || {}) ||
                a(T.converters, function (t, e) {
                    a(e.tags, function (t) {
                        n[t] || (n[t] = []), n[t].push(e)
                    })
                }),
                (this.commands = r(!0, {}, e, this.commands))
        }),
            (o.toSource = t.bind(null, !1)),
            (o.fragmentToSource = t.bind(null, !0))
    }
    ;(m.XHTMLSerializer = function () {
        var i = { indentStr: '\t' },
            o = [],
            d = 0
        function f(t) {
        ...
        function g(e, t) {
            switch (e.nodeType) {
                case 1:
                    !(function (t, e) {
                        var n,
                            ...
                            c =
                                e ||
                                /pre(?:\-wrap)?$/i.test(w(t, 'whiteSpace')),
                            u = !t.firstChild && !b.canHaveChildren(t) && !a
                        if (!y(t, '.sceditor-ignore')) {
                            for (v('<' + r, !e && h(t)); l--; )
                                (i = t.attributes[l]),
                                    (o = i.value),
                                    v(
                ...
                case 3:
                    ...
                    break
                case 4:
                    v('<![CDATA[' + f(e.nodeValue) + ']]>')
                    break
                case 8:
                    v('\x3c!-- ' + f(e.nodeValue) + ' --\x3e')
                    break
                case 9:
                case 11:
                    !(function () {
        ...
        function h(t) {
            ...
            return 1 !== t.nodeType && e
                ? !b.isInline(e)
                : (!e && !b.isInline(t.parentNode)) || !b.isInline(t)
        }
        ...
        (T.converters = [
            {
                tags: { '*': { width: null } },
                conv: function (t) {
                    w(t, 'width', i(t, 'width')), E(t, 'width')
                },
            },
            {
                tags: { '*': { height: null } },
                conv: function (t) {
                    w(t, 'height', i(t, 'height')), E(t, 'height')
                },
            },
            {
                tags: { li: { value: null } },
            ...
            },
            {
                tags: { '*': { text: null } },
                conv: function (t) {
                    w(t, 'color', i(t, 'text')), E(t, 'text')
                },
            },
            {
                tags: { '*': { color: null } },
                conv: function (t) {
                    w(t, 'color', i(t, 'color')), E(t, 'color')
                },
            },
            {
                tags: { '*': { face: null } },
                conv: function (t) {
                    w(t, 'fontFamily', i(t, 'face')), E(t, 'face')
                },
            },
            {
                tags: { '*': { align: null } },
                conv: function (t) {
                    w(t, 'textAlign', i(t, 'align')), E(t, 'align')
                },
            },
            {
                tags: { '*': { border: null } },
                conv: function (t) {
                    w(t, 'borderWidth', i(t, 'border')), E(t, 'border')
                },
            },
            {
                tags: {
                ...
                conv: function (t) {
                    i(t, 'id') || i(t, 'id', i(t, 'name')), E(t, 'name')
                },
            },
            {
                tags: { '*': { vspace: null } },
                conv: function (t) {
                    w(t, 'marginTop', +i(t, 'vspace')),
                        w(t, 'marginBottom', +i(t, 'vspace')),
                        E(t, 'vspace')
                },
            },
            {
                tags: { '*': { hspace: null } },
                conv: function (t) {
                    w(t, 'marginLeft', +i(t, 'hspace')),
                        w(t, 'marginRight', +i(t, 'hspace')),
                        E(t, 'hspace')
                },
            },
            {
                ...
                conv: function (t) {
                    w(t, 'borderStyle', 'solid'), E(t, 'noshade')
                },
            },
            {
                tags: { '*': { nowrap: null } },
                conv: function (t) {
                    w(t, 'whiteSpace', 'nowrap'), E(t, 'nowrap')
                },
            },
            {
                tags: { big: null },
                conv: function (t) {
                    w(n(t, 'span'), 'fontSize', 'larger')
                },
            },
            {
                tags: { small: null },
                conv: function (t) {
                    w(n(t, 'span'), 'fontSize', 'smaller')
                },
            },
            {
                tags: { b: null },
            ...
            },
            {
                tags: { u: null },
                conv: function (t) {
                    w(n(t, 'span'), 'textDecoration', 'underline')
                },
            },
            {
                tags: { s: null, strike: null },
                conv: function (t) {
                    w(n(t, 'span'), 'textDecoration', 'line-through')
                },
            },
            {
                tags: { dir: null },
            ...
            },
            {
                tags: { center: null },
                conv: function (t) {
                    w(n(t, 'div'), 'textAlign', 'center')
                },
            },
            {
                tags: { font: { size: null } },
                conv: function (t) {
                    w(t, 'fontSize', w(t, 'fontSize')), E(t, 'size')
                },
            },
            {
                tags: { font: null },
            ...
            {
                tags: { '*': { 'data-sce-target': null } },
                conv: function (t) {
                    var e = i(t, 'rel') || '',
                        n = i(t, 'data-sce-target')
                    '_blank' === n &&
                        y(t, 'a') &&
                        (/(^|\s)noopener(\s|$)/.test(e) ||
                            i(t, 'rel', 'noopener' + (e ? ' ' + e : '')),
                        i(t, 'target', n)),
                        E(t, 'data-sce-target')
                },
            },
            {
                tags: { code: null },
                conv: function (t) {
                    for (var e = t.getElementsByTagName('div'); (t = e[0]); )
                        (t.style.display = 'block'), n(t, 'span')
                },
            },
        ]),
        (T.allowedAttribs = {}),
