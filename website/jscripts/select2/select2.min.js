        ...
        function M(a, c, d, e) {
            ...
            for (;;) {
                for (
                    ...
                    k > j &&
                    ((l = e.tokenSeparators[j]), (i = a.indexOf(l)), !(i >= 0));
                    j++
                );
                if (0 > i) break
                if (
                ...
                (c = O(Object, {
                    ...
                    init: function (c) {
                        ...
                        ;(this.opts = c = this.prepareOpts(c)),
                            ...
                            (this.dropdown =
                                this.container.find('.select2-drop')),
                            D(
                                this.dropdown,
                                this.opts.element,
                    ...
                    prepareOpts: function (c) {
                        ...
                        if (
                            ...
                            null != c.selectOnClose &&
                                (c.selectOnBlur = c.selectOnClose),
                            null != c.ajax &&
                            ...
                            var k = c.language
                            a.isFunction(k.noMatches) &&
                                (c.formatNoMatches = k.noMatches),
                                a.isFunction(k.searching) &&
                                    (c.formatSearching = k.searching),
                    ...
                    positionDropdown: function () {
                        ...
                        u
                            ...
                            !s() &&
                                t() &&
                                (o =
                                    d.left + this.container.outerWidth(!1) - r),
                            (y = { left: o, width: f }),
                            w
                                ? (this.container.addClass(
                                      'select2-drop-above'
                    ...
                    prefillNextSearchTerm: function () {
                        ...
                        var a = this.opts.nextSearchTerm(
                            this.data(),
                            this.lastSearchTerm
                        )
                        return a !== b
                                        ...
                                        if (l == this.queryCount) {
                                            ...
                                            if (
                                                ...
                                                this.opts.createSearchChoice &&
                                                    '' !== d.val() &&
                                                    ((i =
                                                        this.opts.createSearchChoice.call(
                                                            h,
                                                            d.val(),
                                                            g.results
                                                        )),
                    ...
                    initContainerWidth: function () {
                        function b() {
                            ...
                            if (
                                ...
                                if (
                                    ((b = this.opts.element.attr('style')),
                                    'string' == typeof b)
                                )
                                    for (
                                        c = b.split(';'), e = 0, f = c.length;
                                        f > e;
                                        e += 1
                                    )
                                        if (
                    ...
                    val: function () {
                        ...
                        if (
                            ...
                            this.opts.debug &&
                                ...
                                this.setPlaceholder(),
                                c &&
                                    this.triggerChange({ added: d, removed: f })
                        else {
                    ...
                    createChoice: function (c) {
                        ...
                        return (
                            ...
                            i != b &&
                                g
                                    .find('div')
                                    .replaceWith(a('<div></div>').html(i)),
                            (j = this.opts.formatSelectionCssClass(
                                c,
                                g.find('div')
                            )),
                            j != b && g.addClass(j),
                    ...
                    val: function (c, d) {
                        ...
                        if ((this.setVal(c), this.select))
                            this.opts.initSelection(
                                ...
                                d &&
                                    this.triggerChange(
                                        this.buildChangeDetails(e, this.data())
                                    )
                        else {
                            if (this.opts.initSelection === b)
                                throw new Error(
                    ...
                    onSortEnd: function () {
                        ...
                        this.searchContainer.show(),
                            ...
                            this.selection
                                ...
                                .each(function () {
                                    b.push(
                                        c.opts.id(a(this).data('select2-data'))
                                    )
                                }),
                            this.setVal(b),
                            this.triggerChange()
                    ...
                    data: function (b, c) {
                        ...
                        return 0 === arguments.length
                            ...
                            : ((f = this.data()),
                              ...
                              c &&
                                  this.triggerChange(
                                      this.buildChangeDetails(f, this.data())
                                  ),
                              void 0)
                    },
                })),
                                ...
                                if (
                                    ...
                                    'container' === f
                                        ...
                                        : 'dropdown' === f
                                          ? (g = e.dropdown)
                                          : (l[f] && (f = l[f]),
                                            (g = e[f].apply(e, c.slice(1)))),
                                    p(c[0], j) >= 0 ||
                                        (p(c[0], k) >= 0 && 1 == c.length))
                                )
                                    return !1
                            }
                        }),
