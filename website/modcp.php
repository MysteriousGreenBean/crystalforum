...
$templatelist =
    'modcp_reports,modcp_reports_report,modcp_reports_selectall,modcp_reports_multipage,modcp_reports_allreport,modcp_reports_allreports,modcp_modlogs_multipage,modcp_announcements_delete,modcp_announcements_edit,modcp_awaitingmoderation';
$templatelist .=
    ',modcp_reports_allnoreports,modcp_reports_noreports,modcp_banning,modcp_banning_ban,modcp_announcements_announcement_global,modcp_no_announcements_forum,modcp_modqueue_threads_thread,modcp_awaitingthreads,preview';
$templatelist .=
    ',modcp_banning_nobanned,modcp_modqueue_threads_empty,modcp_modqueue_masscontrols,modcp_modqueue_threads,modcp_modqueue_posts_post,modcp_modqueue_posts_empty,modcp_awaitingposts,modcp_nav_editprofile,modcp_nav_banning';
$templatelist .=
    ',modcp_nav,modcp_modlogs_noresults,modcp_modlogs_nologs,modcp,modcp_modqueue_posts,modcp_modqueue_attachments_attachment,modcp_modqueue_attachments_empty,modcp_modqueue_attachments,modcp_editprofile_suspensions_info';
$templatelist .=
    ',modcp_no_announcements_global,modcp_announcements_global,modcp_announcements_forum,modcp_announcements,modcp_editprofile_select_option,modcp_editprofile_select,modcp_finduser_noresults, modcp_nav_forums_posts';
$templatelist .=
    ',codebuttons,modcp_announcements_new,modcp_modqueue_empty,forumjump_bit,forumjump_special,modcp_warninglogs_warning_revoked,modcp_warninglogs_warning,modcp_ipsearch_result,modcp_nav_modqueue,modcp_banuser_liftlist';
$templatelist .=
    ',modcp_modlogs,modcp_finduser_user,modcp_finduser,usercp_profile_customfield,usercp_profile_profilefields,modcp_ipsearch_noresults,modcp_ipsearch_results,modcp_ipsearch_misc_info,modcp_nav_announcements,modcp_modqueue_post_link';
$templatelist .=
    ',modcp_editprofile,modcp_ipsearch,modcp_banuser_addusername,modcp_banuser,modcp_warninglogs_nologs,modcp_banuser_editusername,modcp_lastattachment,modcp_lastpost,modcp_lastthread,modcp_nobanned,modcp_modqueue_thread_link';
$templatelist .=
    ',modcp_warninglogs,modcp_modlogs_result,modcp_editprofile_signature,forumjump_advanced,modcp_announcements_forum_nomod,modcp_announcements_announcement,usercp_profile_away,modcp_modlogs_user,modcp_editprofile_away';
$templatelist .=
    ',multipage,multipage_end,multipage_jump_page,multipage_nextpage,multipage_page,multipage_page_current,multipage_page_link_current,multipage_prevpage,multipage_start,modcp_awaitingattachments,modcp_modqueue_attachment_link';
$templatelist .=
    ',postbit_groupimage,postbit_userstar,postbit_online,postbit_offline,postbit_away,postbit_avatar,postbit_find,postbit_pm,postbit_email,postbit_www,postbit_author_user,announcement_edit,announcement_quickdelete';
$templatelist .=
    ',modcp_awaitingmoderation_none,modcp_banning_edit,modcp_banuser_bangroups_group,modcp_banuser_lift,modcp_modlogs_result_announcement,modcp_modlogs_result_forum,modcp_modlogs_result_post,modcp_modlogs_result_thread';
$templatelist .=
    ',modcp_nav_warninglogs,modcp_nav_ipsearch,modcp_nav_users,modcp_announcements_day,modcp_announcements_month_start,modcp_announcements_month_end,modcp_announcements_announcement_expired,modcp_announcements_announcement_active';
$templatelist .=
    ',modcp_modqueue_link_forum,modcp_modqueue_link_thread,usercp_profile_day,modcp_ipsearch_result_regip,modcp_ipsearch_result_lastip,modcp_ipsearch_result_post,modcp_ipsearch_results_information,usercp_profile_profilefields_text';
$templatelist .=
    ',usercp_profile_profilefields_select_option,usercp_profile_profilefields_multiselect,usercp_profile_profilefields_select,usercp_profile_profilefields_textarea,usercp_profile_profilefields_radio,postbit';
$templatelist .=
    ',modcp_banning_remaining,postmodcp_nav_announcements,modcp_nav_reportcenter,modcp_nav_modlogs,modcp_latestfivemodactions,modcp_banuser_bangroups_hidden,modcp_banuser_bangroups,usercp_profile_profilefields_checkbox';
...
if (
    ...
    (int) $mybb->settings['threadsperpage'] < 1
) {
...
if ($mybb->usergroup['issupermod'] != 1) {
    $query = $db->simple_select(
        'moderators',
        '*',
        "(id='{$mybb->user['uid']}' AND isgroup = '0') OR (id IN ({$mybb->usergroup['all_usergroups']}) AND isgroup = '1')"
    );
...
$nav_announcements = $nav_modqueue = $nav_reportcenter = $nav_modlogs = $nav_editprofile = $nav_banning = $nav_warninglogs = $nav_ipsearch = $nav_forums_posts = $modcp_nav_users =
    '';
if (
    ($numannouncements > 0 || $mybb->usergroup['issupermod'] == 1) &&
    $mybb->usergroup['canmanageannounce'] == 1
) {
    eval(
        "\$nav_announcements = \"" .
            $templates->get('modcp_nav_announcements') .
            "\";"
    );
}

if (
    ($nummodqueuethreads > 0 ||
        $nummodqueueposts > 0 ||
        $nummodqueueattach > 0 ||
        $mybb->usergroup['issupermod'] == 1) &&
    $mybb->usergroup['canmanagemodqueue'] == 1
) {
    eval("\$nav_modqueue = \"" . $templates->get('modcp_nav_modqueue') . "\";");
}

if (
    ($numreportedposts > 0 || $mybb->usergroup['issupermod'] == 1) &&
    $mybb->usergroup['canmanagereportedcontent'] == 1
) {
    eval(
        "\$nav_reportcenter = \"" .
            $templates->get('modcp_nav_reportcenter') .
            "\";"
    );
}

if (
    ($nummodlogs > 0 || $mybb->usergroup['issupermod'] == 1) &&
...
if ($mybb->usergroup['caneditprofiles'] == 1) {
    eval(
        "\$nav_editprofile = \"" .
            $templates->get('modcp_nav_editprofile') .
            "\";"
    );
}
...
if ($mybb->usergroup['canviewwarnlogs'] == 1) {
    eval(
        "\$nav_warninglogs = \"" .
            $templates->get('modcp_nav_warninglogs') .
            "\";"
    );
}
...
if (
    !empty($nav_announcements) ||
    !empty($nav_modqueue) ||
    !empty($nav_reportcenter) ||
    !empty($nav_modlogs)
) {
    ...
    eval(
        "\$modcp_nav_forums_posts = \"" .
            $templates->get('modcp_nav_forums_posts') .
            "\";"
    );
}

if (
    !empty($nav_editprofile) ||
    !empty($nav_banning) ||
    !empty($nav_warninglogs) ||
    !empty($nav_ipsearch)
) {
...
if ($mybb->input['action'] == 'do_reports') {
    ...
    if (
        empty($mybb->input['reports']) &&
        empty($mybb->cookies['inlinereports'])
    ) {
    ...
    if (isset($mybb->cookies['inlinereports'])) {
        if ($mybb->cookies['inlinereports'] == '|ALL|') {
            ...
            if (isset($mybb->cookies['inlinereports_removed'])) {
                $inlinereportremovedlist = explode(
                    '|',
                    $mybb->cookies['inlinereports_removed']
                );
...
if ($mybb->input['action'] == 'reports') {
    ...
    if ($mybb->usergroup['cancp'] || $mybb->usergroup['issupermod']) {
        ...
        $query = $db->simple_select(
            'reportedcontent',
            'id3',
            "reportstatus='0' AND (type = 'post' OR type = '')"
        );
    ...
    if ($postcount > $perpage) {
        ...
        eval(
            "\$reportspages = \"" .
                $templates->get('modcp_reports_multipage') .
                "\";"
        );
    }
    ...
    $query = $db->query(
		...
		LEFT JOIN " .
            TABLE_PREFIX .
            "reportreasons rr ON (r.reasonid = rr.rid)
    ...
    if (!$db->num_rows($query)) {
        ...
        eval(
            "\$reports = \"" .
                $templates->get('modcp_reports_noreports') .
                "\";"
        );
    } else {
        ...
        $lang->page_selected = $lang->sprintf(
            $lang->page_selected,
            count($reportcache)
        );
        $lang->select_all = $lang->sprintf(
            $lang->select_all,
            (int) $report_count
        );
        $lang->all_selected = $lang->sprintf(
            $lang->all_selected,
            (int) $report_count
        );
        eval(
            "\$selectall = \"" .
                $templates->get('modcp_reports_selectall') .
                "\";"
        );
        ...
        foreach ($reportcache as $report) {
            ...
            switch ($report['type']) {
                case 'post':
                    $post =
                        get_post_link($report['id']) . "#pid{$report['id']}";
                    $user = build_profile_link(
                        htmlspecialchars_uni(
                            $postcache[$report['id']]['username']
                        ),
                        $postcache[$report['id']]['uid']
                    );
                    $report_data['content'] = $lang->sprintf(
                        $lang->report_info_post,
                        $post,
                        $user
                    );

                    $thread_link = get_thread_link(
                        $postcache[$report['id']]['tid']
                    );
                    $thread_subject = htmlspecialchars_uni(
                        $parser->parse_badwords(
                            $postcache[$report['id']]['subject']
                        )
                    );
                    $report_data['content'] .= $lang->sprintf(
                        $lang->report_info_post_thread,
                        $thread_link,
                        $thread_subject
                    );
                ...
                case 'profile':
                    $user = build_profile_link(
                        htmlspecialchars_uni(
                            $usercache[$report['id']]['username']
                        ),
                        $usercache[$report['id']]['uid']
                    );
                    $report_data['content'] = $lang->sprintf(
                        $lang->report_info_profile,
                        $user
                    );
                    break;
                case 'reputation':
                    $reputation_link = "reputation.php?uid={$usercache[$report['id3']]['uid']}#rid{$report['id']}";
                    $bad_user = build_profile_link(
                        htmlspecialchars_uni(
                            $usercache[$report['id2']]['username']
                        ),
                        $usercache[$report['id2']]['uid']
                    );
                    $report_data['content'] = $lang->sprintf(
                        $lang->report_info_reputation,
                        $reputation_link,
                        $bad_user
                    );

                    $good_user = build_profile_link(
                        htmlspecialchars_uni(
                            $usercache[$report['id3']]['username']
                        ),
                        $usercache[$report['id3']]['uid']
                    );
                    $report_data['content'] .= $lang->sprintf(
                        $lang->report_info_rep_profile,
                        $good_user
                    );
                    break;
            }
            ...
            if ($report['reasonid'] > 0) {
                ...
                if (empty($report['reason'])) {
                    eval(
                        "\$report_data['comment'] = \"" .
                            $templates->get('modcp_reports_report_comment') .
                            "\";"
                    );
                } else {
            ...
            if ($report['lastreporter']) {
                if (is_array($usercache[$report['lastreporter']])) {
                    $lastreport_user = build_profile_link(
                        htmlspecialchars_uni(
                            $usercache[$report['lastreporter']]['username']
                        ),
                        $report['lastreporter']
                    );
                ...
                $report_data['lastreporter'] = $lang->sprintf(
                    $lang->report_info_lastreporter,
                    $lastreport_date,
                    $lastreport_user
                );
            }
            ...
            $inlinecheck = '';
            if (
                isset($mybb->cookies['inlinereports']) &&
                my_strpos(
                    $mybb->cookies['inlinereports'],
                    "|{$report['rid']}|"
                ) !== false
            ) {
            ...
            eval(
                "\$reports .= \"" .
                    $templates->get('modcp_reports_report') .
                    "\";"
            );
        }
    }
...
if ($mybb->input['action'] == 'allreports') {
    ...
    $query = $db->query(
		...
		LEFT JOIN " .
            TABLE_PREFIX .
            "users pr ON (pr.uid=r.id)
		LEFT JOIN " .
            TABLE_PREFIX .
            "users prrep ON (prrep.uid=r.id2)
		LEFT JOIN " .
            TABLE_PREFIX .
            "reportreasons rr ON (r.reasonid = rr.rid)
		{$wflist_reports}
    ...
    if (!$db->num_rows($query)) {
        eval(
            "\$allreports = \"" .
                $templates->get('modcp_reports_allnoreports') .
                "\";"
        );
    } else {
        while ($report = $db->fetch_array($query)) {
            ...
            if ($report['type'] == 'post') {
                ...
                $user = build_profile_link(
                    htmlspecialchars_uni($report['postusername']),
                    $report['postuid']
                );
                $report_data['content'] = $lang->sprintf(
                    $lang->report_info_post,
                ...
                $thread_subject = htmlspecialchars_uni(
                    $parser->parse_badwords($report['threadsubject'])
                );
                $report_data['content'] .= $lang->sprintf(
                    $lang->report_info_post_thread,
                    $thread_link,
                ...
                $user = build_profile_link(
                    htmlspecialchars_uni($report['profileusername']),
                    $report['id']
                );
                $report_data['content'] = $lang->sprintf(
                    $lang->report_info_profile,
                ...
                $user = build_profile_link(
                    htmlspecialchars_uni($report['repusername']),
                    $report['id2']
                );
            ...
            eval(
                "\$allreports .= \"" .
                    $templates->get('modcp_reports_allreport') .
                    "\";"
            );
        }
    }
    ...
    eval(
        "\$allreportedcontent = \"" .
            $templates->get('modcp_reports_allreports') .
            "\";"
    );
...
if ($mybb->input['action'] == 'modlogs') {
    ...
    if ($mybb->get_input('uid', MyBB::INPUT_INT)) {
        $where .=
            " AND l.uid='" . $mybb->get_input('uid', MyBB::INPUT_INT) . "'";
    }

    // Searching for entries in a specific forum
    if ($mybb->get_input('fid', MyBB::INPUT_INT)) {
        $where .=
            " AND t.fid='" . $mybb->get_input('fid', MyBB::INPUT_INT) . "'";
    }
    ...
    if ($postcount > $perpage) {
        eval(
            "\$resultspages = \"" .
                $templates->get('modcp_modlogs_multipage') .
                "\";"
        );
    }
    $query = $db->query(
		...
		LEFT JOIN " .
            TABLE_PREFIX .
            "forums f ON (f.fid=l.fid)
		LEFT JOIN " .
            TABLE_PREFIX .
            "posts p ON (p.pid=l.pid)
		WHERE 1=1 {$where}{$tflist_modlog}
    ...
    while ($logitem = $db->fetch_array($query)) {
        ...
        if ($logitem['username']) {
            ...
            $logitem['profilelink'] = build_profile_link(
                $username,
                $logitem['uid']
            );
        } else {
            $username = $logitem['profilelink'] = $logitem[
                'username'
            ] = htmlspecialchars_uni($lang->na_deleted);
        }
        $logitem['ipaddress'] = my_inet_ntop(
            $db->unescape_binary($logitem['ipaddress'])
        );

        if ($logitem['tsubject']) {
            $logitem['tsubject'] = htmlspecialchars_uni(
                $parser->parse_badwords($logitem['tsubject'])
            );
            $logitem['thread'] = get_thread_link($logitem['tid']);
            eval(
                "\$information .= \"" .
                    $templates->get('modcp_modlogs_result_thread') .
                    "\";"
            );
        }
        if ($logitem['fname']) {
            ...
            eval(
                "\$information .= \"" .
                    $templates->get('modcp_modlogs_result_forum') .
                    "\";"
            );
        }
        if ($logitem['psubject']) {
            $logitem['psubject'] = htmlspecialchars_uni(
                $parser->parse_badwords($logitem['psubject'])
            );
            $logitem['post'] = get_post_link($logitem['pid']);
            eval(
                "\$information .= \"" .
                    $templates->get('modcp_modlogs_result_post') .
                    "\";"
            );
        }
        ...
        if (
            ...
            if (!empty($data['uid'])) {
                ...
                $information = $lang->sprintf(
                    $lang->edited_user_info,
                    htmlspecialchars_uni($data['username']),
                    get_profile_link($data['uid'])
                );
            }
            if (!empty($data['aid'])) {
                $data['subject'] = htmlspecialchars_uni(
                    $parser->parse_badwords($data['subject'])
                );
                $data['announcement'] = get_announcement_link($data['aid']);
                eval(
                    "\$information .= \"" .
                        $templates->get('modcp_modlogs_result_announcement') .
                        "\";"
                );
            }
        }
        ...
        eval(
            "\$results .= \"" . $templates->get('modcp_modlogs_result') . "\";"
        );
    }
    ...
    if (!$results) {
        eval(
            "\$results = \"" .
                $templates->get('modcp_modlogs_noresults') .
                "\";"
        );
    }
    ...
    while ($user = $db->fetch_array($query)) {
        ...
        eval(
            "\$user_options .= \"" .
                $templates->get('modcp_modlogs_user') .
                "\";"
        );
    }

    $forum_select = build_forum_jump(
        '',
...
if ($mybb->input['action'] == 'do_delete_announcement') {
    ...
    if (
        ($mybb->usergroup['issupermod'] != 1 && $announcement['fid'] == -1) ||
        ($announcement['fid'] != -1 &&
            !is_moderator($announcement['fid'], 'canmanageannouncements')) ||
        ($unviewableforums && in_array($announcement['fid'], $unviewableforums))
    ) {
        error_no_permission();
    }
    ...
    log_moderator_action(
        ['aid' => $announcement['aid'], 'subject' => $announcement['subject']],
        $lang->announcement_deleted
    );
    $cache->update_forumsdisplay();

    redirect(
        'modcp.php?action=announcements',
        $lang->redirect_delete_announcement
    );
}
...
if ($mybb->input['action'] == 'delete_announcement') {
    ...
    $announcement = $db->fetch_array($query);
    $announcement['subject'] = htmlspecialchars_uni(
        $parser->parse_badwords($announcement['subject'])
    );
    ...
    eval(
        "\$announcements = \"" .
            $templates->get('modcp_announcements_delete') .
            "\";"
    );
...
if ($mybb->input['action'] == 'do_new_announcement') {
    ...
    if (
        ($mybb->usergroup['issupermod'] != 1 && $announcement_fid == -1) ||
        ($announcement_fid != -1 &&
            !is_moderator($announcement_fid, 'canmanageannouncements')) ||
        ($unviewableforums && in_array($announcement_fid, $unviewableforums))
    ) {
        error_no_permission();
    }
    ...
    $localized_time_offset =
        (float) $mybb->user['timezone'] * 3600 + $mybb->user['dst'] * 3600;
    ...
    $startdate =
        gmmktime(
            ...
            (int) $startdate[1],
            0,
            $mybb->get_input('starttime_month', MyBB::INPUT_INT),
            $mybb->get_input('starttime_day', MyBB::INPUT_INT),
            $mybb->get_input('starttime_year', MyBB::INPUT_INT)
        ) - $localized_time_offset;
    if (
        !checkdate(
            $mybb->get_input('starttime_month', MyBB::INPUT_INT),
    ...
    if ($mybb->get_input('endtime_type', MyBB::INPUT_INT) == 2) {
        ...
        $enddate =
            gmmktime(
                ...
                (int) $enddate[1],
                0,
                $mybb->get_input('endtime_month', MyBB::INPUT_INT),
                $mybb->get_input('endtime_day', MyBB::INPUT_INT),
                $mybb->get_input('endtime_year', MyBB::INPUT_INT)
            ) - $localized_time_offset;
        if (
            !checkdate(
                $mybb->get_input('endtime_month', MyBB::INPUT_INT),
    ...
    if (
        $mybb->settings['announcementshtml'] &&
        $mybb->get_input('allowhtml', MyBB::INPUT_INT) == 1
    ) {
        $allowhtml = 1;
    } else {
        $allowhtml = 0;
    ...
    if (!$errors) {
        if (isset($mybb->input['preview'])) {
            ...
            log_moderator_action(
                ['aid' => $aid, 'subject' => $mybb->input['title']],
                $lang->announcement_added
            );
            ...
            redirect(
                'modcp.php?action=announcements',
                $lang->redirect_add_announcement
            );
        }
    } else {
        $mybb->input['action'] = 'new_announcement';
...
if ($mybb->input['action'] == 'new_announcement') {
    ...
    add_breadcrumb(
        $lang->mcp_nav_announcements,
        'modcp.php?action=announcements'
    );
    add_breadcrumb(
        $lang->add_announcement,
        'modcp.php?action=new_announcements'
    );
    ...
    if (!empty($errors) || isset($preview)) {
        ...
        $localized_time =
            TIME_NOW +
            (float) $mybb->user['timezone'] * 3600 +
            $mybb->user['dst'] * 3600;

        $starttime_time = gmdate(
    ...
    for ($day = 1; $day <= 31; ++$day) {
        if ($startday == $day) {
            ...
            eval(
                "\$startdateday .= \"" .
                    $templates->get('modcp_announcements_day') .
                    "\";"
            );
        } else {
            $selected = '';
    ...
    eval(
        "\$startdatemonth .= \"" .
            $templates->get('modcp_announcements_month_start') .
            "\";"
    );
    eval(
        "\$enddatemonth .= \"" .
            $templates->get('modcp_announcements_month_end') .
            "\";"
    );
    ...
    if ($mybb->settings['announcementshtml']) {
        ...
        eval(
            "\$allow_html = \"" .
                $templates->get('modcp_announcements_allowhtml') .
                "\";"
        );
    } else {
        $allow_html = '';
    ...
    if (
        !isset($mybb->input['endtime_type']) ||
        $mybb->input['endtime_type'] == 2
    ) {
    ...
    if (isset($preview)) {
        $announcementarray = [
            ...
            'allowhtml' =>
                $mybb->settings['announcementshtml'] &&
                $mybb->get_input('allowhtml', MyBB::INPUT_INT),
        ...
        foreach ($data_key as $field => $key) {
            $announcementarray[$key] =
                $groupscache[$announcementarray['usergroup']][$field];
        }
    ...
    eval(
        "\$announcements = \"" .
            $templates->get('modcp_announcements_new') .
            "\";"
    );
    output_page($announcements);
}
...
if ($mybb->input['action'] == 'do_edit_announcement') {
    ...
    if (!$errors) {
        if (isset($mybb->input['preview'])) {
            ...
            redirect(
                'modcp.php?action=announcements',
                $lang->redirect_edit_announcement
            );
        }
    } else {
        $mybb->input['action'] = 'edit_announcement';
...
if ($mybb->input['action'] == 'edit_announcement') {
    ...
    add_breadcrumb(
        ...
        "modcp.php?action=edit_announcements&amp;aid={$aid}"
    );
    ...
    if (!empty($errors) || isset($preview)) {
        ...
        $localized_time_startdate =
            $announcement['startdate'] +
            (float) $mybb->user['timezone'] * 3600 +
            $mybb->user['dst'] * 3600;
        $localized_time_enddate =
    ...
    $end_type_sel = ['infinite' => '', 'finite' => ''];
    if (
        ($errored && $mybb->get_input('endtime_type', MyBB::INPUT_INT) == 2) ||
        (!$errored && (int) $announcement['enddate'] == 0) ||
        $makeshift_end == true
    ) {
        $end_type_sel['infinite'] = ' checked="checked"';
    } else {
    ...
    eval(
        "\$announcements = \"" .
            $templates->get('modcp_announcements_edit') .
            "\";"
    );
    output_page($announcements);
}
...
if ($mybb->input['action'] == 'announcements') {
    ...
    while ($announcement = $db->fetch_array($query)) {
        ...
        $announcements[$announcement['fid']][
            $announcement['aid']
        ] = $announcement;
    }
    ...
    if ($mybb->usergroup['issupermod'] == 1) {
        if ($global_announcements && $mybb->usergroup['issupermod'] == 1) {
            ...
            foreach ($global_announcements as $aid => $announcement) {
                $trow = alt_trow();
                if (
                    (isset($announcement['startdate']) &&
                        $announcement['startdate'] > TIME_NOW) ||
                    (isset($announcement['enddate']) &&
                        $announcement['enddate'] < TIME_NOW &&
                        $announcement['enddate'] != 0)
                ) {
                    eval(
                        "\$icon = \"" .
                            $templates->get(
                                'modcp_announcements_announcement_expired'
                            ) .
                            "\";"
                    );
                } else {
                    eval(
                        "\$icon = \"" .
                            $templates->get(
                                'modcp_announcements_announcement_active'
                            ) .
                            "\";"
                    );
                }

                $subject = htmlspecialchars_uni(
                    $parser->parse_badwords($announcement['subject'])
                );
            ...
            eval(
                "\$announcements_global = \"" .
                    $templates->get('modcp_no_announcements_global') .
                    "\";"
            );
        }
        eval(
            "\$announcements_global = \"" .
                $templates->get('modcp_announcements_global') .
                "\";"
        );
    }
    ...
    if (!$announcements_forum) {
        eval(
            "\$announcements_forum = \"" .
                $templates->get('modcp_no_announcements_forum') .
                "\";"
        );
    }
    ...
    eval(
        "\$announcements = \"" . $templates->get('modcp_announcements') . "\";"
    );
    output_page($announcements);
}
...
if ($mybb->input['action'] == 'do_modqueue') {
    ...
    $mybb->input['attachments'] = $mybb->get_input(
        'attachments',
        MyBB::INPUT_ARRAY
    );
    if (!empty($mybb->input['threads'])) {
        ...
        $query = $db->simple_select(
            'threads',
            'tid',
            'tid IN (' . implode(',', $threads) . "){$flist_queue_threads}"
        );
        ...
        if (!empty($threads_to_approve)) {
            ...
            log_moderator_action(
                ['tids' => $threads_to_approve],
                $lang->multi_approve_threads
            );
        }
        if (!empty($threads_to_delete)) {
            if ($mybb->settings['soft_delete'] == 1) {
                ...
                log_moderator_action(
                    ['tids' => $threads_to_delete],
                    $lang->multi_soft_delete_threads
                );
            } else {
        ...
        $query = $db->simple_select(
            'posts',
            'pid',
            'pid IN (' . implode(',', $posts) . "){$flist_queue_posts}"
        );
        while ($post = $db->fetch_array($query)) {
        ...
        if (!empty($posts_to_approve)) {
            ...
            log_moderator_action(
                ['pids' => $posts_to_approve],
                $lang->multi_approve_posts
            );
        }
        if (!empty($posts_to_delete)) {
            if ($mybb->settings['soft_delete'] == 1) {
                ...
                log_moderator_action(
                    ['pids' => $posts_to_delete],
                    $lang->multi_soft_delete_posts
                );
            } else {
                log_moderator_action(
                    ['pids' => $posts_to_delete],
                    $lang->multi_delete_posts
                );
            }
        }
        ...
        redirect(
            'modcp.php?action=modqueue&type=posts',
            $lang->redirect_postsmoderated
        );
    } elseif (!empty($mybb->input['attachments'])) {
        $attachments = array_map(
            'intval',
            array_keys($mybb->input['attachments'])
        );
        $query = $db->query(
            "
			...
			LEFT JOIN " .
                TABLE_PREFIX .
                "posts p ON (a.pid=p.pid)
			LEFT JOIN " .
                TABLE_PREFIX .
                "threads t ON (t.tid=p.tid)
			WHERE aid IN (" .
                implode(',', $attachments) .
                "){$tflist_queue_attach}
		"
        ...
        while ($attachment = $db->fetch_array($query)) {
            ...
            if ($action == 'approve') {
                ...
                if (isset($attachment['tid'])) {
                    update_thread_counters((int) $attachment['tid'], [
                        'attachmentcount' => '+1',
                    ]);
                }
            } elseif ($action == 'delete') {
        ...
        redirect(
            'modcp.php?action=modqueue&type=attachments',
            $lang->redirect_attachmentsmoderated
        );
    }
}
...
if ($mybb->input['action'] == 'modqueue') {
    ...
    if (
        ...
        (!$mybb->input['type'] &&
            ($nummodqueuethreads > 0 || $mybb->usergroup['issupermod'] == 1))
    ) {
        ...
        $query = $db->simple_select(
            'threads',
            'COUNT(tid) AS unapprovedthreads',
            "visible='0' {$flist_queue_threads}"
        );
        ...
        $multipage = multipage(
            ...
            $perpage,
            $page,
            'modcp.php?action=modqueue&type=threads'
        );
        ...
        while ($thread = $db->fetch_array($query)) {
            $altbg = alt_trow();
            $thread['subject'] = htmlspecialchars_uni(
                $parser->parse_badwords($thread['subject'])
            );
            ...
            if ($thread['username'] == '') {
                if ($thread['threadusername'] != '') {
                    $thread['threadusername'] = htmlspecialchars_uni(
                ...
                $profile_link = build_profile_link(
                    $thread['username'],
                    $thread['uid']
                );
            }
            ...
            $thread['postmessage'] = nl2br(
                htmlspecialchars_uni($thread['postmessage'])
            );
            eval(
                "\$forum = \"" .
                    $templates->get('modcp_modqueue_link_forum') .
                    "\";"
            );
            eval(
                "\$threads .= \"" .
                    $templates->get('modcp_modqueue_threads_thread') .
                    "\";"
            );
        }
        ...
        if (!$threads && $mybb->input['type'] == 'threads') {
            eval(
                "\$threads = \"" .
                    $templates->get('modcp_modqueue_threads_empty') .
                    "\";"
            );
        }
        ...
        if ($threads) {
            ...
            if ($nummodqueueposts > 0 || $mybb->usergroup['issupermod'] == 1) {
                ...
                eval(
                    "\$post_link = \"" .
                        $templates->get('modcp_modqueue_post_link') .
                        "\";"
                );
            }

            if (
                $mybb->settings['enableattachments'] == 1 &&
                ($nummodqueueattach > 0 || $mybb->usergroup['issupermod'] == 1)
            ) {
                $navsep = ' | ';
                eval(
                    "\$attachment_link = \"" .
                        $templates->get('modcp_modqueue_attachment_link') .
                        "\";"
                );
            }
            ...
            eval(
                "\$mass_controls = \"" .
                    $templates->get('modcp_modqueue_masscontrols') .
                    "\";"
            );
            eval(
                "\$threadqueue = \"" .
                    $templates->get('modcp_modqueue_threads') .
                    "\";"
            );
    ...
    if (
        $mybb->input['type'] == 'posts' ||
        (!$mybb->input['type'] &&
            !$threadqueue &&
            ($nummodqueueposts > 0 || $mybb->usergroup['issupermod'] == 1))
    ) {
        if ($nummodqueueposts == 0 && $mybb->usergroup['issupermod'] != 1) {
        ...
        while ($post = $db->fetch_array($query)) {
            $altbg = alt_trow();
            $post['threadsubject'] = htmlspecialchars_uni(
                $parser->parse_badwords($post['threadsubject'])
            );
            $post['subject'] = htmlspecialchars_uni(
            ...
            if ($post['username'] == '') {
                if ($post['postusername'] != '') {
                    $post['postusername'] = htmlspecialchars_uni(
                        $post['postusername']
                    );
            ...
            eval(
                "\$thread = \"" .
                    $templates->get('modcp_modqueue_link_thread') .
                    "\";"
            );
            eval(
                "\$forum = \"" .
            ...
            eval(
                "\$posts .= \"" .
                    $templates->get('modcp_modqueue_posts_post') .
                    "\";"
            );
        }
        ...
        if (!$posts && $mybb->input['type'] == 'posts') {
            eval(
                "\$posts = \"" .
                    $templates->get('modcp_modqueue_posts_empty') .
                    "\";"
            );
        }
        ...
        if ($posts) {
            ...
            if (
                ...
                eval(
                    "\$thread_link = \"" .
                        $templates->get('modcp_modqueue_thread_link') .
                        "\";"
                );
            }
            ...
            eval(
                "\$postqueue = \"" .
                    $templates->get('modcp_modqueue_posts') .
                    "\";"
            );
    ...
    if (
        ...
        $unapproved_attachments = $db->fetch_field(
            $query,
        ...
        while ($attachment = $db->fetch_array($query)) {
            ...
            $attachment['postsubject'] = htmlspecialchars_uni(
                $parser->parse_badwords($attachment['postsubject'])
            );
            $attachment['filename'] = htmlspecialchars_uni(
                $attachment['filename']
            );
            $attachment['threadsubject'] = htmlspecialchars_uni(
                $parser->parse_badwords($attachment['threadsubject'])
            );
            $attachment['filesize'] = get_friendly_size(
                $attachment['filesize']
            );

            $link =
                get_post_link($attachment['pid'], $attachment['tid']) .
                "#pid{$attachment['pid']}";
            $thread_link = get_thread_link($attachment['tid']);
            $attachment['username'] = htmlspecialchars_uni(
                $attachment['username']
            );
            $profile_link = build_profile_link(
                $attachment['username'],
            ...
            eval(
                "\$attachments .= \"" .
                    $templates->get('modcp_modqueue_attachments_attachment') .
                    "\";"
            );
        }
        ...
        if (!$attachments && $mybb->input['type'] == 'attachments') {
            eval(
                "\$attachments = \"" .
                    $templates->get('modcp_modqueue_attachments_empty') .
                    "\";"
            );
        }
        ...
        if ($attachments) {
            add_breadcrumb(
                $lang->mcp_nav_modqueue_attachments,
                'modcp.php?action=modqueue&amp;type=attachments'
            );
            ...
            eval(
                "\$attachmentqueue = \"" .
                    $templates->get('modcp_modqueue_attachments') .
                    "\";"
            );
...
if ($mybb->input['action'] == 'do_editprofile') {
    ...
    if (
        $mybb->get_input('away', MyBB::INPUT_INT) == 1 &&
    ...
    if (!$userhandler->validate_user()) {
        ...
        foreach ($moderator_options as $option) {
            ${$option['time']} = $mybb->get_input(
                $option['time'],
                MyBB::INPUT_INT
            );
            $mybb->input[$option['period']] = $mybb->get_input(
                $option['period']
            );
...
if ($mybb->input['action'] == 'editprofile') {
    ...
    if (!$errors) {
        ...
        list(
            $mybb->input['birthday_day'],
            $mybb->input['birthday_month'],
            $mybb->input['birthday_year'],
        ) = $birthday;
    } else {
        $errors = inline_error($errors);
    }
    ...
    for ($day = 1; $day <= 31; ++$day) {
        ...
        eval(
            "\$bdaydaysel .= \"" . $templates->get('usercp_profile_day') . "\";"
        );
    }
    ...
    if ($mybb->settings['allowaway'] != 0) {
        ...
        if ($errors) {
            ...
            $user['awayreason'] = htmlspecialchars_uni(
                $mybb->get_input('awayreason')
            );
        } else {
        ...
        for ($day = 1; $day <= 31; ++$day) {
            ...
            eval(
                "\$returndatesel .= \"" .
                    $templates->get('usercp_profile_day') .
                    "\";"
            );
        }
        ...
        eval(
            "\$awaysection = \"" .
                $templates->get('usercp_profile_away') .
                "\";"
        );
    }
    ...
    if (is_array($pfcache)) {
        foreach ($pfcache as $profilefield) {
            ...
            $profilefield['description'] = htmlspecialchars_uni(
            ...
            if ($type == 'multiselect') {
                ...
                eval(
                    "\$code = \"" .
                        $templates->get('usercp_profile_profilefields_text') .
                        "\";"
                );
            }
            ...
            if ($profilefield['required'] == 1) {
                eval(
                    "\$requiredfields .= \"" .
                        $templates->get('usercp_profile_customfield') .
                        "\";"
                );
            } else {
                eval(
    ...
    if ($customfields) {
        eval(
            "\$customfields = \"" .
                $templates->get('usercp_profile_profilefields') .
                "\";"
        );
    }

    $user['username'] = htmlspecialchars_uni($user['username']);
    $lang->edit_profile = $lang->sprintf(
        $lang->edit_profile,
        $user['username']
    );
    $profile_link = build_profile_link(
    ...
    if (
        $user['suspendsignature'] ||
        ($mybb->get_input('suspendsignature', MyBB::INPUT_INT) &&
            !empty($errors))
    ) {
        $checked = 1;
    ...
    if (
        $user['moderateposts'] ||
        ($mybb->get_input('moderateposting', MyBB::INPUT_INT) &&
            !empty($errors))
    ) {
        $modpost_check = 1;
    ...
    if (
        $user['suspendposting'] ||
        ($mybb->get_input('suspendposting', MyBB::INPUT_INT) && !empty($errors))
    ) {
        $suspost_check = 1;
    ...
    foreach ($moderator_options as $option) {
        ...
        foreach ($periods as $key => $value) {
            ...
            eval(
                "\$selection_options .= \"" .
                    $templates->get('modcp_editprofile_select_option') .
                    "\";"
            );
        }
        ...
        switch ($option['option']) {
            case 'suspendsignature':
                eval(
                    "\$action_options = \"" .
                        $templates->get('modcp_editprofile_select') .
                        "\";"
                );
                break;
            case 'moderateposts':
    ...
    eval(
        "\$suspend_signature = \"" .
            $templates->get('modcp_editprofile_signature') .
            "\";"
    );
...
if ($mybb->input['action'] == 'finduser') {
    ...
    if (isset($mybb->input['username'])) {
        ...
        $where =
            " AND {$field} LIKE '%" .
            my_strtolower(
                $db->escape_string_like($mybb->get_input('username'))
            ) .
            "%'";
    }
    ...
    // Fetch out results
    $query = $db->simple_select('users', '*', "1=1 {$where}", [
        'order_by' => $sortby,
        'order_dir' => $order,
        'limit' => $perpage,
        'limit_start' => $start,
    ...
    while ($user = $db->fetch_array($query)) {
        ...
        $usergroup = htmlspecialchars_uni(
            $usergroups_cache[$user['usergroup']]['title']
        );
    ...
    if (!$users) {
        eval(
            "\$users = \"" . $templates->get('modcp_finduser_noresults') . "\";"
        );
    }
...
if ($mybb->input['action'] == 'warninglogs') {
    ...
    if (!empty($mybb->input['filter']['username'])) {
        ...
        $mybb->input['filter']['username'] = htmlspecialchars_uni(
    ...
    if (!empty($mybb->input['filter']['uid'])) {
        ...
        if (!isset($mybb->input['search']['username'])) {
            ...
            $mybb->input['search']['username'] = htmlspecialchars_uni(
                $user['username']
            );
        }
    } else {
    ...
    if (!empty($mybb->input['filter']['mod_username'])) {
        $mod_user = get_user_by_username(
            $mybb->input['filter']['mod_username']
        );

        $mybb->input['filter']['mod_uid'] = (int) $mod_user['uid'];
        $mybb->input['filter']['mod_username'] = htmlspecialchars_uni(
            $mybb->input['filter']['mod_username']
        );
    } else {
        $mybb->input['filter']['mod_username'] = '';
    ...
    if (!empty($mybb->input['filter']['mod_uid'])) {
        ...
        if (!isset($mybb->input['search']['mod_username'])) {
            ...
            $mybb->input['search']['mod_username'] = htmlspecialchars_uni(
                $mod_user['username']
            );
        }
    } else {
    ...
    if (!empty($mybb->input['filter']['reason'])) {
        $search['reason'] = $db->escape_string_like(
        ...
        $mybb->input['filter']['reason'] = htmlspecialchars_uni(
            $mybb->input['filter']['reason']
        );
    } else {
        $mybb->input['filter']['reason'] = '';
    ...
    $per_page = 20;
    if (
        isset($mybb->input['filter']['per_page']) &&
        (int) $mybb->input['filter']['per_page'] > 0
    ) {
    ...
    $sql =
        ...
        "warnings w
			LEFT JOIN " .
        TABLE_PREFIX .
        "users u ON (w.uid=u.uid)
			LEFT JOIN " .
        TABLE_PREFIX .
        "warningtypes t ON (w.tid=t.tid)
			LEFT JOIN " .
        TABLE_PREFIX .
        "users i ON (i.uid=w.issuedby)
		WHERE 1=1
			{$where_sql}
		ORDER BY {$sortby} {$order}
    ...
    while ($row = $db->fetch_array($query)) {
        ...
        $mod_username = format_name(
            $row['mod_username'],
            $row['mod_usergroup'],
            $row['mod_displaygroup']
        );
        ...
        if ($row['daterevoked'] > 0) {
            ...
            eval(
                "\$revoked_text = \"" .
                    $templates->get('modcp_warninglogs_warning_revoked') .
                    "\";"
            );
        }
        if ($row['expires'] > 0) {
        ...
        eval(
            "\$warning_list .= \"" .
                $templates->get('modcp_warninglogs_warning') .
                "\";"
        );
    }
    ...
    if (!$warning_list) {
        eval(
            "\$warning_list = \"" .
                $templates->get('modcp_warninglogs_nologs') .
                "\";"
        );
    }
    ...
    if ($mybb->input['ipaddress']) {
        ...
        if (isset($mybb->input['search_posts'])) {
            ...
            if ($ip_range) {
                if (!is_array($ip_range)) {
                    $post_ip_sql =
                        'p.ipaddress=' . $db->escape_binary($ip_range);
                } else {
                    $post_ip_sql =
                        'p.ipaddress BETWEEN ' .
            ...
            if ($post_ip_sql) {
                ...
                if (!empty($onlyusfids)) {
                    $where_sql .=
                        ' AND ((t.fid IN(' .
                        implode(',', $onlyusfids) .
                        ") AND t.uid='{$mybb->user['uid']}') OR t.fid NOT IN(" .
                        implode(',', $onlyusfids) .
                        '))';
                }
                ...
                if ($mybb->usergroup['issupermod'] != 1) {
                    ...
                    if (!empty($unapprove_forums)) {
                        $visible_sql .=
                            ' OR (p.visible = 0 AND p.fid IN(' .
                            implode(',', $unapprove_forums) .
                            ')) OR (t.visible = 0 AND t.fid IN(' .
                            implode(',', $unapprove_forums) .
                            '))';
                    }
                    if (!empty($deleted_forums)) {
                        $visible_sql .=
                            ' OR (p.visible = -1 AND p.fid IN(' .
                            implode(',', $deleted_forums) .
                            ')) OR (t.visible = -1 AND t.fid IN(' .
                            implode(',', $deleted_forums) .
                            '))';
                    }
                } else {
        ...
        if (
            ...
            while ($ipaddress = $db->fetch_array($query)) {
                $result = false;
                $ipaddress['username'] = htmlspecialchars_uni(
                    $ipaddress['username']
                );
                $profile_link = build_profile_link(
                    $ipaddress['username'],
                ...
                if (is_array($ip_range)) {
                    if (
                        strcmp($ip_range[0], $ipaddress['regip']) <= 0 &&
                        strcmp($ip_range[1], $ipaddress['regip']) >= 0
                    ) {
                        eval(
                            "\$subject = \"" .
                                $templates->get('modcp_ipsearch_result_regip') .
                                "\";"
                        );
                        $ip = my_inet_ntop(
                            $db->unescape_binary($ipaddress['regip'])
                        );
                    } elseif (
                        strcmp($ip_range[0], $ipaddress['lastip']) <= 0 &&
                        strcmp($ip_range[1], $ipaddress['lastip']) >= 0
                    ) {
                        eval(
                            "\$subject = \"" .
                                $templates->get(
                                    'modcp_ipsearch_result_lastip'
                                ) .
                                "\";"
                        );
                        $ip = my_inet_ntop(
                            $db->unescape_binary($ipaddress['lastip'])
                        );
                    }
                    ...
                    eval(
                        "\$subject = \"" .
                            $templates->get('modcp_ipsearch_result_lastip') .
                            "\";"
                    );
                    $ip = my_inet_ntop(
                        $db->unescape_binary($ipaddress['lastip'])
        ...
        if (
            isset($mybb->input['search_posts']) &&
            $post_results &&
            (!isset($mybb->input['search_users']) ||
                (isset($mybb->input['search_users']) && $post_limit > 0))
        ) {
            ...
            if (!empty($ipaddresses)) {
                $query = $db->simple_select(
                    'threads',
                    'subject, tid',
                    'tid IN(' . implode(',', array_keys($tids)) . ')'
                );
                while ($thread = $db->fetch_array($query)) {
                    $ipaddresses[$tids[$thread['tid']]]['threadsubject'] =
                        $thread['subject'];
                }
                unset($tids);
                ...
                $query = $db->simple_select(
                    'users',
                    'username, uid',
                    'uid IN(' . implode(',', array_keys($uids)) . ')'
                );
                while ($user = $db->fetch_array($query)) {
                    $ipaddresses[$uids[$user['uid']]]['username'] =
                        $user['username'];
                }
                unset($uids);
                ...
                foreach ($ipaddresses as $ipaddress) {
                    $ip = my_inet_ntop(
                        $db->unescape_binary($ipaddress['ipaddress'])
                    );
                    ...
                    if (empty($ipaddress['subject'])) {
                        $ipaddress[
                            'subject'
                        ] = "RE: {$ipaddress['threadsubject']}";
                    }

                    $ipaddress['postlink'] = get_post_link(
                        $ipaddress['pid'],
                        $ipaddress['tid']
                    );
                    $ipaddress['subject'] = htmlspecialchars_uni(
                        $parser->parse_badwords($ipaddress['subject'])
                    );
                    $ipaddress['profilelink'] = build_profile_link(
                        $ipaddress['username'],
                        $ipaddress['uid']
                    );
                    ...
                    eval(
                        "\$subject = \"" .
                            $templates->get('modcp_ipsearch_result_post') .
                            "\";"
                    );
                    eval(
                        "\$results .= \"" .
        ...
        if (!$results) {
            eval(
                "\$results = \"" .
                    $templates->get('modcp_ipsearch_noresults') .
                    "\";"
            );
        }

        if ($ipaddressvalue) {
            $lang->ipsearch_results = $lang->sprintf(
                $lang->ipsearch_results,
                $ipaddressvalue
            );
        } else {
        ...
        if (
            ...
            eval(
                "\$misc_info_link = \"" .
                    $templates->get('modcp_ipsearch_results_information') .
                    "\";"
            );
        }
        ...
        eval(
            "\$ipsearch_results = \"" .
                $templates->get('modcp_ipsearch_results') .
                "\";"
        );
    }
...
if ($mybb->input['action'] == 'iplookup') {
    ...
    eval(
        "\$iplookup = \"" .
            $templates->get('modcp_ipsearch_misc_info', 1, 0) .
            "\";"
    );
    echo $iplookup;
    exit();
...
if ($mybb->input['action'] == 'banning') {
    ...
    while ($banned = $db->fetch_array($query)) {
        ...
        if (
            ...
            eval(
                "\$edit_link = \"" .
                    $templates->get('modcp_banning_edit') .
                    "\";"
            );
        }

        $admin_profile = build_profile_link(
            htmlspecialchars_uni($banned['adminuser']),
            $banned['admin']
        );
        ...
        if ($banned['reason']) {
            $banned['reason'] = htmlspecialchars_uni(
                $parser->parse_badwords($banned['reason'])
            );
        } else {
        ...
        if (
            ...
            $timeremaining =
                nice_time($remaining, ['short' => 1, 'seconds' => false]) . '';
            ...
            eval(
                '$timeremaining = "' .
                    $templates->get('modcp_banning_remaining') .
                    '";'
            );
        }

        eval(
            "\$bannedusers .= \"" . $templates->get('modcp_banning_ban') . "\";"
        );
    }
    ...
    if (!$bannedusers) {
        eval(
            "\$bannedusers = \"" .
                $templates->get('modcp_banning_nobanned') .
                "\";"
        );
    }
...
if ($mybb->input['action'] == 'do_banuser' && $mybb->request_method == 'post') {
    ...
    $usergroups_cache = $cache->read('usergroups');
    if (
        isset($usergroups_cache[$mybb->get_input('usergroup', MyBB::INPUT_INT)])
    ) {
        $usergroup =
            $usergroups_cache[$mybb->get_input('usergroup', MyBB::INPUT_INT)];
    }
    ...
    if (!$errors) {
        ...
        if ($mybb->get_input('liftafter') == '---') {
            ...
            $lifted = ban_date2timestamp(
                $mybb->get_input('liftafter'),
                $user['dateline']
            );
        }
...
if ($mybb->input['action'] == 'banuser') {
    ...
    if ($mybb->input['uid']) {
        ...
        if (!empty($banned['username'])) {
            $username = $banned['username'] = htmlspecialchars_uni(
                $banned['username']
            );
            ...
            eval(
                "\$banuser_username = \"" .
                    $templates->get('modcp_banuser_editusername') .
                    "\";"
            );
        }
    }
    ...
    if (!$banuser_username) {
        ...
        eval(
            "\$banuser_username = \"" .
                $templates->get('modcp_banuser_addusername') .
                "\";"
        );
    }
    ...
    foreach ($bantimes as $time => $title) {
        ...
        if ($time != '---') {
            ...
            $thatime = my_date(
                ...
                ban_date2timestamp($time, $dateline)
            );
            $thattime = " ({$thatime})";
        }
        ...
        eval(
            "\$liftlist .= \"" .
                $templates->get('modcp_banuser_liftlist') .
                "\";"
        );
    }
    ...
    if ($numgroups == 0) {
        ...
        eval(
            "\$bangroups = \"" .
                $templates->get('modcp_banuser_bangroups') .
                "\";"
        );
    } else {
        eval(
            "\$bangroups = \"" .
                $templates->get('modcp_banuser_bangroups_hidden') .
                "\";"
        );
    }
    ...
    if (!empty($banned['uid'])) {
        eval(
            "\$lift_link = \"" . $templates->get('modcp_banuser_lift') . "\";"
        );
        $uid = $banned['uid'];
    } else {
        $lift_link = '';
...
if (!$mybb->input['action']) {
    ...
    if ($mybb->usergroup['canmanagemodqueue'] == 1) {
        if (
            ...
            if ($unapproved_attachments > 0) {
                ...
                $attachment['profilelink'] = build_profile_link(
                    $attachment['username'],
                    $attachment['uid']
                );
                $attachment['link'] = get_post_link(
                    $attachment['pid'],
                    $attachment['tid']
                );
                $attachment['filename'] = htmlspecialchars_uni(
                ...
                $unapproved_attachments = my_number_format(
                    $unapproved_attachments
                );

                eval(
                    "\$latest_attachment = \"" .
                        $templates->get('modcp_lastattachment') .
                        "\";"
                );
            } else {
                eval(
                    "\$latest_attachment = \"" .
                        $templates->get('modcp_awaitingmoderation_none') .
                        "\";"
                );
            }
            ...
            eval(
                "\$awaitingattachments = \"" .
                    $templates->get('modcp_awaitingattachments') .
                    "\";"
            );
        }
        ...
        if ($nummodqueueposts > 0 || $mybb->usergroup['issupermod'] == 1) {
            ...
            if ($unapproved_posts > 0) {
                ...
                $post['username'] = htmlspecialchars_uni($post['username']);
                $post['profilelink'] = build_profile_link(
                    $post['username'],
                    $post['uid']
                );
                ...
                if (my_strlen($post['subject']) > 25) {
                    $post['subject'] =
                        my_substr($post['subject'], 0, 25) . '...';
                }
                $post['subject'] = htmlspecialchars_uni($post['subject']);
                $post['fullsubject'] = htmlspecialchars_uni(
                    $post['fullsubject']
                );
            ...
            eval(
                "\$awaitingposts = \"" .
                    $templates->get('modcp_awaitingposts') .
                    "\";"
            );
        }
        ...
        if ($nummodqueuethreads > 0 || $mybb->usergroup['issupermod'] == 1) {
            ...
            if ($unapproved_threads > 0) {
                $query = $db->simple_select(
                    'threads',
                    'tid, subject, uid, username, dateline',
                    "visible='0' {$flist_queue_threads}",
                    [
                        'order_by' => 'dateline',
                        'order_dir' => 'DESC',
                ...
                if (my_strlen($thread['subject']) > 25) {
                    $post['subject'] =
                        my_substr($thread['subject'], 0, 25) . '...';
                }
                $thread['subject'] = htmlspecialchars_uni($thread['subject']);
                $thread['fullsubject'] = htmlspecialchars_uni(
                    $thread['fullsubject']
                );
            ...
            eval(
                "\$awaitingthreads = \"" .
                    $templates->get('modcp_awaitingthreads') .
                    "\";"
            );
        }

        if (
            !empty($awaitingattachments) ||
            !empty($awaitingposts) ||
            !empty($awaitingthreads)
        ) {
            eval(
                "\$awaitingmoderation = \"" .
                    $templates->get('modcp_awaitingmoderation') .
                    "\";"
            );
        }
    }
    ...
    if (
        ...
        while ($logitem = $db->fetch_array($query)) {
            ...
            if (
                ...
                if (isset($data['aid'])) {
                    ...
                    eval(
                        "\$information .= \"" .
                            $templates->get(
                                'modcp_modlogs_result_announcement'
                            ) .
                            "\";"
                    );
                }
            ...
            eval(
                "\$modlogresults .= \"" .
                    $templates->get('modcp_modlogs_result') .
                    "\";"
            );
        }
        ...
        if (!$modlogresults) {
            eval(
                "\$modlogresults = \"" .
                    $templates->get('modcp_modlogs_nologs') .
                    "\";"
            );
        }
        ...
        eval(
            "\$latestfivemodactions = \"" .
                $templates->get('modcp_latestfivemodactions') .
                "\";"
        );
    }
