...
$templatelist =
    'usercp,usercp_nav,usercp_profile,usercp_changename,usercp_password,usercp_subscriptions_thread,forumbit_depth2_forum_lastpost,usercp_forumsubscriptions_forum,postbit_reputation_formatted,usercp_subscriptions_thread_icon';
$templatelist .=
    ',usercp_usergroups_memberof_usergroup,usercp_usergroups_memberof,usercp_usergroups_joinable_usergroup,usercp_usergroups_joinable,usercp_usergroups,usercp_nav_attachments,usercp_options_style,usercp_warnings_warning_post';
$templatelist .=
    ',usercp_nav_messenger,usercp_nav_changename,usercp_nav_profile,usercp_nav_misc,usercp_usergroups_leader_usergroup,usercp_usergroups_leader,usercp_currentavatar,usercp_reputation,usercp_avatar_remove,usercp_resendactivation';
$templatelist .=
    ',usercp_attachments_attachment,usercp_attachments,usercp_profile_away,usercp_profile_customfield,usercp_profile_profilefields,usercp_profile_customtitle,usercp_forumsubscriptions_none,usercp_profile_customtitle_currentcustom';
$templatelist .=
    ',usercp_forumsubscriptions,usercp_subscriptions_none,usercp_subscriptions,usercp_options_pms_from_buddys,usercp_options_tppselect,usercp_options_pppselect,usercp_themeselector,usercp_profile_customtitle_reverttitle';
$templatelist .=
    ',usercp_nav_editsignature,usercp_referrals,usercp_notepad,usercp_latest_threads_threads,forumdisplay_thread_gotounread,usercp_latest_threads,usercp_subscriptions_remove,usercp_nav_messenger_folder,usercp_profile_profilefields_text';
$templatelist .=
    ',usercp_editsig_suspended,usercp_editsig,usercp_avatar_current,usercp_options_timezone_option,usercp_drafts,usercp_options_language,usercp_options_date_format,usercp_profile_website,usercp_latest_subscribed,usercp_warnings';
$templatelist .=
    ',usercp_avatar,usercp_editlists_userusercp_editlists,usercp_drafts_draft,usercp_usergroups_joingroup,usercp_attachments_none,usercp_avatar_upload,usercp_options_timezone,usercp_usergroups_joinable_usergroup_join';
$templatelist .=
    ',usercp_warnings_warning,usercp_nav_messenger_tracking,multipage,multipage_end,multipage_jump_page,multipage_nextpage,multipage_page,multipage_page_current,multipage_page_link_current,multipage_prevpage,multipage_start';
$templatelist .=
    ',codebuttons,usercp_nav_messenger_compose,usercp_options_language_option,usercp_editlists,usercp_profile_contact_fields_field,usercp_latest_subscribed_threads,usercp_profile_contact_fields,usercp_profile_day,usercp_nav_home';
$templatelist .=
    ',usercp_profile_profilefields_select_option,usercp_profile_profilefields_multiselect,usercp_profile_profilefields_select,usercp_profile_profilefields_textarea,usercp_profile_profilefields_radio,usercp_profile_profilefields_checkbox';
$templatelist .=
    ',usercp_options_tppselect_option,usercp_options_pppselect_option,forumbit_depth2_forum_lastpost_never,forumbit_depth2_forum_lastpost_hidden,usercp_avatar_auto_resize_auto,usercp_avatar_auto_resize_user,usercp_options';
$templatelist .=
    ',usercp_editlists_no_buddies,usercp_editlists_no_ignored,usercp_editlists_no_requests,usercp_editlists_received_requests,usercp_editlists_sent_requests,usercp_drafts_draft_thread,usercp_drafts_draft_forum,usercp_editlists_user';
$templatelist .=
    ',usercp_usergroups_leader_usergroup_memberlist,usercp_usergroups_leader_usergroup_moderaterequests,usercp_usergroups_memberof_usergroup_leaveprimary,usercp_usergroups_memberof_usergroup_display,usercp_email,usercp_options_pms';
$templatelist .=
    ',usercp_usergroups_memberof_usergroup_leaveleader,usercp_usergroups_memberof_usergroup_leaveother,usercp_usergroups_memberof_usergroup_leave,usercp_usergroups_joinable_usergroup_description,usercp_options_time_format';
$templatelist .=
    ',usercp_editlists_sent_request,usercp_editlists_received_request,usercp_drafts_none,usercp_usergroups_memberof_usergroup_setdisplay,usercp_usergroups_memberof_usergroup_description,usercp_options_quick_reply';
$templatelist .=
    ',usercp_addsubscription_thread,forumdisplay_password,forumdisplay_password_wrongpass,';
...
if (isset($_SERVER['HTTP_REFERER'])) {
    ...
    if (my_strpos($server_http_referer, $mybb->settings['bburl'] . '/') !== 0) {
        ...
        $server_http_referer =
            $mybb->settings['bburl'] . '/' . end($url_segments);
    }
}
...
if ($mybb->input['action'] == 'do_profile' && $mybb->request_method == 'post') {
    ...
    foreach (['icq', 'skype', 'google'] as $cfield) {
    ...
    if (!$userhandler->validate_user()) {
        ...
        if (
            array_key_exists('invalid_birthday_privacy', $raw_errors) ||
...
if ($mybb->input['action'] == 'profile') {
    ...
    if ($cfieldsshow) {
        eval(
            '$contactfields = "' .
                $templates->get('usercp_profile_contact_fields') .
                '";'
        );
    }
    ...
    if (is_array($pfcache)) {
        foreach ($pfcache as $profilefield) {
            if (
                !is_member($profilefield['editableby']) ||
                ($profilefield['postnum'] &&
                    $profilefield['postnum'] > $mybb->user['postnum'])
            ) {
                continue;
            }
    ...
    if ($mybb->usergroup['cancustomtitle'] == 1) {
        ...
        eval(
            "\$customtitle = \"" .
                $templates->get('usercp_profile_customtitle') .
                "\";"
        );
    } else {
        $customtitle = '';
    ...
    if ($mybb->usergroup['canchangewebsite'] == 1) {
        eval(
            "\$website = \"" . $templates->get('usercp_profile_website') . "\";"
        );
    }
...
if ($mybb->input['action'] == 'do_options' && $mybb->request_method == 'post') {
    ...
    $user['options'] = [
        ...
        'subscriptionmethod' => $mybb->get_input(
            'subscriptionmethod',
            MyBB::INPUT_INT
        ),
...
if ($mybb->input['action'] == 'options') {
    ...
    if (count($languages) > 1) {
        foreach ($languages as $name => $language) {
            ...
            eval(
                '$langoptions .= "' .
                    $templates->get('usercp_options_language_option') .
                    '";'
            );
        }
        ...
        eval(
            '$board_language = "' .
                $templates->get('usercp_options_language') .
                '";'
        );
    }
    ...
    if ($mybb->usergroup['canbeinvisible'] == 1) {
        ...
        eval(
            '$canbeinvisible = "' .
                $templates->get('usercp_options_invisible') .
                "\";"
        );
    }
    ...
    $no_auto_subscribe_selected = $instant_email_subscribe_selected = $instant_pm_subscribe_selected = $no_subscribe_selected =
        '';
    if (
        isset($user['subscriptionmethod']) &&
        $user['subscriptionmethod'] == 1
    ) {
        $no_subscribe_selected = "selected=\"selected\"";
    } elseif (
        isset($user['subscriptionmethod']) &&
        $user['subscriptionmethod'] == 2
    ) {
        $instant_email_subscribe_selected = "selected=\"selected\"";
    } elseif (
        isset($user['subscriptionmethod']) &&
        $user['subscriptionmethod'] == 3
    ) {
    ...
    if (
        !isset($user['threadmode']) ||
        ($user['threadmode'] != 'threaded' && $user['threadmode'] != 'linear')
    ) {
    ...
    foreach ($date_formats as $key => $format) {
        ...
        eval(
            "\$date_format_options .= \"" .
                $templates->get('usercp_options_date_format') .
                "\";"
        );
    }
    ...
    foreach ($time_formats as $key => $format) {
        ...
        eval(
            "\$time_format_options .= \"" .
                $templates->get('usercp_options_time_format') .
                "\";"
        );
    }

    $tzselect = build_timezone_select(
        'timezoneoffset',
        $mybb->user['timezone'],
        true
    );
    ...
    if ($mybb->settings['allowbuddyonly'] == 1) {
        eval(
            "\$pms_from_buddys = \"" .
                $templates->get('usercp_options_pms_from_buddys') .
                "\";"
        );
    }
    ...
    if ($mybb->settings['quickreply'] == 1) {
        eval(
            "\$quick_reply = \"" .
                $templates->get('usercp_options_quick_reply') .
                "\";"
        );
    }
    ...
    if (!empty($stylelist)) {
        eval(
            '$board_style = "' . $templates->get('usercp_options_style') . '";'
        );
    }
    ...
    if ($mybb->settings['usertppoptions']) {
        ...
        if (is_array($explodedtpp)) {
            foreach ($explodedtpp as $key => $val) {
                ...
                eval(
                    "\$tppoptions .= \"" .
                        $templates->get('usercp_options_tppselect_option') .
                        "\";"
                );
            }
        }
        eval(
            "\$tppselect = \"" .
                $templates->get('usercp_options_tppselect') .
                "\";"
        );
    }
    ...
    if ($mybb->settings['userpppoptions']) {
        ...
        if (is_array($explodedppp)) {
            foreach ($explodedppp as $key => $val) {
                ...
                eval(
                    "\$pppoptions .= \"" .
                        $templates->get('usercp_options_pppselect_option') .
                        "\";"
                );
            }
        }
        eval(
            "\$pppselect = \"" .
                $templates->get('usercp_options_pppselect') .
                "\";"
        );
    }
    ...
    if (
        ...
        if (!$userhandler->validate_user()) {
            ...
            if ($activation) {
                ...
                $lang->emailsubject_changeemail = $lang->sprintf(
                ...
                $mail_message = $lang->sprintf(
                    $lang->email_changeemail_noactivation,
                    $mybb->user['username'],
                    $mybb->settings['bbname'],
                    $mybb->user['email'],
                    $mybb->get_input('email'),
...
if (
    ...
    if (
        ...
        if (!$userhandler->validate_user()) {
            ...
            my_setcookie(
                'mybbuser',
                $mybb->user['uid'] . '_' . $userhandler->data['loginkey'],
                null,
                true,
                'lax'
            );
            ...
            $mail_message = $lang->sprintf(
                $lang->email_changepassword,
                $mybb->user['username'],
                $mybb->user['email'],
                $mybb->settings['bbname'],
                $mybb->settings['bburl']
            );
            $lang->emailsubject_changepassword = $lang->sprintf(
                $lang->emailsubject_changepassword,
                $mybb->settings['bbname']
            );
            my_mail(
                $mybb->user['email'],
...
if (
    $mybb->input['action'] == 'do_changename' &&
    $mybb->request_method == 'post'
) {
    // Verify incoming POST request
    verify_post_check($mybb->get_input('my_post_key'));
    ...
    if (
        ...
        if (!$userhandler->validate_user()) {
            ...
            redirect(
                'usercp.php?action=changename',
                $lang->redirect_namechanged
            );
        }
    }
    if (count($errors) > 0) {
...
if ($mybb->input['action'] == 'do_subscriptions') {
    ...
    $mybb->input['check'] = array_map(
        'intval',
        $mybb->get_input('check', MyBB::INPUT_ARRAY)
    );
    ...
    if ($mybb->get_input('do') == 'delete') {
        $db->delete_query(
            'threadsubscriptions',
            "tid IN ($tids) AND uid='{$mybb->user['uid']}'"
        );
    }
    ...
    redirect(
        ...
        $lang->redirect_subscriptions_updated
    );
}
...
if ($mybb->input['action'] == 'subscriptions') {
    ...
    // Thread visiblity
    $where = ["s.uid={$mybb->user['uid']}", get_visible_where('t')];
    ...
    $query = $db->query(
		...
		FROM " .
            TABLE_PREFIX .
            "threadsubscriptions s
		LEFT JOIN " .
            TABLE_PREFIX .
            "threads t ON (t.tid = s.tid)
		WHERE {$where}
	"
    );
    ...
    while ($subscription = $db->fetch_array($query)) {
        ...
        if (
            ...
            $subscription['uid'] != $mybb->user['uid']
        ) {
    ...
    if (!empty($del_subscriptions)) {
        ...
        if ($sids) {
            $db->delete_query(
                'threadsubscriptions',
                "sid IN ({$sids}) AND uid='{$mybb->user['uid']}'"
            );
        }
    ...
    if (!empty($subscriptions)) {
        ...
        $query = $db->query(
			...
			LEFT JOIN " .
                TABLE_PREFIX .
                "forumsread fr ON (fr.fid=f.fid AND fr.uid='{$mybb->user['uid']}')
			WHERE f.active != 0
        ...
        if ($mybb->settings['dotfolders'] != 0) {
            $query = $db->simple_select(
                'posts',
                'tid,uid',
                "uid='{$mybb->user['uid']}' AND tid IN ({$tids})"
            );
        ...
        if ($mybb->settings['threadreadcut'] > 0) {
            ...
            while ($readthread = $db->fetch_array($query)) {
                $subscriptions[$readthread['tid']]['lastread'] =
                    $readthread['dateline'];
            }
        }
        ...
        foreach ($subscriptions as $thread) {
            ...
            if (
                $thread['prefix'] != 0 &&
                !empty($threadprefixes[$thread['prefix']])
            ) {
                $thread['threadprefix'] =
                    $threadprefixes[$thread['prefix']]['displaystyle'] .
                    '&nbsp;';
            }
            ...
            $thread['lastpostlink'] = get_thread_link(
                $thread['tid'],
                0,
                'lastpost'
            );
            ...
            if ($thread['icon'] > 0 && $icon_cache[$thread['icon']]) {
                ...
                eval(
                    "\$icon = \"" .
                        $templates->get('usercp_subscriptions_thread_icon') .
                        "\";"
                );
            } else {
                $icon = '&nbsp;';
            ...
            if ($mybb->settings['threadreadcut'] > 0) {
                $read_cutoff =
                    TIME_NOW - $mybb->settings['threadreadcut'] * 60 * 60 * 24;
                if (
                    empty($readforums[$thread['fid']]) ||
                    $readforums[$thread['fid']] < $read_cutoff
                ) {
            ...
            if (!$lastread) {
                $readcookie = $threadread = my_get_array_cookie(
                    'threadread',
                    $thread['tid']
                );
            ...
            if ($lastread && $lastread < $thread['lastpost']) {
                ...
                $thread['newpostlink'] = get_thread_link(
                    $thread['tid'],
                    0,
                    'newpost'
                );
                eval(
                    "\$gotounread = \"" .
                        $templates->get('forumdisplay_thread_gotounread') .
                        "\";"
                );
                $unreadpost = 1;
            } else {
            ...
            if (
                $thread['replies'] >= $mybb->settings['hottopic'] ||
                $thread['views'] >= $mybb->settings['hottopicviews']
            ) {
                $folder .= 'hot';
            ...
            eval(
                "\$threads .= \"" .
                    $templates->get('usercp_subscriptions_thread') .
                    "\";"
            );
        }
        ...
        eval(
            "\$remove_options = \"" .
                $templates->get('usercp_subscriptions_remove') .
                "\";"
        );
    } else {
        $remove_options = '';
        eval(
            "\$threads = \"" .
                $templates->get('usercp_subscriptions_none') .
                "\";"
        );
    }
...
if ($mybb->input['action'] == 'forumsubscriptions') {
    ...
    $query = $db->query(
		...
		FROM " .
            TABLE_PREFIX .
            "forumsubscriptions fs
		LEFT JOIN " .
            TABLE_PREFIX .
            "forums f ON (f.fid = fs.fid)
		LEFT JOIN " .
            TABLE_PREFIX .
            "threads t ON (t.tid = f.lastposttid)
		LEFT JOIN " .
            TABLE_PREFIX .
            "forumsread fr ON (fr.fid=f.fid AND fr.uid='{$mybb->user['uid']}')
    ...
    while ($forum = $db->fetch_array($query)) {
        ...
        if ($forum['lastpost'] == 0) {
            eval(
                "\$lastpost = \"" .
                    $templates->get('forumbit_depth2_forum_lastpost_never') .
                    "\";"
            );
        }
        // Hide last post
        elseif (
            isset($forumpermissions['canonlyviewownthreads']) &&
            $forumpermissions['canonlyviewownthreads'] != 0 &&
            $forum['lastposteruid'] != $mybb->user['uid']
        ) {
            eval(
                "\$lastpost = \"" .
                    $templates->get('forumbit_depth2_forum_lastpost_hidden') .
                    "\";"
            );
        } else {
            $forum['lastpostsubject'] = $parser->parse_badwords(
            ...
            if ($forum['lastposteruid'] == 0) {
                ...
                $lastpost_profilelink = build_profile_link(
                    $lastposter,
                    $forum['lastposteruid']
                );
            }
            $full_lastpost_subject = $lastpost_subject = htmlspecialchars_uni(
                $forum['lastpostsubject']
            );
            ...
            eval(
                "\$lastpost = \"" .
                    $templates->get('forumbit_depth2_forum_lastpost') .
                    "\";"
            );
        }
        ...
        eval(
            "\$forums .= \"" .
                $templates->get('usercp_forumsubscriptions_forum') .
                "\";"
        );
    }
    ...
    if (!$forums) {
        eval(
            "\$forums = \"" .
                $templates->get('usercp_forumsubscriptions_none') .
                "\";"
        );
    }
    ...
    eval(
        "\$forumsubscriptions = \"" .
            $templates->get('usercp_forumsubscriptions') .
            "\";"
    );
...
if (
    $mybb->input['action'] == 'do_addsubscription' &&
    $mybb->get_input('type') != 'forum'
) {
    // Verify incoming POST request
    verify_post_check($mybb->get_input('my_post_key'));
    ...
    add_subscribed_thread(
        $thread['tid'],
        $mybb->get_input('notification', MyBB::INPUT_INT)
    );
...
if ($mybb->input['action'] == 'addsubscription') {
    ...
    if ($mybb->get_input('type') == 'forum') {
        ...
        $thread['subject'] = $parser->parse_badwords($thread['subject']);
        $thread['subject'] = htmlspecialchars_uni($thread['subject']);
        $lang->subscribe_to_thread = $lang->sprintf(
            $lang->subscribe_to_thread,
            $thread['subject']
        );
        ...
        $notification_none_checked = $notification_email_checked = $notification_pm_checked =
            '';
        if (
            $mybb->user['subscriptionmethod'] == 1 ||
        ...
        eval(
            "\$add_subscription = \"" .
                $templates->get('usercp_addsubscription_thread') .
                "\";"
        );
...
if (
    $mybb->input['action'] == 'removesubscription' &&
    ($mybb->request_method == 'post' ||
...
if ($mybb->input['action'] == 'removesubscription') {
    ...
    if ($mybb->get_input('type') == 'forum') {
        ...
        $lang->unsubscribe_from_forum = $lang->sprintf(
            $lang->unsubscribe_from_forum,
            $forum['name']
        );
        ...
        $thread['subject'] = $parser->parse_badwords($thread['subject']);
        $thread['subject'] = htmlspecialchars_uni($thread['subject']);
        $lang->unsubscribe_from_thread = $lang->sprintf(
            $lang->unsubscribe_from_thread,
            $thread['subject']
        );
        ...
        eval(
            "\$remove_thread_subscription = \"" .
                $templates->get('usercp_removesubscription_thread') .
                "\";"
        );
...
if ($mybb->input['action'] == 'do_editsig' && $mybb->request_method == 'post') {
    ...
    if (
        $mybb->user['suspendsignature'] == 1 &&
        $mybb->user['suspendsigtime'] > TIME_NOW
    ) {
        error_no_permission();
    }
...
if ($mybb->input['action'] == 'editsig') {
    ...
    if (
        $mybb->user['suspendsignature'] &&
        ($mybb->user['suspendsigtime'] == 0 ||
            ($mybb->user['suspendsigtime'] > 0 &&
                $mybb->user['suspendsigtime'] > TIME_NOW))
    ) {
    ...
    if ($mybb->usergroup['canusesig'] != 1) {
        ...
        $mybb->usergroup['canusesig'] == 1 &&
        $mybb->usergroup['canusesigxposts'] > 0 &&
        $mybb->user['postnum'] < $mybb->usergroup['canusesigxposts']
    ) {
        // Usergroup can use this facility, but only after x posts
        error(
            $lang->sprintf(
                $lang->sig_suspended_posts,
                $mybb->usergroup['canusesigxposts']
            )
        );
    }
    ...
    if (
        ...
        eval(
            "\$editsig = \"" .
                $templates->get('usercp_editsig_suspended') .
                "\";"
        );
    } else {
        ...
        $lang->edit_sig_note2 = $lang->sprintf(
            $lang->edit_sig_note2,
            $sigsmilies,
            $sigmycode,
            $sigimgcode,
...
if ($mybb->input['action'] == 'do_avatar' && $mybb->request_method == 'post') {
    ...
    if (!empty($mybb->input['remove'])) {
        ...
        if (validate_email_format($mybb->input['avatarurl']) != false) {
            ...
            $mybb->input['avatarurl'] = preg_replace(
                '#script:#i',
                '',
                $mybb->get_input('avatarurl')
            );
            ...
            if (empty($avatar_error)) {
                ...
                $updated_avatar = [
                    'avatar' => $db->escape_string(
                        $mybb->input['avatarurl'] . '?dateline=' . TIME_NOW
                    ),
                    'avatardimensions' => $avatar_dimensions,
                    'avatartype' => 'remote',
                ];
    ...
    // remote avatar, but remote avatars are not allowed
    else {
...
if ($mybb->input['action'] == 'avatar') {
    ...
    if (
        $mybb->user['avatartype'] == 'upload' ||
        stristr($mybb->user['avatar'], $mybb->settings['avataruploadpath'])
    ) {
        $avatarmsg =
            '<br /><strong>' . $lang->already_uploaded_avatar . '</strong>';
    } elseif (
        $mybb->user['avatartype'] == 'remote' ||
        my_validate_url($mybb->user['avatar'])
    ) {
        $avatarmsg =
            '<br /><strong>' . $lang->using_remote_avatar . '</strong>';
        $avatarurl = htmlspecialchars_uni($mybb->user['avatar']);
    }

    $useravatar = format_avatar(
        $mybb->user['avatar'],
        $mybb->user['avatardimensions'],
        '100x100'
    );
    eval(
        "\$currentavatar = \"" .
            $templates->get('usercp_avatar_current') .
            "\";"
    );
    ...
    if ($mybb->settings['avatarsize']) {
        ...
        $lang->avatar_note .=
            '<br />' . $lang->sprintf($lang->avatar_note_size, $maxsize);
    }
    ...
    if ($mybb->settings['avatarresizing'] == 'auto') {
        eval(
            "\$auto_resize = \"" .
                $templates->get('usercp_avatar_auto_resize_auto') .
                "\";"
        );
    } elseif ($mybb->settings['avatarresizing'] == 'user') {
        eval(
            "\$auto_resize = \"" .
                $templates->get('usercp_avatar_auto_resize_user') .
                "\";"
        );
    }
    ...
    if ($mybb->usergroup['canuploadavatars'] == 1) {
        eval(
            "\$avatarupload = \"" .
                $templates->get('usercp_avatar_upload') .
                "\";"
        );
    }
    ...
    if ($mybb->settings['allowremoteavatars'] == 1) {
        eval(
            "\$avatar_remote = \"" .
                $templates->get('usercp_avatar_remote') .
                "\";"
        );
    }
    ...
    if (!empty($mybb->user['avatar'])) {
        eval(
            "\$removeavatar = \"" .
                $templates->get('usercp_avatar_remove') .
                "\";"
        );
    }
...
if ($mybb->input['action'] == 'do_editlists') {
    ...
    if ($mybb->get_input('add_username')) {
        ...
        foreach ($users as $key => $username) {
            ...
            if (
                my_strtoupper($mybb->user['username']) ==
                my_strtoupper($username)
            ) {
                $adding_self = true;
                unset($users[$key]);
                continue;
        ...
        if (count($users) > 0) {
            ...
            while ($user = $db->fetch_array($query)) {
                ...
                if (
                    in_array($user['uid'], $existing_users) ||
                    in_array($user['uid'], $selected_list)
                ) {
                    if ($mybb->get_input('manage') == 'ignored') {
                ...
                if (
                    $user['buddyrequestsauto'] == 1 &&
                    $mybb->get_input('manage') != 'ignored'
                ) {
        ...
        if (
            ($adding_self != true ||
                ($adding_self == true && count($users) > 0)) &&
    ...
    elseif ($mybb->get_input('delete', MyBB::INPUT_INT)) {
        ...
        $key = array_search(
            $mybb->get_input('delete', MyBB::INPUT_INT),
            $existing_users
        );
        if ($key !== false) {
    ...
    if (!empty($mybb->input['ajax'])) {
        ...
        redirect(
            'usercp.php?action=editlists#' . $mybb->get_input('manage'),
            $message
        );
    }
}
...
if ($mybb->input['action'] == 'editlists') {
    ...
    if ($mybb->user['buddylist']) {
        ...
        while ($user = $db->fetch_array($query)) {
            ...
            eval(
                "\$buddy_list .= \"" .
                    $templates->get('usercp_editlists_user') .
                    "\";"
            );
            ++$buddy_count;
        }
    ...
    $lang->current_buddies = $lang->sprintf(
        $lang->current_buddies,
        $buddy_count
    );
    if (!$buddy_list) {
        eval(
            "\$buddy_list = \"" .
                $templates->get('usercp_editlists_no_buddies') .
                "\";"
        );
    }
    ...
    $lang->current_ignored_users = $lang->sprintf(
        $lang->current_ignored_users,
        $ignore_count
    );
    if (!$ignore_list) {
        eval(
            "\$ignore_list = \"" .
                $templates->get('usercp_editlists_no_ignored') .
                "\";"
        );
    }
        ...
        if ($mybb->input['manage'] == 'ignored') {
            ...
            if (isset($sent) && $sent === true) {
                ...
                while ($request = $db->fetch_array($query)) {
                    $bgcolor = alt_trow();
                    $request['username'] = build_profile_link(
                ...
                eval(
                    "\$sent_requests = \"" .
                        $templates->get(
                            'usercp_editlists_sent_requests',
                            1,
                            0
                        ) .
                        "\";"
                ...
                echo $sent_requests .
                    "<script type=\"text/javascript\">{$message_js}</script>";
            } else {
                echo $buddy_list;
    ...
    while ($request = $db->fetch_array($query)) {
        ...
        eval(
            "\$received_rows .= \"" .
                $templates->get('usercp_editlists_received_request') .
                "\";"
        );
    }
    ...
    if ($received_rows == '') {
        eval(
            "\$received_rows = \"" .
                $templates->get('usercp_editlists_no_requests') .
                "\";"
        );
    }
    ...
    eval(
        "\$received_requests = \"" .
            $templates->get('usercp_editlists_received_requests') .
            "\";"
    );
    ...
    while ($request = $db->fetch_array($query)) {
        ...
        eval(
            "\$sent_rows .= \"" .
                $templates->get('usercp_editlists_sent_request') .
                "\";"
        );
    }
    ...
    eval(
        "\$sent_requests = \"" .
            $templates->get('usercp_editlists_sent_requests') .
            "\";"
    );
...
if ($mybb->input['action'] == 'drafts') {
    ...
    $query = $db->simple_select(
        'posts',
        'COUNT(pid) AS draftcount',
        "visible='-2' AND uid='{$mybb->user['uid']}'"
    );
    $draftcount = $db->fetch_field($query, 'draftcount');

    $drafts = $disable_delete_drafts = '';
    $lang->drafts_count = $lang->sprintf(
        $lang->drafts_count,
        my_number_format($draftcount)
    );
    ...
    if ($draftcount) {
        ...
        while ($draft = $db->fetch_array($query)) {
            ...
            if ($draft['threadvisible'] == 1) {
                ...
                $draft['threadsubject'] = htmlspecialchars_uni(
                    $draft['threadsubject']
                );
                eval(
                    "\$detail = \"" .
                        $templates->get('usercp_drafts_draft_thread') .
                        "\";"
                );
                ...
                eval(
                    "\$detail = \"" .
                        $templates->get('usercp_drafts_draft_forum') .
                        "\";"
                );
            ...
            eval(
                "\$drafts .= \"" .
                    $templates->get('usercp_drafts_draft') .
                    "\";"
            );
        }
    } else {
...
if ($mybb->input['action'] == 'do_drafts' && $mybb->request_method == 'post') {
    ...
    $mybb->input['deletedraft'] = $mybb->get_input(
        'deletedraft',
        MyBB::INPUT_ARRAY
    );
    ...
    if ($pidin || $tidinp) {
        ...
        $db->delete_query(
            'posts',
            "($pidinq $tidinp) AND visible='-2' AND uid='" .
                $mybb->user['uid'] .
                "'"
        );
    }
...
if ($mybb->input['action'] == 'usergroups') {
    ...
    if ($mybb->get_input('displaygroup', MyBB::INPUT_INT)) {
        ...
        if (
            my_strpos($ingroups, ',' . $mybb->input['displaygroup'] . ',') ===
            false
        ) {
        ...
        $dispgroup =
            $usergroups[$mybb->get_input('displaygroup', MyBB::INPUT_INT)];
    ...
    if ($mybb->get_input('leavegroup', MyBB::INPUT_INT)) {
        ...
        $usergroup =
            $usergroups[$mybb->get_input('leavegroup', MyBB::INPUT_INT)];
        if (
            $usergroup['type'] != 4 &&
            $usergroup['type'] != 3 &&
            $usergroup['type'] != 5
    ...
    if ($mybb->get_input('joingroup', MyBB::INPUT_INT)) {
        ...
        $usergroup =
            $usergroups[$mybb->get_input('joingroup', MyBB::INPUT_INT)];
        ...
        if (
            ($usergroup['type'] != 4 && $usergroup['type'] != 3) ||
            !$usergroup['gid']
        ) {
        ...
        if (
            my_strpos(
                $ingroups,
                ',' . $mybb->get_input('joingroup', MyBB::INPUT_INT) . ','
            ) !== false
        ) {
        ...
        if ($mybb->get_input('do') == 'joingroup' && $usergroup['type'] == 4) {
            ...
            if ($reasonlength > 250) {
                // Reason field is varchar(250) in database
                error(
                    $lang->sprintf(
                        $lang->joinreason_too_long,
                        $reasonlength - 250
                    )
                );
            }
            ...
            if (array_key_exists($usergroup['gid'], $groupleaders)) {
                foreach ($groupleaders[$usergroup['gid']] as $leader) {
                    ...
                    $subject = $lang->sprintf(
                        $lang->emailsubject_newjoinrequest,
                        $mybb->settings['bbname']
                    );
                    $message = $lang->sprintf(
                        $lang->email_groupleader_joinrequest,
                        $leader['username'],
                        $mybb->user['username'],
                        $usergroup['title'],
                        $mybb->settings['bbname'],
            ...
            redirect(
                'usercp.php?action=usergroups',
                $lang->group_join_requestsent
            );
            exit();
            ...
            eval(
                "\$joinpage = \"" .
                    $templates->get('usercp_usergroups_joingroup') .
                    "\";"
            );
    ...
    if ($mybb->get_input('acceptinvite', MyBB::INPUT_INT)) {
        ...
        $usergroup =
            $usergroups[$mybb->get_input('acceptinvite', MyBB::INPUT_INT)];

        if (
            my_strpos(
                $ingroups,
                ',' . $mybb->get_input('acceptinvite', MyBB::INPUT_INT) . ','
            ) !== false
        ) {
    ...
    switch ($db->type) {
        ...
        case 'sqlite':
            $query = $db->query(
				...
				LEFT JOIN " .
                    TABLE_PREFIX .
                    "usergroups g ON(g.gid=l.gid)
				LEFT JOIN " .
                    TABLE_PREFIX .
                    "users u ON(((','|| u.additionalgroups|| ',' LIKE '%,'|| g.gid|| ',%') OR u.usergroup = g.gid))
				LEFT JOIN " .
                    TABLE_PREFIX .
                    "joinrequests j ON(j.gid=g.gid AND j.uid != 0)
				WHERE l.uid='" .
                    $mybb->user['uid'] .
                    "'
        ...
        default:
            $query = $db->query(
				...
				LEFT JOIN " .
                    TABLE_PREFIX .
                    "users u ON(((CONCAT(',', u.additionalgroups, ',') LIKE CONCAT('%,', g.gid, ',%')) OR u.usergroup = g.gid))
				LEFT JOIN " .
                    TABLE_PREFIX .
                    "joinrequests j ON(j.gid=g.gid AND j.uid != 0)
				WHERE l.uid='" .
    ...
    while ($usergroup = $db->fetch_array($query)) {
        ...
        if (
            $usergroup['joinrequests'] > 0 &&
            $usergroup['canmanagerequests'] == 1
        ) {
            eval(
                "\$moderaterequestslink = \"" .
                    $templates->get(
        ...
        eval(
            "\$groupsledlist .= \"" .
                $templates->get('usercp_usergroups_leader_usergroup') .
                "\";"
        );
    }
    $leadinggroups = '';
    if ($groupsledlist) {
        eval(
            "\$leadinggroups = \"" .
                $templates->get('usercp_usergroups_leader') .
                "\";"
        );
    }
    ...
    if ($usergroup['description']) {
        $usergroup['description'] = htmlspecialchars_uni(
    ...
    $trow = alt_trow();
    if (
        $usergroup['candisplaygroup'] == 1 &&
        $usergroup['gid'] == $mybb->user['displaygroup']
    ) {
        eval(
            "\$displaycode = \"" .
                $templates->get(
    ...
    eval(
        "\$memberoflist = \"" .
            $templates->get('usercp_usergroups_memberof_usergroup') .
            "\";"
    );
    $showmemberof = false;
    if ($mybb->user['additionalgroups']) {
        $additionalgroups = implode(
            ',',
            array_map('intval', explode(',', $mybb->user['additionalgroups']))
        );
        $query = $db->simple_select(
            'usergroups',
            '*',
        ...
        while ($usergroup = $db->fetch_array($query)) {
            ...
            $description = '';
            $usergroup['title'] = htmlspecialchars_uni($usergroup['title']);
            $usergroup['usertitle'] = htmlspecialchars_uni(
                $usergroup['usertitle']
            );
            if ($usergroup['description']) {
                $usergroup['description'] = htmlspecialchars_uni(
    ...
    eval(
        "\$membergroups = \"" .
            $templates->get('usercp_usergroups_memberof') .
            "\";"
    );
    ...
    while ($usergroup = $db->fetch_array($query)) {
        ...
        if (isset($appliedjoin[$usergroup['gid']]) && $usergroup['type'] != 5) {
            ...
            isset($appliedjoin[$usergroup['gid']]) &&
            $usergroup['type'] == 5
        ) {
            $joinlink = $lang->sprintf(
        ...
        if (!empty($groupleaders[$usergroup['gid']])) {
            ...
            $usergroupleaders = '';
            foreach ($groupleaders[$usergroup['gid']] as $leader) {
                $leader['username'] = format_name(
                    htmlspecialchars_uni($leader['username']),
                    $leader['usergroup'],
                    $leader['displaygroup']
                );
                $usergroupleaders .=
                    $comma .
                    build_profile_link($leader['username'], $leader['uid']);
                $comma = $lang->comma;
            }
            $usergroupleaders =
                $lang->usergroup_leaders . ' ' . $usergroupleaders;
        }
    ...
    if ($joinablegrouplist) {
        eval(
            "\$joinablegroups = \"" .
                $templates->get('usercp_usergroups_joinable') .
                "\";"
        );
    }
    ...
    eval(
        "\$groupmemberships = \"" . $templates->get('usercp_usergroups') . "\";"
    );
...
if ($mybb->input['action'] == 'attachments') {
    ...
    while ($attachment = $db->fetch_array($query)) {
        if ($attachment['dateline'] && $attachment['tid']) {
            $attachment['subject'] = htmlspecialchars_uni(
                $parser->parse_badwords($attachment['subject'])
            );
            $attachment['postlink'] = get_post_link(
                $attachment['pid'],
                $attachment['tid']
            );
            ...
            $sizedownloads = $lang->sprintf(
                $lang->attachment_size_downloads,
                $size,
            ...
            eval(
                "\$attachments .= \"" .
                    $templates->get('usercp_attachments_attachment') .
                    "\";"
            );
    ...
    if ($mybb->usergroup['attachquota']) {
        $percent = round(
            ($totalusage / ($mybb->usergroup['attachquota'] * 1024)) * 100
        );
        $friendlyusage .= $lang->sprintf(
            $lang->attachments_usage_percent,
            $percent
        );
        $attachquota = get_friendly_size(
            $mybb->usergroup['attachquota'] * 1024
        );
        $usagenote = $lang->sprintf(
            $lang->attachments_usage_quota,
            $friendlyusage,
            $attachquota,
            $totalattachments
        );
    ...
    eval(
        "\$delete_button = \"" .
            $templates->get('delete_attachments_button') .
            "\";"
    );
    ...
    if (!$attachments) {
        eval(
            "\$attachments = \"" .
                $templates->get('usercp_attachments_none') .
                "\";"
        );
        $usagenote = '';
        $delete_button = '';
...
if (
    $mybb->input['action'] == 'do_attachments' &&
    $mybb->request_method == 'post'
) {
    // Verify incoming POST request
    verify_post_check($mybb->get_input('my_post_key'));
    ...
    require_once MYBB_ROOT . 'inc/functions_upload.php';
    if (
        !isset($mybb->input['attachments']) ||
        !is_array($mybb->input['attachments'])
    ) {
...
if ($mybb->input['action'] == 'do_notepad' && $mybb->request_method == 'post') {
    ...
    if (my_strlen($mybb->get_input('notepad')) > 60000) {
        $mybb->input['notepad'] = my_substr(
            $mybb->get_input('notepad'),
            0,
            60000
        );
    }
    ...
    $db->update_query(
        'users',
        ['notepad' => $db->escape_string($mybb->get_input('notepad'))],
        "uid='" . $mybb->user['uid'] . "'"
    );
...
if (!$mybb->input['action']) {
    ...
    $colspan = 2;
    $lang->posts_day = $lang->sprintf(
        $lang->posts_day,
        my_number_format($perday),
        $percent
    );
    ...
    if (
        ...
        eval(
            "\$usergroup .= \"" .
                $templates->get('usercp_resendactivation') .
                "\";"
        );
    }
    ...
    if (
        ...
        $mybb->settings['canviewownwarning'] != 0
    ) {
        ...
        if ($warning_level > 0) {
            ...
            $lang->current_warning_level = $lang->sprintf(
            ...
            $query = $db->query(
				...
				LEFT JOIN " .
                    TABLE_PREFIX .
                    "warningtypes t ON (t.tid=w.tid)
				LEFT JOIN " .
                    TABLE_PREFIX .
                    "users u ON (u.uid=w.issuedby)
				LEFT JOIN " .
                    TABLE_PREFIX .
                    "posts p ON (p.pid=w.pid)
            ...
            while ($warning = $db->fetch_array($query)) {
                ...
                if ($warning['post_subject']) {
                    $warning['post_subject'] = $parser->parse_badwords(
                        $warning['post_subject']
                    );
                    $warning['post_subject'] = htmlspecialchars_uni(
                        $warning['post_subject']
                    );
                    $warning['postlink'] = get_post_link($warning['pid']);
                    eval(
                        "\$post_link .= \"" .
                            $templates->get('usercp_warnings_warning_post') .
                            "\";"
                    );
                }
                $warning['username'] = htmlspecialchars_uni(
                    $warning['username']
                );
                $issuedby = build_profile_link(
                    $warning['username'],
                    $warning['issuedby']
                );
                ...
                eval(
                    "\$warnings .= \"" .
                        $templates->get('usercp_warnings_warning') .
                        "\";"
                );
            }
            if ($warnings) {
    ...
    if ($mybb->settings['usereferrals'] == 1) {
        ...
        if ($referral_count > 0) {
            ...
            eval(
                "\$mybb->user['referrals'] = \"" .
                    $templates->get('member_referrals_link') .
                    "\";"
            );
        }

        eval(
            "\$referral_info = \"" . $templates->get('usercp_referrals') . "\";"
        );
    }
        ...
        if ($subscriptions) {
            ...
            if ($mybb->settings['threadreadcut'] > 0) {
                ...
                while ($readthread = $db->fetch_array($query)) {
                    if (
                        $readthread['dateline'] >=
                        $subscriptions[$readthread['tid']]['lastpost']
                    ) {
            ...
            if ($subscriptions) {
                ...
                foreach ($subscriptions as $thread) {
                    ...
                    if (!empty($thread['tid'])) {
                        $bgcolor = alt_trow();
                        $thread['subject'] = $parser->parse_badwords(
                            $thread['subject']
                        );
                        ...
                        if (
                            ...
                            $thread['lastread'] < $thread['lastpost']
                        ) {
                            $folder .= 'new';
                            $folder_label .= $lang->icon_new;
                            $new_class = 'subject_new';
                        ...
                        if (!$lastposteruid && !$thread['lastposter']) {
                            ...
                            $lastposter = htmlspecialchars_uni(
                                $thread['lastposter']
                            );
                        }
                        ...
                        $thread['replies'] = my_number_format(
                            $thread['replies']
                        );
                        $thread['views'] = my_number_format($thread['views']);
                        $thread['username'] = htmlspecialchars_uni(
                            $thread['username']
                        );
                        $thread['author'] = build_profile_link(
                            $thread['username'],
                            $thread['uid']
                        );
                ...
                eval(
                    "\$latest_subscribed = \"" .
                        $templates->get('usercp_latest_subscribed') .
                        "\";"
                );
            }
        }
    ...
    $where = ["t.uid={$mybb->user['uid']}", get_visible_where('t')];
    ...
    if (!empty($threadcache)) {
        ...
        if ($mybb->settings['threadreadcut'] > 0) {
            ...
            while ($readthread = $db->fetch_array($query)) {
                $threadcache[$readthread['tid']]['lastread'] =
                    $readthread['dateline'];
            }
        }
        ...
        foreach ($threadcache as $thread) {
            ...
            if (!empty($thread['tid'])) {
                ...
                if ($mybb->settings['threadreadcut'] > 0) {
                    ...
                    $read_cutoff =
                        TIME_NOW -
                        $mybb->settings['threadreadcut'] * 60 * 60 * 24;
                ...
                eval(
                    "\$latest_threads_threads .= \"" .
                        $templates->get('usercp_latest_threads_threads') .
                        "\";"
                );
            }
        }
        ...
        eval(
            "\$latest_threads = \"" .
                $templates->get('usercp_latest_threads') .
                "\";"
        );
    }
